...
public class SimpleJwkFilter {
    ...
    public void setKid(String expectedKid, boolean omittedValueAcceptable) {
        ...
        new Criteria(expectedKid, omittedValueAcceptable, (C15351) null);
        this.kid = criteria2;
    }
    ...
    public void setKty(String expectedKty) {
        Criteria criteria;
        Criteria criteria2 = criteria;
        new Criteria(expectedKty, false, (C15351) null);
        this.kty = criteria2;
    }
    ...
    public void setUse(String expectedUse, boolean omittedValueAcceptable) {
        Criteria criteria;
        Criteria criteria2 = criteria;
        new Criteria(expectedUse, omittedValueAcceptable, (C15351) null);
        this.use = criteria2;
    }
    ...
    public void setKeyOperations(String[] expectedKeyOps, boolean omittedValueAcceptable) {
        ...
        new KeyOpsCriteria(expectedKeyOps, omittedValueAcceptable, (C15351) null);
    ...
    public void setAlg(String expectedAlg, boolean omittedValueAcceptable) {
        Criteria criteria;
        Criteria criteria2 = criteria;
        new Criteria(expectedAlg, omittedValueAcceptable, (C15351) null);
        this.alg = criteria2;
    }
    ...
    public void setX5t(String expectedThumb, boolean omittedValueAcceptable) {
        Criteria criteria;
        Criteria criteria2 = criteria;
        new Criteria(expectedThumb, omittedValueAcceptable, (C15351) null);
        this.x5t = criteria2;
    }
    ...
    public void setCrv(String expectedCrv, boolean omittedValueAcceptable) {
        Criteria criteria;
        Criteria criteria2 = criteria;
        new Criteria(expectedCrv, omittedValueAcceptable, (C15351) null);
        this.crv = criteria2;
    }
    ...
    private static class Criteria {
        ...
        /* synthetic */ Criteria(String x0, boolean x1, C15351 r10) {
            this(x0, x1);
            C15351 r3 = r10;
        }
    ...
    private static class KeyOpsCriteria {
        ...
        /* JADX INFO: this call moved to the top of the method (can break code semantics) */
        /* synthetic */ KeyOpsCriteria(String[] x0, boolean x1, C15351 r10) {
            this(x0, x1);
            C15351 r3 = r10;
        }
