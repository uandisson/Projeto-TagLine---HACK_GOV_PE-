...
public class HttpsJwks {
    ...
    public HttpsJwks(String location2) {
        ...
        new Cache(Collections.emptyList(), 0, (C15341) null);
        this.cache = cache2;
        new ReentrantLock();
    ...
    public List<JsonWebKey> getJsonWebKeys() throws JoseException, IOException {
        ...
        try {
            ...
            new Cache(c2.keys, now + this.retainCacheOnErrorDurationMills, (C15341) null);
            Cache cache3 = cache2;
            c = cache3;
            this.cache = cache3;
            Logger logger = log;
    ...
    public void refresh() throws JoseException, IOException {
        ...
        try {
            ...
            if (last >= this.refreshReprieveThreshold || this.cache.keys.isEmpty()) {
                ...
                new Cache(keys, exp, (C15341) null);
                this.cache = cache2;
            } else {
    ...
    static long getExpires(SimpleResponse response) {
        return getDateHeaderValue(response, SqlTileWriter.COLUMN_EXPIRES, 0);
    }
    ...
    private static class Cache {
        ...
        /* synthetic */ Cache(List x0, long x1, C15341 r14) {
            this(x0, x1);
            C15341 r4 = r14;
        }
