...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    private void drawShadow(Canvas canvas) {
        ...
        float shadowScaleHorizontal = shadowOffset / (shadowOffset + (this.rawShadowSize - (this.rawShadowSize * 0.5f)));
        float shadowScaleTop = shadowOffset / (shadowOffset + shadowOffsetTop);
        float shadowScaleBottom = shadowOffset / (shadowOffset + (this.rawShadowSize - (this.rawShadowSize * 1.0f)));
    ...
    private void buildShadowCorners() {
        ...
        if (shadowRadius > 0.0f) {
            ...
            fArr2[1] = startRatio;
            float[] fArr3 = fArr2;
            fArr3[2] = startRatio + ((1.0f - startRatio) / 2.0f);
            float[] fArr4 = fArr3;
            fArr4[3] = 1.0f;
        ...
        new LinearGradient(0.0f, f, 0.0f, f2, iArr8, new float[]{0.0f, 0.5f, 1.0f}, Shader.TileMode.CLAMP);
