...
import android.support.p000v4.util.C1623LruCache;
import android.support.p000v4.util.C1626SparseArrayCompat;
...
public final class AppCompatDrawableManager {
    ...
    private C1617ArrayMap<String, InflateDelegate> mDelegates;
    private final WeakHashMap<Context, C1622LongSparseArray<WeakReference<Drawable.ConstantState>>> mDrawableCaches;
    private boolean mHasCheckedVectorDrawableSetup;
    private C1626SparseArrayCompat<String> mKnownDrawableIdTags;
    private WeakHashMap<Context, C1626SparseArrayCompat<ColorStateList>> mTintLists;
    ...
    public AppCompatDrawableManager() {
        WeakHashMap<Context, C1622LongSparseArray<WeakReference<Drawable.ConstantState>>> weakHashMap;
        new WeakHashMap<>(0);
    ...
    public synchronized void onConfigurationChanged(@NonNull Context context) {
        Context context2 = context;
        synchronized (this) {
            C1622LongSparseArray<WeakReference<Drawable.ConstantState>> cache = this.mDrawableCaches.get(context2);
            if (cache != null) {
                cache.clear();
            }
        }
    ...
    private Drawable loadDrawableFromDelegates(@NonNull Context context, @DrawableRes int i) {
        C1626SparseArrayCompat<String> sparseArrayCompat;
        int type;
        Throwable th;
        TypedValue typedValue;
        Context context2 = context;
    ...
    private synchronized boolean addDrawableToCache(@NonNull Context context, long j, @NonNull Drawable drawable) {
        boolean z;
        Object obj;
        C1622LongSparseArray longSparseArray;
        Context context2 = context;
        long key = j;
        Drawable drawable2 = drawable;
        synchronized (this) {
            ...
            if (cs != null) {
                C1622LongSparseArray longSparseArray2 = this.mDrawableCaches.get(context2);
                if (longSparseArray2 == null) {
                    new C1622LongSparseArray();
                    longSparseArray2 = longSparseArray;
                    C1622LongSparseArray<WeakReference<Drawable.ConstantState>> put = this.mDrawableCaches.put(context2, longSparseArray2);
                }
    ...
    private void addDelegate(@NonNull String str, @NonNull InflateDelegate inflateDelegate) {
        C1617ArrayMap<String, InflateDelegate> arrayMap;
        String tagName = str;
    ...
    private ColorStateList getTintListFromCache(@NonNull Context context, @DrawableRes int i) {
        ...
        C1626SparseArrayCompat<ColorStateList> tints = this.mTintLists.get(context2);
    ...
    private void addTintListToCache(@NonNull Context context, @DrawableRes int i, @NonNull ColorStateList colorStateList) {
        C1626SparseArrayCompat sparseArrayCompat;
        WeakHashMap<Context, C1626SparseArrayCompat<ColorStateList>> weakHashMap;
        Context context2 = context;
        int resId = i;
        ...
        C1626SparseArrayCompat sparseArrayCompat2 = this.mTintLists.get(context2);
        if (sparseArrayCompat2 == null) {
            new C1626SparseArrayCompat();
            sparseArrayCompat2 = sparseArrayCompat;
            C1626SparseArrayCompat<ColorStateList> put = this.mTintLists.put(context2, sparseArrayCompat2);
        }
    ...
    private static class ColorFilterLruCache extends C1623LruCache<Integer, PorterDuffColorFilter> {
