...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public String exceptionLabel() {
        StringBuilder sb;
        new StringBuilder();
        return sb.append(" ").append(super.toString()).append(", adapter:").append(this.mAdapter).append(", layout:").append(this.mLayout).append(", context:").append(getContext()).toString();
    }
    ...
    public static abstract class SmoothScroller {
        ...
        public void start(RecyclerView recyclerView, LayoutManager layoutManager) {
            ...
            if (this.mStarted) {
                new StringBuilder();
                int w = Log.w(RecyclerView.TAG, sb.append("An instance of ").append(getClass().getSimpleName()).append(" was started ").append("more than once. Each instance of").append(getClass().getSimpleName()).append(" ").append("is intended to only be used once. You should create a new instance for ").append("each use.").toString());
            }
            this.mRecyclerView = recyclerView2;
