...
public class C1623LruCache<K, V> {
    ...
    public final V get(@NonNull K k) {
        ...
        synchronized (this) {
            try {
                C1623LruCache<K, V> mapValue = this.map.get(key);
                if (mapValue != null) {
                    this.hitCount++;
                    C1623LruCache<K, V> lruCache = mapValue;
                    return lruCache;
                }
                this.missCount++;
                C1623LruCache<K, V> createdValue = create(key);
                ...
                synchronized (this) {
                    try {
                        this.createCount++;
                        C1623LruCache<K, V> mapValue2 = this.map.put(key, createdValue);
                        if (mapValue2 != null) {
    ...
    public final V put(@NonNull K k, @NonNull V v) {
        ...
        synchronized (this) {
            try {
                ...
                C1623LruCache<K, V> previous = this.map.put(key, value);
                if (previous != null) {
    ...
    public void trimToSize(int r14) {
        ...
        L_0x005c:
            ...
            goto L_0x0002
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p000v4.util.C1623LruCache.trimToSize(int):void");
    }
    ...
    public final V remove(@NonNull K k) {
        ...
        synchronized (this) {
            try {
                C1623LruCache<K, V> previous = this.map.remove(key);
                if (previous != null) {
                    this.size -= safeSizeOf(key, previous);
                }
                if (previous != null) {
                    entryRemoved(false, key, previous, (C1623LruCache<K, V>) null);
                }
                return previous;
            } catch (Throwable th3) {
                while (true) {
