...
public final class C1619CircularArray<E> {
    ...
    public C1619CircularArray() {
        this(8);
    }

    public C1619CircularArray(int i) {
        int arrayCapacity;
        Throwable th;
        Throwable th2;
        int minCapacity = i;
    ...
    public E popFirst() {
        ...
        C1619CircularArray<E> result = this.mElements[this.mHead];
    ...
    public E popLast() {
        ...
        C1619CircularArray<E> result = this.mElements[t];
