...
public class C1625SimpleArrayMap<K, V> {
    ...
    private static int binarySearchHashes(int[] hashes, int N, int hash) {
        Throwable th;
        try {
            return C1621ContainerHelpers.binarySearch(hashes, N, hash);
    ...
    private void allocArrays(int i) {
        int size = i;
        if (size == 8) {
            Class<C1617ArrayMap> cls = C1617ArrayMap.class;
            Class<C1617ArrayMap> cls2 = cls;
            synchronized (cls) {
                try {
                    ...
                    while (true) {
                        Throwable th2 = th;
                        Class<C1617ArrayMap> cls3 = cls2;
                        throw th2;
                    }
                }
            }
        } else if (size == 4) {
            Class<C1617ArrayMap> cls4 = C1617ArrayMap.class;
            Class<C1617ArrayMap> cls5 = cls4;
            synchronized (cls4) {
                try {
                    if (mBaseCache != null) {
    ...
    public C1625SimpleArrayMap() {
        this.mHashes = C1621ContainerHelpers.EMPTY_INTS;
        this.mArray = C1621ContainerHelpers.EMPTY_OBJECTS;
        this.mSize = 0;
    }

    public C1625SimpleArrayMap(int i) {
        int capacity = i;
        if (capacity == 0) {
            this.mHashes = C1621ContainerHelpers.EMPTY_INTS;
            this.mArray = C1621ContainerHelpers.EMPTY_OBJECTS;
    ...
    public C1625SimpleArrayMap(C1625SimpleArrayMap<K, V> simpleArrayMap) {
        this();
        C1625SimpleArrayMap<K, V> map = simpleArrayMap;
        if (map != null) {
            putAll(map);
        }
    }
    ...
    public V setValueAt(int index, V value) {
        ...
        C1625SimpleArrayMap<K, V> old = this.mArray[index2];
    ...
    public void putAll(@NonNull C1625SimpleArrayMap<? extends K, ? extends V> simpleArrayMap) {
        C1625SimpleArrayMap<? extends K, ? extends V> array = simpleArrayMap;
        int N = array.mSize;
    ...
    public boolean equals(Object obj) {
        ...
        if (object instanceof C1625SimpleArrayMap) {
            C1625SimpleArrayMap<?, ?> map = (C1625SimpleArrayMap) object;
            if (size() != map.size()) {
                return false;
            }
            int i = 0;
