...
public final class C1618ArraySet<E> implements Collection<E>, Set<E> {
    ...
    Object[] mArray;
    private C1624MapCollections<E, E> mCollections;
    private int[] mHashes;
    int mSize;
    ...
    private int indexOf(Object obj, int i) {
        ...
        int index = C1621ContainerHelpers.binarySearch(this.mHashes, N, hash);
        if (index < 0) {
            return index;
        }
    ...
    private int indexOfNull() {
        ...
        int index = C1621ContainerHelpers.binarySearch(this.mHashes, N, 0);
        if (index < 0) {
            return index;
        }
    ...
    private void allocArrays(int i) {
        int size = i;
        if (size == 8) {
            Class<C1618ArraySet> cls = C1618ArraySet.class;
            Class<C1618ArraySet> cls2 = cls;
            synchronized (cls) {
                try {
                    ...
                    while (true) {
                        Throwable th2 = th;
                        Class<C1618ArraySet> cls3 = cls2;
                        throw th2;
                    }
                }
            }
        } else if (size == 4) {
            Class<C1618ArraySet> cls4 = C1618ArraySet.class;
            Class<C1618ArraySet> cls5 = cls4;
            synchronized (cls4) {
                try {
                    if (sBaseCache != null) {
    ...
    public C1618ArraySet() {
        this(0);
    }

    public C1618ArraySet(int i) {
        int capacity = i;
        if (capacity == 0) {
            this.mHashes = INT;
            this.mArray = OBJECT;
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public C1618ArraySet(@Nullable C1618ArraySet<E> arraySet) {
        this();
        C1618ArraySet<E> set = arraySet;
        if (set != null) {
            addAll(set);
        }
    }
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public C1618ArraySet(@Nullable Collection<E> collection) {
        this();
    ...
    public void addAll(@NonNull C1618ArraySet<? extends E> arraySet) {
        C1618ArraySet<? extends E> array = arraySet;
        int N = array.mSize;
    ...
    public boolean removeAll(@NonNull C1618ArraySet<? extends E> arraySet) {
        C1618ArraySet<? extends E> array = arraySet;
        int N = array.mSize;
    ...
    private C1624MapCollections<E, E> getCollection() {
        C1624MapCollections<E, E> mapCollections;
        if (this.mCollections == null) {
            new C1624MapCollections<E, E>(this) {
                final /* synthetic */ C1618ArraySet this$0;
