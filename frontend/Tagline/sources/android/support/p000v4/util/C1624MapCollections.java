...
abstract class C1624MapCollections<K, V> {
    @Nullable
    C1624MapCollections<K, V>.EntrySet mEntrySet;
    @Nullable
    C1624MapCollections<K, V>.KeySet mKeySet;
    @Nullable
    C1624MapCollections<K, V>.ValuesCollection mValues;
    ...
    final class ArrayIterator<T> implements Iterator<T> {
        ...
        final int mOffset;
        int mSize;
        final /* synthetic */ C1624MapCollections this$0;

        ArrayIterator(C1624MapCollections mapCollections, int offset) {
            C1624MapCollections this$02 = mapCollections;
            this.this$0 = this$02;
            this.mOffset = offset;
    ...
    final class MapIterator implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
        ...
        MapIterator(C1624MapCollections mapCollections) {
            C1624MapCollections this$02 = mapCollections;
            this.this$0 = this$02;
        ...
        public boolean equals(Object obj) {
            ...
            if (!this.mEntryValid) {
                ...
                return C1621ContainerHelpers.equal(e.getKey(), this.this$0.colGetEntry(this.mIndex, 0)) && C1621ContainerHelpers.equal(e.getValue(), this.this$0.colGetEntry(this.mIndex, 1));
            }
        }
    ...
    final class EntrySet implements Set<Map.Entry<K, V>> {
        ...
        EntrySet(C1624MapCollections this$02) {
            this.this$0 = this$02;
        }
        ...
        public boolean contains(Object obj) {
            ...
            return C1621ContainerHelpers.equal(this.this$0.colGetEntry(index, 1), e.getValue());
        }
        ...
        public boolean equals(Object object) {
            return C1624MapCollections.equalsSetHelper(this, object);
        }
    ...
    final class KeySet implements Set<K> {
        ...
        KeySet(C1624MapCollections this$02) {
            this.this$0 = this$02;
        }
        ...
        public boolean containsAll(Collection<?> collection) {
            return C1624MapCollections.containsAllHelper(this.this$0.colGetMap(), collection);
        }
        ...
        public boolean removeAll(Collection<?> collection) {
            return C1624MapCollections.removeAllHelper(this.this$0.colGetMap(), collection);
        }

        public boolean retainAll(Collection<?> collection) {
            return C1624MapCollections.retainAllHelper(this.this$0.colGetMap(), collection);
        }
    ...
    final class ValuesCollection implements Collection<V> {
        ...
        ValuesCollection(C1624MapCollections this$02) {
            this.this$0 = this$02;
        }
    ...
    public Set<Map.Entry<K, V>> getEntrySet() {
        C1624MapCollections<K, V>.EntrySet entrySet;
    ...
    public Set<K> getKeySet() {
        C1624MapCollections<K, V>.KeySet keySet;
    ...
    public Collection<V> getValues() {
        C1624MapCollections<K, V>.ValuesCollection valuesCollection;
