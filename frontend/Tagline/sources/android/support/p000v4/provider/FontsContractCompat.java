...
public class FontsContractCompat {
    ...
    @GuardedBy("sLock")
    static final C1625SimpleArrayMap<String, ArrayList<SelfDestructiveThread.ReplyCallback<TypefaceResult>>> sPendingReplies;
    static final C1623LruCache<String, Typeface> sTypefaceCache;
    ...
    static {
        C1623LruCache<String, Typeface> lruCache;
        SelfDestructiveThread selfDestructiveThread;
        Object obj;
        C1625SimpleArrayMap<String, ArrayList<SelfDestructiveThread.ReplyCallback<TypefaceResult>>> simpleArrayMap;
        Comparator<byte[]> comparator;
        new C1623LruCache<>(16);
        sTypefaceCache = lruCache;
        new SelfDestructiveThread("fonts", 10, 10000);
        sBackgroundThread = selfDestructiveThread;
        new Object();
        sLock = obj;
        new C1625SimpleArrayMap<>();
        ...
        try {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    new FontInfo(fileUri, ttcIndex, weightColumnIndex != -1 ? cursor.getInt(weightColumnIndex) : SVG.Style.FONT_WEIGHT_NORMAL, italicColumnIndex != -1 && cursor.getInt(italicColumnIndex) == 1, resultCode);
