...
class FragmentTransition {
        ...
        if (fragmentManager.mCurState >= 1) {
            ...
            if (sparseArray2.size() != 0) {
                ...
                for (int i4 = 0; i4 < numContainers; i4++) {
                    ...
                    C1617ArrayMap<String, String> nameOverrides = calculateNameOverrides(containerId, records, isRecordPop, startIndex, endIndex);
    ...
    private static android.support.p000v4.util.C1617ArrayMap<java.lang.String, java.lang.String> calculateNameOverrides(int r22, java.util.ArrayList<android.support.p000v4.app.BackStackRecord> r23, java.util.ArrayList<java.lang.Boolean> r24, int r25, int r26) {
        /*
            r2 = r22
            r3 = r23
            r4 = r24
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static void configureTransitionsReordered(android.support.p000v4.app.FragmentManagerImpl r31, int r32, android.support.p000v4.app.FragmentTransition.FragmentContainerTransition r33, android.view.View r34, android.support.p000v4.util.C1617ArrayMap<java.lang.String, java.lang.String> r35) {
        /*
            r1 = r31
            r2 = r32
            r3 = r33
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static void configureTransitionsOrdered(android.support.p000v4.app.FragmentManagerImpl r30, int r31, android.support.p000v4.app.FragmentTransition.FragmentContainerTransition r32, android.view.View r33, android.support.p000v4.util.C1617ArrayMap<java.lang.String, java.lang.String> r34) {
        /*
            r1 = r30
            r2 = r31
            r3 = r32
    ...
    private static Object configureSharedElementsReordered(FragmentTransitionImpl fragmentTransitionImpl, ViewGroup viewGroup, View view, C1617ArrayMap<String, String> arrayMap, FragmentContainerTransition fragmentContainerTransition, ArrayList<View> arrayList, ArrayList<View> arrayList2, Object obj, Object obj2) {
        ...
        View nonExistentView = view;
        C1617ArrayMap<String, String> nameOverrides = arrayMap;
        ...
        C1617ArrayMap<String, View> outSharedElements = captureOutSharedElements(impl, nameOverrides, sharedElementTransition2, fragments);
        C1617ArrayMap<String, View> inSharedElements = captureInSharedElements(impl, nameOverrides, sharedElementTransition2, fragments);
        if (nameOverrides.isEmpty()) {
        ...
        final C1617ArrayMap<String, View> arrayMap2 = inSharedElements;
    ...
    private static void addSharedElementsWithMatchingNames(ArrayList<View> arrayList, C1617ArrayMap<String, View> arrayMap, Collection<String> collection) {
        ArrayList<View> views = arrayList;
        C1617ArrayMap<String, View> sharedElements = arrayMap;
    ...
    private static Object configureSharedElementsOrdered(FragmentTransitionImpl fragmentTransitionImpl, ViewGroup viewGroup, View view, C1617ArrayMap<String, String> arrayMap, FragmentContainerTransition fragmentContainerTransition, ArrayList<View> arrayList, ArrayList<View> arrayList2, Object obj, Object obj2) {
        Object sharedElementTransition;
        Rect inEpicenter;
        Runnable runnable;
        Rect rect;
        ...
        final FragmentTransitionImpl fragmentTransitionImpl2 = impl;
        final C1617ArrayMap<String, String> arrayMap2 = nameOverrides;
        ...
        new Runnable() {
            public void run() {
                C1617ArrayMap<String, View> inSharedElements = FragmentTransition.captureInSharedElements(fragmentTransitionImpl2, arrayMap2, obj3, fragmentContainerTransition2);
                if (inSharedElements != null) {
    ...
    private static C1617ArrayMap<String, View> captureOutSharedElements(FragmentTransitionImpl fragmentTransitionImpl, C1617ArrayMap<String, String> arrayMap, Object obj, FragmentContainerTransition fragmentContainerTransition) {
        C1617ArrayMap arrayMap2;
        ...
        Fragment outFragment = fragments.firstOut;
        new C1617ArrayMap();
        C1617ArrayMap arrayMap3 = arrayMap2;
    ...
    static C1617ArrayMap<String, View> captureInSharedElements(FragmentTransitionImpl fragmentTransitionImpl, C1617ArrayMap<String, String> arrayMap, Object obj, FragmentContainerTransition fragmentContainerTransition) {
        C1617ArrayMap arrayMap2;
        SharedElementCallback sharedElementCallback;
        ArrayList<String> names;
        String key;
    ...
    private static String findKeyForValue(C1617ArrayMap<String, String> arrayMap, String str) {
        C1617ArrayMap<String, String> map = arrayMap;
        String value = str;
    ...
    static View getInEpicenterView(C1617ArrayMap<String, View> arrayMap, FragmentContainerTransition fragments, Object enterTransition, boolean z) {
        String targetName;
        C1617ArrayMap<String, View> inSharedElements = arrayMap;
        boolean inIsPop = z;
        BackStackRecord inTransaction = fragments.lastInTransaction;
    ...
    private static void setOutEpicenter(FragmentTransitionImpl fragmentTransitionImpl, Object obj, Object obj2, C1617ArrayMap<String, View> arrayMap, boolean z, BackStackRecord backStackRecord) {
        String sourceName;
        FragmentTransitionImpl impl = fragmentTransitionImpl;
        Object sharedElementTransition = obj;
        Object exitTransition = obj2;
        C1617ArrayMap<String, View> outSharedElements = arrayMap;
        boolean outIsPop = z;
    ...
    private static void retainValues(C1617ArrayMap<String, String> arrayMap, C1617ArrayMap<String, View> arrayMap2) {
        C1617ArrayMap<String, String> nameOverrides = arrayMap;
        C1617ArrayMap<String, View> namedViews = arrayMap2;
    ...
    static void callSharedElementStartEnd(Fragment fragment, Fragment fragment2, boolean isPop, C1617ArrayMap<String, View> arrayMap, boolean z) {
