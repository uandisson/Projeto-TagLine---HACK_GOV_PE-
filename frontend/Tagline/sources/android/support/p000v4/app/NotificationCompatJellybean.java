...
class NotificationCompatJellybean {
    ...
    static NotificationCompat.Action getActionFromBundle(Bundle bundle) {
        ...
        new NotificationCompat.Action(bundle2.getInt(KEY_ICON), bundle2.getCharSequence("title"), (PendingIntent) bundle2.getParcelable(KEY_ACTION_INTENT), bundle2.getBundle(KEY_EXTRAS), fromBundleArray(getBundleArrayFromBundle(bundle2, KEY_REMOTE_INPUTS)), fromBundleArray(getBundleArrayFromBundle(bundle2, KEY_DATA_ONLY_REMOTE_INPUTS)), allowGeneratedReplies, bundle2.getInt(KEY_SEMANTIC_ACTION), bundle2.getBoolean(KEY_SHOWS_USER_INTERFACE));
        return action;
    }
    ...
    static Bundle getBundleForAction(NotificationCompat.Action action) {
        ...
        bundle4.putCharSequence("title", action2.getTitle());
