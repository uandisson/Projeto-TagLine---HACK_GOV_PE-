...
public class TransitionManager {
    ...
    private static ThreadLocal<WeakReference<C1617ArrayMap<ViewGroup, ArrayList<Transition>>>> sRunningTransitions;
    private C1617ArrayMap<Scene, C1617ArrayMap<Scene, Transition>> mScenePairTransitions;
    private C1617ArrayMap<Scene, Transition> mSceneTransitions;

    public TransitionManager() {
        C1617ArrayMap<Scene, Transition> arrayMap;
        C1617ArrayMap<Scene, C1617ArrayMap<Scene, Transition>> arrayMap2;
        new C1617ArrayMap<>();
    ...
    static {
        ...
        ThreadLocal<WeakReference<C1617ArrayMap<ViewGroup, ArrayList<Transition>>>> threadLocal;
    ...
    public void setTransition(@NonNull Scene scene, @NonNull Scene scene2, @Nullable Transition transition) {
        ...
        C1617ArrayMap arrayMap2 = this.mScenePairTransitions.get(toScene);
        if (arrayMap2 == null) {
            new C1617ArrayMap();
            arrayMap2 = arrayMap;
            C1617ArrayMap<Scene, Transition> put = this.mScenePairTransitions.put(toScene, arrayMap2);
        }
    ...
    private Transition getTransition(Scene scene) {
        Scene currScene;
        C1617ArrayMap<Scene, Transition> sceneTransitionMap;
        Transition transition;
        Scene scene2 = scene;
    ...
    static C1617ArrayMap<ViewGroup, ArrayList<Transition>> getRunningTransitions() {
        C1617ArrayMap arrayMap;
        Object obj;
        C1617ArrayMap<ViewGroup, ArrayList<Transition>> transitions;
        WeakReference<C1617ArrayMap<ViewGroup, ArrayList<Transition>>> runningTransitions = sRunningTransitions.get();
        if (runningTransitions != null && (transitions = (C1617ArrayMap) runningTransitions.get()) != null) {
            return transitions;
        }
        new C1617ArrayMap();
        C1617ArrayMap arrayMap2 = arrayMap;
    ...
    private static class MultiListener implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
        ...
        public boolean onPreDraw() {
            ...
            C1617ArrayMap<ViewGroup, ArrayList<Transition>> runningTransitions = TransitionManager.getRunningTransitions();
            ...
            final C1617ArrayMap<ViewGroup, ArrayList<Transition>> arrayMap = runningTransitions;
