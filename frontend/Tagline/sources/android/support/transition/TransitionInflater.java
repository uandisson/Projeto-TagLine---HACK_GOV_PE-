...
public class TransitionInflater {
    private static final C1617ArrayMap<String, Constructor> CONSTRUCTORS;
    private static final Class<?>[] CONSTRUCTOR_SIGNATURE;
    private final Context mContext;

    static {
        C1617ArrayMap<String, Constructor> arrayMap;
    ...
    private Object createCustom(AttributeSet attributeSet, Class cls, String str) {
        ...
        try {
            C1617ArrayMap<String, Constructor> arrayMap2 = CONSTRUCTORS;
            arrayMap = arrayMap2;
