...
public abstract class Transition implements Cloneable {
    ...
    private static ThreadLocal<C1617ArrayMap<Animator, AnimationInfo>> sRunningAnimators;
    ...
    private C1617ArrayMap<String, String> mNameOverrides;
    ...
    static {
        ...
        ThreadLocal<C1617ArrayMap<Animator, AnimationInfo>> threadLocal;
        new PathMotion() {
    ...
    private void matchInstances(C1617ArrayMap<View, TransitionValues> arrayMap, C1617ArrayMap<View, TransitionValues> arrayMap2) {
        TransitionValues end;
        C1617ArrayMap<View, TransitionValues> unmatchedStart = arrayMap;
        C1617ArrayMap<View, TransitionValues> unmatchedEnd = arrayMap2;
    ...
    private void matchItemIds(C1617ArrayMap<View, TransitionValues> arrayMap, C1617ArrayMap<View, TransitionValues> arrayMap2, C1622LongSparseArray<View> longSparseArray, C1622LongSparseArray<View> longSparseArray2) {
        View endView;
        C1617ArrayMap<View, TransitionValues> unmatchedStart = arrayMap;
        C1617ArrayMap<View, TransitionValues> unmatchedEnd = arrayMap2;
        C1622LongSparseArray<View> startItemIds = longSparseArray;
        C1622LongSparseArray<View> endItemIds = longSparseArray2;
    ...
    private void matchIds(C1617ArrayMap<View, TransitionValues> arrayMap, C1617ArrayMap<View, TransitionValues> arrayMap2, SparseArray<View> sparseArray, SparseArray<View> sparseArray2) {
        View endView;
        C1617ArrayMap<View, TransitionValues> unmatchedStart = arrayMap;
        C1617ArrayMap<View, TransitionValues> unmatchedEnd = arrayMap2;
    ...
    private void matchNames(C1617ArrayMap<View, TransitionValues> arrayMap, C1617ArrayMap<View, TransitionValues> arrayMap2, C1617ArrayMap<String, View> arrayMap3, C1617ArrayMap<String, View> arrayMap4) {
        View endView;
        C1617ArrayMap<View, TransitionValues> unmatchedStart = arrayMap;
        C1617ArrayMap<View, TransitionValues> unmatchedEnd = arrayMap2;
        C1617ArrayMap<String, View> startNames = arrayMap3;
        C1617ArrayMap<String, View> endNames = arrayMap4;
    ...
    private void addUnmatched(C1617ArrayMap<View, TransitionValues> arrayMap, C1617ArrayMap<View, TransitionValues> arrayMap2) {
        C1617ArrayMap<View, TransitionValues> unmatchedStart = arrayMap;
        C1617ArrayMap<View, TransitionValues> unmatchedEnd = arrayMap2;
    ...
    private void matchStartAndEnd(TransitionValuesMaps transitionValuesMaps, TransitionValuesMaps transitionValuesMaps2) {
        ...
        new C1617ArrayMap((C1625SimpleArrayMap) startValues.mViewValues);
        C1617ArrayMap arrayMap3 = arrayMap;
        new C1617ArrayMap((C1625SimpleArrayMap) endValues.mViewValues);
        C1617ArrayMap arrayMap4 = arrayMap2;
    ...
    public void createAnimators(ViewGroup viewGroup, TransitionValuesMaps transitionValuesMaps, TransitionValuesMaps transitionValuesMaps2, ArrayList<TransitionValues> arrayList, ArrayList<TransitionValues> arrayList2) {
        ...
        C1617ArrayMap<Animator, AnimationInfo> runningAnimators = getRunningAnimators();
    ...
    private static C1617ArrayMap<Animator, AnimationInfo> getRunningAnimators() {
        C1617ArrayMap arrayMap;
        C1617ArrayMap arrayMap2 = sRunningAnimators.get();
        if (arrayMap2 == null) {
            new C1617ArrayMap();
            arrayMap2 = arrayMap;
    ...
    private void runAnimator(Animator animator, C1617ArrayMap<Animator, AnimationInfo> arrayMap) {
        Animator.AnimatorListener animatorListener;
        Animator animator2 = animator;
        C1617ArrayMap<Animator, AnimationInfo> runningAnimators = arrayMap;
        if (animator2 != null) {
            final C1617ArrayMap<Animator, AnimationInfo> arrayMap2 = runningAnimators;
