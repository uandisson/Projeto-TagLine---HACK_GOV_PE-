...
/* renamed from: io.kodular.tagline.Tagline.Screen2 */
...
public class Screen2 extends Form implements Runnable {
    ...
    static final PairWithPosition Lit15 = PairWithPosition.make(Lit51, PairWithPosition.make(Lit7, LList.Empty, "/tmp/1613066542848_0.683030498808931-0/youngandroidproject/../src/io/kodular/tagline/Tagline/Screen2.yail", 77966), "/tmp/1613066542848_0.683030498808931-0/youngandroidproject/../src/io/kodular/tagline/Tagline/Screen2.yail", 77955);
    static final SimpleSymbol Lit16;
    static final PairWithPosition Lit17 = PairWithPosition.make(Lit51, PairWithPosition.make(Lit7, LList.Empty, "/tmp/1613066542848_0.683030498808931-0/youngandroidproject/../src/io/kodular/tagline/Tagline/Screen2.yail", 78114), "/tmp/1613066542848_0.683030498808931-0/youngandroidproject/../src/io/kodular/tagline/Tagline/Screen2.yail", 78103);
    ...
    static {
        ...
        Lit51 = (SimpleSymbol) simpleSymbol.readResolve();
        new SimpleSymbol("lookup-handler");
        Lit50 = (SimpleSymbol) simpleSymbol2.readResolve();
        new SimpleSymbol("dispatchGenericEvent");
        Lit49 = (SimpleSymbol) simpleSymbol3.readResolve();
        new SimpleSymbol("dispatchEvent");
        Lit48 = (SimpleSymbol) simpleSymbol4.readResolve();
        new SimpleSymbol("send-error");
        Lit47 = (SimpleSymbol) simpleSymbol5.readResolve();
        new SimpleSymbol("add-to-form-do-after-creation");
        Lit46 = (SimpleSymbol) simpleSymbol6.readResolve();
        ...
        Lit39 = (SimpleSymbol) simpleSymbol13.readResolve();
        new SimpleSymbol("android-log-form");
        Lit38 = (SimpleSymbol) simpleSymbol14.readResolve();
        new SimpleSymbol("get-simple-name");
        Lit37 = (SimpleSymbol) simpleSymbol15.readResolve();
        ...
        Lit29 = (SimpleSymbol) simpleSymbol16.readResolve();
        new SimpleSymbol("Height");
        Lit27 = (SimpleSymbol) simpleSymbol17.readResolve();
        int[] iArr3 = new int[2];
        iArr3[0] = -14575886;
        Lit26 = IntNum.make(iArr3);
        new SimpleSymbol("BackgroundColor");
        Lit25 = (SimpleSymbol) simpleSymbol18.readResolve();
        new FString("com.google.appinventor.components.runtime.HorizontalArrangement");
        Lit24 = fString6;
        ...
        Lit21 = (SimpleSymbol) simpleSymbol19.readResolve();
        new SimpleSymbol("Screen2$Initialize");
        Lit20 = (SimpleSymbol) simpleSymbol20.readResolve();
        SimpleSymbol simpleSymbol37 = Lit51;
        new SimpleSymbol(PropertyTypeConstants.PROPERTY_TYPE_TEXT);
        SimpleSymbol simpleSymbol38 = (SimpleSymbol) simpleSymbol21.readResolve();
        Lit7 = simpleSymbol38;
        Lit19 = PairWithPosition.make(simpleSymbol37, PairWithPosition.make(simpleSymbol38, LList.Empty, "/tmp/1613066542848_0.683030498808931-0/youngandroidproject/../src/io/kodular/tagline/Tagline/Screen2.yail", 78258), "/tmp/1613066542848_0.683030498808931-0/youngandroidproject/../src/io/kodular/tagline/Tagline/Screen2.yail", 78247);
        new SimpleSymbol("Horizontal_Arrangement3");
        Lit18 = (SimpleSymbol) simpleSymbol22.readResolve();
        new SimpleSymbol("Horizontal_Arrangement2");
        Lit16 = (SimpleSymbol) simpleSymbol23.readResolve();
        new SimpleSymbol("Horizontal_Arrangement1");
        Lit14 = (SimpleSymbol) simpleSymbol24.readResolve();
        new SimpleSymbol("AddComponentToView");
        Lit13 = (SimpleSymbol) simpleSymbol25.readResolve();
        new SimpleSymbol("View_Pager1");
        Lit12 = (SimpleSymbol) simpleSymbol26.readResolve();
        new SimpleSymbol("Title");
        Lit11 = (SimpleSymbol) simpleSymbol27.readResolve();
        new SimpleSymbol("Theme");
        Lit10 = (SimpleSymbol) simpleSymbol28.readResolve();
        new SimpleSymbol("ReceiveSharedText");
        Lit9 = (SimpleSymbol) simpleSymbol29.readResolve();
        new SimpleSymbol("AppName");
        Lit8 = (SimpleSymbol) simpleSymbol30.readResolve();
        new SimpleSymbol("AppId");
        Lit6 = (SimpleSymbol) simpleSymbol31.readResolve();
        new SimpleSymbol("number");
        Lit5 = (SimpleSymbol) simpleSymbol32.readResolve();
        int[] iArr4 = new int[2];
        iArr4[0] = -1;
        Lit4 = IntNum.make(iArr4);
        new SimpleSymbol("AccentColor");
        Lit3 = (SimpleSymbol) simpleSymbol33.readResolve();
        new SimpleSymbol("*the-null-value*");
        Lit2 = (SimpleSymbol) simpleSymbol34.readResolve();
        new SimpleSymbol("getMessage");
        Lit1 = (SimpleSymbol) simpleSymbol35.readResolve();
        new SimpleSymbol("Screen2");
        Lit0 = (SimpleSymbol) simpleSymbol36.readResolve();
    }
    ...
    public Screen2() {
        ...
        ModuleMethod moduleMethod26 = moduleMethod;
        new frame();
        frame frame3 = frame2;
        frame3.$main = this;
        frame frame4 = frame3;
        new ModuleMethod(frame4, 1, Lit37, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.get$Mnsimple$Mnname = moduleMethod26;
        new ModuleMethod(frame4, 2, Lit38, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.android$Mnlog$Mnform = moduleMethod2;
        new ModuleMethod(frame4, 3, Lit39, 8194);
        this.add$Mnto$Mnform$Mnenvironment = moduleMethod3;
        new ModuleMethod(frame4, 4, Lit40, 8193);
        this.lookup$Mnin$Mnform$Mnenvironment = moduleMethod4;
        new ModuleMethod(frame4, 6, Lit41, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.is$Mnbound$Mnin$Mnform$Mnenvironment = moduleMethod5;
        new ModuleMethod(frame4, 7, Lit42, 8194);
        this.add$Mnto$Mnglobal$Mnvar$Mnenvironment = moduleMethod6;
        new ModuleMethod(frame4, 8, Lit43, 8194);
        this.add$Mnto$Mnevents = moduleMethod7;
        new ModuleMethod(frame4, 9, Lit44, 16388);
        this.add$Mnto$Mncomponents = moduleMethod8;
        new ModuleMethod(frame4, 10, Lit45, 8194);
        this.add$Mnto$Mnglobal$Mnvars = moduleMethod9;
        new ModuleMethod(frame4, 11, Lit46, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.add$Mnto$Mnform$Mndo$Mnafter$Mncreation = moduleMethod10;
        new ModuleMethod(frame4, 12, Lit47, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        new ModuleMethod(frame4, 14, Lit48, 16388);
        this.dispatchEvent = moduleMethod13;
        new ModuleMethod(frame4, 15, Lit49, 16388);
        this.dispatchGenericEvent = moduleMethod14;
        new ModuleMethod(frame4, 16, Lit50, 8194);
        this.lookup$Mnhandler = moduleMethod15;
        new ModuleMethod(frame4, 17, (Object) null, 0);
        ModuleMethod moduleMethod27 = moduleMethod16;
        moduleMethod27.setProperty("source-location", "/tmp/runtime8397583071109955809.scm:615");
        lambda$Fn1 = moduleMethod27;
        ...
        new ModuleMethod(frame4, 20, Lit20, 0);
        ...
        try {
            ...
            try {
                ...
                if (C1234runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    ...
                    Object andCoerceProperty$Ex4 = C1234runtime.setAndCoerceProperty$Ex(Lit0, Lit9, AlgorithmIdentifiers.NONE, Lit7);
                    Object andCoerceProperty$Ex5 = C1234runtime.setAndCoerceProperty$Ex(Lit0, Lit10, "AppTheme.Light.DarkActionBar", Lit7);
                    Values.writeValues(C1234runtime.setAndCoerceProperty$Ex(Lit0, Lit11, "Screen2", Lit7), $result);
                } else {
                    new Promise(lambda$Fn2);
                    addToFormDoAfterCreation(obj2);
                }
                if (C1234runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    Object addToCurrentFormEnvironment = C1234runtime.addToCurrentFormEnvironment(Lit20, this.Screen2$Initialize);
                } else {
                    addToFormEnvironment(Lit20, this.Screen2$Initialize);
                }
                if (C1234runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    EventDispatcher.registerEventForDelegation((HandlesEventDispatching) C1234runtime.$Stthis$Mnform$St, "Screen2", "Initialize");
                } else {
                    addToEvents(Lit0, Lit21);
                }
                this.View_Pager1 = null;
                if (C1234runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    Values.writeValues(C1234runtime.addComponentWithinRepl(Lit0, Lit22, Lit12, Boolean.FALSE), $result);
                } else {
                    addToComponents(Lit0, Lit23, Lit12, Boolean.FALSE);
                }
                this.Horizontal_Arrangement3 = null;
                if (C1234runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    Values.writeValues(C1234runtime.addComponentWithinRepl(Lit0, Lit24, Lit18, lambda$Fn3), $result);
                } else {
                    addToComponents(Lit0, Lit30, Lit18, lambda$Fn4);
                }
                this.Horizontal_Arrangement2 = null;
                if (C1234runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    Values.writeValues(C1234runtime.addComponentWithinRepl(Lit0, Lit31, Lit16, lambda$Fn5), $result);
                } else {
                    addToComponents(Lit0, Lit33, Lit16, lambda$Fn6);
                }
                this.Horizontal_Arrangement1 = null;
                if (C1234runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    Values.writeValues(C1234runtime.addComponentWithinRepl(Lit0, Lit34, Lit14, lambda$Fn7), $result);
                } else {
                    addToComponents(Lit0, Lit36, Lit14, lambda$Fn8);
                }
    ...
    static Object lambda3() {
        ...
        Object andCoerceProperty$Ex4 = C1234runtime.setAndCoerceProperty$Ex(Lit0, Lit9, AlgorithmIdentifiers.NONE, Lit7);
        Object andCoerceProperty$Ex5 = C1234runtime.setAndCoerceProperty$Ex(Lit0, Lit10, "AppTheme.Light.DarkActionBar", Lit7);
        return C1234runtime.setAndCoerceProperty$Ex(Lit0, Lit11, "Screen2", Lit7);
    }

    public Object Screen2$Initialize() {
        C1234runtime.setThisForm();
        Object callComponentMethod = C1234runtime.callComponentMethod(Lit12, Lit13, LList.list2(C1234runtime.lookupInCurrentFormEnvironment(Lit14), "Mapa"), Lit15);
        Object callComponentMethod2 = C1234runtime.callComponentMethod(Lit12, Lit13, LList.list2(C1234runtime.lookupInCurrentFormEnvironment(Lit16), "Dashboard"), Lit17);
        return C1234runtime.callComponentMethod(Lit12, Lit13, LList.list2(C1234runtime.lookupInCurrentFormEnvironment(Lit18), "Sobre"), Lit19);
    }

    static Object lambda4() {
        Object andCoerceProperty$Ex = C1234runtime.setAndCoerceProperty$Ex(Lit18, Lit25, Lit26, Lit5);
        Object andCoerceProperty$Ex2 = C1234runtime.setAndCoerceProperty$Ex(Lit18, Lit27, Lit28, Lit5);
        return C1234runtime.setAndCoerceProperty$Ex(Lit18, Lit29, Lit28, Lit5);
    }
    ...
    static Object lambda6() {
        Object andCoerceProperty$Ex = C1234runtime.setAndCoerceProperty$Ex(Lit16, Lit25, Lit32, Lit5);
        Object andCoerceProperty$Ex2 = C1234runtime.setAndCoerceProperty$Ex(Lit16, Lit27, Lit28, Lit5);
        return C1234runtime.setAndCoerceProperty$Ex(Lit16, Lit29, Lit28, Lit5);
    }
    ...
    static Object lambda8() {
        Object andCoerceProperty$Ex = C1234runtime.setAndCoerceProperty$Ex(Lit14, Lit25, Lit35, Lit5);
        Object andCoerceProperty$Ex2 = C1234runtime.setAndCoerceProperty$Ex(Lit14, Lit27, Lit28, Lit5);
        return C1234runtime.setAndCoerceProperty$Ex(Lit14, Lit29, Lit28, Lit5);
    }
    ...
    /* renamed from: io.kodular.tagline.Tagline.Screen2$frame */
    /* compiled from: Screen2.yail */
