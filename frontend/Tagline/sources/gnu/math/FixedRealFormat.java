...
public class FixedRealFormat extends Format {
    ...
    public StringBuffer format(double d, StringBuffer stringBuffer, FieldPosition fieldPosition) {
        ...
        if (getMaximumFractionDigits() >= 0) {
            ...
            if (this.width > 0) {
                while (digits < 0) {
                    StringBuffer append3 = sbuf.append(Dimension.SYM_P);
                    digits++;
                    i++;
                }
            ...
            while (cur_scale > 0) {
                StringBuffer append5 = sbuf.append(Dimension.SYM_P);
                cur_scale--;
                i++;
            }
            ...
            char skip = addOne ? '9' : Dimension.SYM_P;
            ...
            if (decimals2 == 0) {
                if (this.width <= 0 || signLen + digits + 1 < this.width) {
                    decimals2 = 1;
                    length3++;
                    StringBuffer insert = sbuf.insert(digStart + digits, Dimension.SYM_P);
                }
            }
    ...
    private void format(StringBuffer stringBuffer, FieldPosition fieldPosition, int i, int i2, int i3, int i4, int i5) {
        ...
        while (true) {
            ...
            StringBuffer insert = sbuf.insert(oldSize + signLen, Dimension.SYM_P);
        }
        if (padding >= 0) {
            int i8 = oldSize;
