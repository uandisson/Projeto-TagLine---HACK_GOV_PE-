...
public abstract class Complex extends Quantity {
    ...
    public boolean isExact() {
        return mo17670re().isExact() && mo17669im().isExact();
    }

    public Complex toExact() {
        Complex complex;
        RealNum re = mo17670re();
        RealNum im = mo17669im();
    ...
    public Complex toInexact() {
        ...
        new DComplex(mo17670re().doubleValue(), mo17669im().doubleValue());
        return complex;
    }
    ...
    public double doubleValue() {
        return mo17670re().doubleValue();
    }

    public double doubleImagValue() {
        return mo17669im().doubleValue();
    }
    ...
    public static boolean equals(Complex complex, Complex y) {
        Complex x = complex;
        return x.mo17670re().equals(y.mo17670re()) && x.mo17669im().equals(x.mo17669im());
    }
    ...
    public static int compare(Complex complex, Complex complex2) {
        Complex x = complex;
        Complex y = complex2;
        int code = x.mo17669im().compare(y.mo17669im());
        if (code != 0) {
            return code;
        }
        return x.mo17670re().compare(y.mo17670re());
    }
    ...
    public boolean isZero() {
        return mo17670re().isZero() && mo17669im().isZero();
    }
    ...
    public String toString(int i) {
        ...
        int radix = i;
        if (mo17669im().isZero()) {
            return mo17670re().toString(radix);
        }
        new StringBuilder();
        String imString = sb.append(mo17669im().toString(radix)).append("i").toString();
        ...
        new StringBuilder();
        return sb2.append(mo17670re().toString(radix)).append(imString).toString();
    }

    public static Complex neg(Complex complex) {
        Complex x = complex;
        return make(x.mo17670re().rneg(), x.mo17669im().rneg());
    }
    ...
    public static Complex add(Complex complex, Complex complex2, int i) {
        ...
        Complex y = complex2;
        int k = i;
        return make(RealNum.add(x.mo17670re(), y.mo17670re(), k), RealNum.add(x.mo17669im(), y.mo17669im(), k));
    }
    ...
    public static Complex times(Complex complex, Complex complex2) {
        Complex x = complex;
        Complex y = complex2;
        RealNum x_re = x.mo17670re();
        RealNum x_im = x.mo17669im();
        RealNum y_re = y.mo17670re();
        RealNum y_im = y.mo17669im();
