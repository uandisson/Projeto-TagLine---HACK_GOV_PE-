...
public abstract class Quantity extends Numeric {
    ...
    /* renamed from: re */
    public RealNum mo17670re() {
        return number().mo17670re();
    }

    /* renamed from: im */
    public RealNum mo17669im() {
        return number().mo17669im();
    }
    ...
    public double doubleValue() {
        return unit().doubleValue() * mo17670re().doubleValue();
    }

    public double doubleImagValue() {
        return unit().doubleValue() * mo17669im().doubleValue();
    }
