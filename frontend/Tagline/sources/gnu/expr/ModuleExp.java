        ...
        while (true) {
            ...
            if (decl2 != null) {
                if (decl2.field == null) {
                    ...
                    if ((!decl2.isSimple() || decl2.isPublic() || decl2.isNamespaceDecl() || (decl2.getFlag(PlaybackStateCompat.ACTION_PREPARE) && decl2.getFlag(6))) && !decl2.getFlag(PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH)) {
