...
public class Char implements Comparable, Externalizable {
    ...
    public static void print(int i, Consumer consumer) {
        ...
        if (i2 >= 65536) {
            ...
            out.write((int) (char) ((i2 & DoubleBits.EXPONENT_BIAS) + 56320));
            return;
        }
        ...
        if (this.value < 32 || this.value >= 127 || this.value == 39) {
            ...
            if (this.value == 39) {
                ...
                while (true) {
                    ...
                    StringBuffer append7 = buf.append(Dimension.SYM_P);
                }
                ...
                while (true) {
                    ...
                    StringBuffer append10 = buf.append(Dimension.SYM_P);
                }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        if (this.value > 55296) {
            if (this.value > 65535) {
                ...
                this.value = (this.value & DoubleBits.EXPONENT_BIAS) + 56320;
