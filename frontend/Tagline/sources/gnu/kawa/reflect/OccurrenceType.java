...
public class OccurrenceType extends ObjectType implements Externalizable, TypeValue {
    ...
    public static char itemCountCode(Type type) {
        ...
        int min = num & 4095;
        int max = num >> 12;
        return max == 0 ? Dimension.SYM_P : min == 0 ? max == 1 ? '?' : Dimension.SYM_DONTCARE : (min == 1 && max == 1) ? Dimension.SYM_L : '+';
    }
    ...
    public String toString() {
        ...
        if (!(this.minOccurs == 1 && this.maxOccurs == 1)) {
            if (this.minOccurs == 0 && this.maxOccurs == 1) {
                ...
                StringBuffer append6 = sbuf.append(Dimension.SYM_DONTCARE);
            } else {
                ...
                if (this.maxOccurs >= 0) {
                    ...
                    StringBuffer append11 = sbuf.append(Dimension.SYM_DONTCARE);
                }
