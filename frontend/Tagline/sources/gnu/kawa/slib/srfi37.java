...
public class srfi37 extends ModuleBody {
    ...
    public class frame extends ModuleBody {
        ...
        public static Object lambda1find(Object obj, Object obj2) {
            ...
            if (C1259lists.isNull(l2)) {
                l = Boolean.FALSE;
            } else if (Scheme.applyToArgs.apply2($Qu, C1259lists.car.apply1(l2)) != Boolean.FALSE) {
                l = C1259lists.car.apply1(l2);
            } else {
                l = lambda1find(C1259lists.cdr.apply1(l2), $Qu);
            }
            return l;
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:47:0x012e, code lost:
            if (kawa.lib.C1259lists.isPair(r5.args) == false) goto L_0x0142;
         */
        ...
        public java.lang.Object lambda3scanShortOptions(java.lang.Object r18, java.lang.Object r19, java.lang.Object r20, java.lang.Object r21) {
            ...
            L_0x0114:
                ...
                boolean r9 = kawa.lib.C1259lists.isPair(r9)
        ...
        public Object lambda4scanOperands(Object operands, Object seeds) {
            ...
            frame23.seeds = seeds;
            if (C1259lists.isNull(frame23.operands)) {
    ...
    public class frame1 extends ModuleBody {
        ...
        public Object lambda11$V(Object[] argsArray) {
            LList x = LList.makeList(argsArray, 0);
            LList lList = x;
            return this.staticLink.lambda5scanArgs(C1259lists.cdr.apply1(this.args), x);
        }
        ...
        public Object lambda10() {
            ...
            try {
                ...
                objArr5[2] = Char.make(this.name);
                Object[] objArr6 = objArr5;
                objArr6[3] = C1259lists.car.apply1(this.args);
                Object[] objArr7 = objArr6;
    ...
    public class frame2 extends ModuleBody {
        ...
        public Object lambda14() {
            return Scheme.apply.apply3(this.staticLink.operand$Mnproc, C1259lists.car.apply1(this.operands), this.seeds);
        }
        ...
        public Object lambda15$V(Object[] argsArray) {
            LList x = LList.makeList(argsArray, 0);
            LList lList = x;
            return this.staticLink.lambda4scanOperands(C1259lists.cdr.apply1(this.operands), x);
        }
    }
