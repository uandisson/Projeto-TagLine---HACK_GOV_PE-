...
public class srfi69 extends ModuleBody {
                ...
                try {
                    ...
                    while (true) {
                        ...
                        try {
                            ...
                            hashTableUpdate$Ex$SlDefault(hash$Mntable, C1259lists.car.apply1(elem), lambda$Fn1, C1259lists.cdr.apply1(elem));
                            obj8 = arg02.getCdr();
    ...
    public static hashtable.HashTable alist$To$HashTable(Object obj, Object obj2, Object obj3) {
        ...
        Object obj9 = obj8;
        try {
            objArr4[1] = Integer.valueOf(2 * C1259lists.length((LList) obj8));
    ...
    static Pair lambda2(Object key, Object obj, Object acc) {
        Object obj2 = obj;
        return C1259lists.cons(key, acc);
    }
    ...
    static Pair lambda3(Object obj, Object val, Object acc) {
        Object obj2 = obj;
        return C1259lists.cons(val, acc);
    }
