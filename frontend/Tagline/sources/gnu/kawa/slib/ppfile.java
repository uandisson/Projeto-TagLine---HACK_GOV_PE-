...
public class ppfile extends ModuleBody {
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda1(Object port) {
            ...
            Object outport = C1259lists.isNull(this.optarg) ? ports.current$Mnoutput$Mnport.apply0() : C1259lists.car.apply1(this.optarg);
                                ...
                                if (characters.isChar$Eq(ppfile.Lit0, (Char) obj4)) {
                                    ...
                                    try {
                                        ...
                                        if (x3) {
                                            ...
                                            Object prettyPrint = C1243pp.prettyPrint(Scheme.applyToArgs.apply2(this.staticLink.filter, o), export);
