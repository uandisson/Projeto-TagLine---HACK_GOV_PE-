...
public class syntaxutils extends ModuleBody {
        ...
        if (exp instanceof LetExp) {
            ...
            try {
                ...
                while (true) {
                    ...
                    frame3.pack = C1259lists.cons(decl.getSymbol(), frame3.pack);
                    firstDecl = decl.nextDecl();
                }
                objArr17[0] = C1259lists.reverse$Ex(frame3.pack);
    ...
    static Object unrewrite$St(Expression[] expressionArr) {
        ...
        while (true) {
            ...
            if (Scheme.numEqu.apply2(obj2, len) != Boolean.FALSE) {
                return C1259lists.reverse$Ex(frame03.pack);
            }
            frame03.pack = C1259lists.cons(unrewrite(exps[((Number) obj2).intValue()]), frame03.pack);
            valueOf = len;
    ...
    static Object unrewriteLet(LetExp letExp) {
        ...
        while (true) {
            ...
            if (decl != null) {
                frame13.pack = C1259lists.cons(LList.list2(decl.getSymbol(), unrewrite(exp.inits[((Number) obj2).intValue()])), frame13.pack);
                firstDecl = decl.nextDecl();
                obj = AddOp.$Pl.apply2(obj2, Lit8);
            } else {
                objArr7[0] = C1259lists.reverse$Ex(frame13.pack);
                Object[] objArr8 = objArr6;
