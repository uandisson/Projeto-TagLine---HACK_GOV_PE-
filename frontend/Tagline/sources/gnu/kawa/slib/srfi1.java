...
public class srfi1 extends ModuleBody {
    ...
    public static final ModuleMethod f819break;
    ...
    static {
        ...
        new SimpleSymbol(NewHtcHomeBadger.COUNT);
    ...
    public final void run(CallContext $ctx) {
        ...
        first = C1259lists.car;
        second = C1259lists.cadr;
        third = C1259lists.caddr;
        fourth = C1259lists.cadddr;
        map$Mnin$Mnorder = Scheme.map;
    }

    public static Pair xcons(Object d, Object a) {
        return C1259lists.cons(a, d);
    }
    ...
    public static Object makeList$V(Object obj, Object[] argsArray) {
        ...
        if (C1259lists.isNull(maybe$Mnelt)) {
            error$V = Boolean.FALSE;
        } else if (C1259lists.isNull(C1259lists.cdr.apply1(maybe$Mnelt))) {
            error$V = C1259lists.car.apply1(maybe$Mnelt);
        } else {
            error$V = misc.error$V("Too many arguments to MAKE-LIST", new Object[]{C1259lists.cons(len, maybe$Mnelt)});
        }
        Object elt = error$V;
        Object obj2 = len;
    ...
    public static Object listTabulate(Object obj, Procedure procedure) {
        ...
        while (true) {
            ...
            obj2 = C1259lists.cons(proc.apply1(i), len2);
        }
    }
    ...
    public static LList listCopy(LList lis) {
        ...
        while (true) {
            LList lis2 = lList;
            if (!C1259lists.isPair(lis2)) {
                return result;
            }
            LList p = C1259lists.cons(C1259lists.car.apply1(lis2), LList.Empty);
            if (prev == LList.Empty) {
                result = p;
            } else {
                LList lList2 = prev;
                LList lList3 = lList2;
                try {
                    C1259lists.setCdr$Ex((Pair) lList2, p);
            ...
            prev = p;
            lList = (LList) C1259lists.cdr.apply1(lis2);
        }
    }
    ...
    public static Object iota(IntNum intNum, Numeric numeric, Numeric numeric2) {
        ...
        try {
            ...
            while (true) {
                ...
                obj4 = C1259lists.cons(obj6, obj5);
            }
        } catch (ClassCastException e) {
            ClassCastException classCastException = e;
            Throwable th2 = th;
    ...
    public static Pair circularList$V(Object val1, Object[] argsArray) {
        ...
        LList lList = vals;
        Pair ans = C1259lists.cons(val1, vals);
        Object lastPair = lastPair(ans);
        Object obj = lastPair;
        try {
            C1259lists.setCdr$Ex((Pair) lastPair, ans);
            return ans;
        } catch (ClassCastException e) {
            ClassCastException classCastException = e;
            Throwable th2 = th;
    ...
    public static Object isProperList(Object obj) {
        ...
        while (true) {
            Object obj4 = obj3;
            Object x2 = obj2;
            if (C1259lists.isPair(x2)) {
                Object x3 = C1259lists.cdr.apply1(x2);
                if (C1259lists.isPair(x3)) {
                    Object apply1 = C1259lists.cdr.apply1(x3);
                    Object lag = C1259lists.cdr.apply1(obj4);
                    Object x4 = apply1;
                    ...
                    bool = C1259lists.isNull(x3) ? Boolean.TRUE : Boolean.FALSE;
                }
            } else {
                bool = C1259lists.isNull(x2) ? Boolean.TRUE : Boolean.FALSE;
            }
        }
        return bool;
    }
        ...
        while (true) {
            ...
            if (C1259lists.isPair(x2)) {
                ...
                if (C1259lists.isPair(x3)) {
                    ...
                    bool = C1259lists.isNull(x3) ? Boolean.FALSE : Boolean.TRUE;
                }
            } else {
                bool = C1259lists.isNull(x2) ? Boolean.FALSE : Boolean.TRUE;
            }
        }
        return bool;
    }
    ...
    public static Object isCircularList(Object obj) {
        ...
        while (true) {
            Object obj4 = obj3;
            Object x2 = obj2;
            boolean x3 = C1259lists.isPair(x2);
            if (x3) {
                Object x4 = C1259lists.cdr.apply1(x2);
                boolean x5 = C1259lists.isPair(x4);
                if (x5) {
                    Object apply1 = C1259lists.cdr.apply1(x4);
                    Object lag = C1259lists.cdr.apply1(obj4);
                    Object x6 = apply1;
                    boolean x7 = x6 == lag;
                    if (x7) {
    ...
    public static boolean isNotPair(Object x) {
        return ((C1259lists.isPair(x) ? 1 : 0) + true) & true;
    }
    ...
    public static Object list$Eq$V(Object obj, Object[] argsArray) {
        ...
        boolean x = C1259lists.isNull(lists);
        if (x) {
            $Eq = x ? Boolean.TRUE : Boolean.FALSE;
        } else {
            Object apply1 = C1259lists.car.apply1(lists);
            Object apply12 = C1259lists.cdr.apply1(lists);
            loop0:
            while (true) {
                Object obj2 = apply12;
                Object list$Mna = apply1;
                boolean x2 = C1259lists.isNull(obj2);
                if (x2) {
                    $Eq = x2 ? Boolean.TRUE : Boolean.FALSE;
                } else {
                    Object apply13 = C1259lists.car.apply1(obj2);
                    Object others = C1259lists.cdr.apply1(obj2);
                        ...
                        while (true) {
                            ...
                            if (isNullList(list$Mna2) != Boolean.FALSE) {
                                ...
                                try {
                                    ...
                                    if (x4) {
                                        Object x5 = Scheme.applyToArgs.apply3($Eq2, C1259lists.car.apply1(list$Mna2), C1259lists.car.apply1(obj5));
                                        if (x5 == Boolean.FALSE) {
                                            $Eq = x5;
                                            break loop0;
                                        }
                                        obj3 = C1259lists.cdr.apply1(list$Mna2);
                                        obj4 = C1259lists.cdr.apply1(obj5);
                                    } else {
    ...
    public static java.lang.Object length$Pl(java.lang.Object r15) {
        ...
        L_0x0008:
            r10 = r1
            boolean r10 = kawa.lib.C1259lists.isPair(r10)
            if (r10 == 0) goto L_0x0066
            gnu.expr.GenericProc r10 = kawa.lib.C1259lists.cdr
            r11 = r1
            ...
            r11 = r4
            java.lang.Object r10 = r10.apply1(r11)
            gnu.expr.GenericProc r11 = kawa.lib.C1259lists.cdr
            r12 = r2
    ...
    public static Object fifth(Object x) {
        return C1259lists.car.apply1(C1259lists.cddddr.apply1(x));
    }

    public static Object sixth(Object x) {
        return C1259lists.cadr.apply1(C1259lists.cddddr.apply1(x));
    }

    public static Object seventh(Object x) {
        return C1259lists.caddr.apply1(C1259lists.cddddr.apply1(x));
    }

    public static Object eighth(Object x) {
        return C1259lists.cadddr.apply1(C1259lists.cddddr.apply1(x));
    }

    public static Object ninth(Object x) {
        return C1259lists.car.apply1(C1259lists.cddddr.apply1(C1259lists.cddddr.apply1(x)));
    }

    public static Object tenth(Object x) {
        return C1259lists.cadr.apply1(C1259lists.cddddr.apply1(C1259lists.cddddr.apply1(x)));
    }

    public static Object car$PlCdr(Object obj) {
        Object pair = obj;
        Object[] objArr = new Object[2];
        objArr[0] = C1259lists.car.apply1(pair);
        Object[] objArr2 = objArr;
        objArr2[1] = C1259lists.cdr.apply1(pair);
        ...
        while (true) {
            ...
            try {
                if (numbers.isZero((Number) obj4)) {
                    ...
                    obj = C1259lists.cdr.apply1(lis2);
                    obj2 = AddOp.$Mn.apply2(obj3, Lit1);
                    lList = C1259lists.cons(C1259lists.car.apply1(lis2), lList2);
                }
    ...
    public static Object take$Ex(Object obj, IntNum intNum) {
        ...
        if (numbers.isZero(k)) {
            ...
            Object obj2 = drop2;
            try {
                C1259lists.setCdr$Ex((Pair) drop2, LList.Empty);
                lis = lis2;
            } catch (ClassCastException e) {
                ClassCastException classCastException = e;
                Throwable th2 = th;
    ...
    public static Object takeRight(Object obj, IntNum k) {
        ...
        while (true) {
            Object obj3 = drop2;
            Object lag = obj2;
            if (!C1259lists.isPair(obj3)) {
                return lag;
            }
            obj2 = C1259lists.cdr.apply1(lag);
            drop2 = C1259lists.cdr.apply1(obj3);
        }
    }
    ...
    public static Object lambda1recur(Object obj, Object obj2) {
        Object lag = obj;
        Object lead = obj2;
        return C1259lists.isPair(lead) ? C1259lists.cons(C1259lists.car.apply1(lag), lambda1recur(C1259lists.cdr.apply1(lag), C1259lists.cdr.apply1(lead))) : LList.Empty;
    }
    ...
    public static Object dropRight$Ex(Object obj, IntNum k) {
        ...
        if (C1259lists.isPair(lead)) {
            Object obj2 = lis2;
            Object apply1 = C1259lists.cdr.apply1(lead);
            while (true) {
                Object obj3 = apply1;
                lag = obj2;
                if (!C1259lists.isPair(obj3)) {
                ...
                obj2 = C1259lists.cdr.apply1(lag);
                apply1 = C1259lists.cdr.apply1(obj3);
            }
            Object obj4 = lag;
            Object obj5 = obj4;
            try {
                C1259lists.setCdr$Ex((Pair) obj4, LList.Empty);
                lis = lis2;
            } catch (ClassCastException e) {
                ClassCastException classCastException = e;
                Throwable th2 = th;
        ...
        while (true) {
            ...
            try {
                if (numbers.isZero((Number) obj5)) {
                    ...
                    LList lList4 = lList3;
                    try {
                        objArr3[0] = C1259lists.reverse$Ex(lList3);
                    ...
                    lList = C1259lists.cons(C1259lists.car.apply1(obj4), lList2);
                    obj = C1259lists.cdr.apply1(obj4);
                    obj2 = AddOp.$Mn.apply2(obj3, Lit1);
                }
            } catch (ClassCastException e2) {
                ClassCastException classCastException2 = e2;
    ...
    public static Object splitAt$Ex(Object obj, IntNum intNum) {
        ...
        if (numbers.isZero(k)) {
            ...
            Object suffix = C1259lists.cdr.apply1(prev);
            Object obj2 = prev;
            Object obj3 = obj2;
            try {
                C1259lists.setCdr$Ex((Pair) obj2, LList.Empty);
    ...
    public static Object last(Object lis) {
        ...
        Object obj2 = obj;
        try {
            return C1259lists.car.apply1(lastPair((Pair) obj));
        } catch (ClassCastException e) {
            ClassCastException classCastException = e;
            Throwable th2 = th;
    ...
    public static java.lang.Object lastPair(gnu.lists.Pair r5) {
        /*
            ...
            r1 = r3
        L_0x0003:
            gnu.expr.GenericProc r3 = kawa.lib.C1259lists.cdr
            r4 = r1
            java.lang.Object r3 = r3.apply1(r4)
            r2 = r3
            r3 = r2
            boolean r3 = kawa.lib.C1259lists.isPair(r3)
    ...
    public static LList unzip1(Object lis) {
        ...
        while (true) {
            ...
            try {
                ...
                obj = arg02.getCdr();
                obj2 = Pair.make(C1259lists.car.apply1(arg02.getCar()), obj3);
            } catch (ClassCastException e) {
                ClassCastException classCastException = e;
                Throwable th2 = th;
    ...
    public class frame extends ModuleBody {
        ...
        public static Object lambda2recur(Object lis) {
            ...
            if (srfi1.isNullList(frame02.lis) != Boolean.FALSE) {
                ...
                frame02.elt = C1259lists.car.apply1(frame02.lis);
    ...
    public class frame1 extends ModuleBody {
        ...
        public static Object lambda5recur(Object lis) {
            ...
            if (srfi1.isNullList(frame22.lis) != Boolean.FALSE) {
                ...
                frame22.elt = C1259lists.car.apply1(frame22.lis);
    ...
    public class frame2 extends ModuleBody {
        ...
        public Object lambda6() {
            return frame1.lambda5recur(C1259lists.cdr.apply1(this.lis));
        }
    ...
    public class frame3 extends ModuleBody {
        ...
        public static Object lambda8recur(Object lis) {
            ...
            if (srfi1.isNullList(frame42.lis) != Boolean.FALSE) {
                ...
                frame42.elt = C1259lists.car.apply1(frame42.lis);
    ...
    public class frame4 extends ModuleBody {
        ...
        public Object lambda9() {
            return frame3.lambda8recur(C1259lists.cdr.apply1(this.lis));
        }
    ...
    public class frame5 extends ModuleBody {
        ...
        public static Object lambda11recur(Object lis) {
            ...
            if (srfi1.isNullList(frame62.lis) != Boolean.FALSE) {
                ...
                frame62.elt = C1259lists.car.apply1(frame62.lis);
    ...
    public class frame6 extends ModuleBody {
        ...
        public Object lambda12() {
            return frame5.lambda11recur(C1259lists.cdr.apply1(this.lis));
        }
    ...
    public static java.lang.Object append$Ex$V(java.lang.Object[] r19) {
        ...
        L_0x0015:
            r11 = r2
            boolean r11 = kawa.lib.C1259lists.isPair(r11)
        ...
        L_0x001d:
            ...
            return r0
        L_0x001f:
            gnu.expr.GenericProc r11 = kawa.lib.C1259lists.car
            r12 = r2
            java.lang.Object r11 = r11.apply1(r12)
            gnu.expr.GenericProc r12 = kawa.lib.C1259lists.cdr
            r13 = r2
        ...
        L_0x004c:
            ...
            r12 = r8
            kawa.lib.C1259lists.setCdr$Ex(r11, r12)
            r11 = r8
            boolean r11 = kawa.lib.C1259lists.isPair(r11)
    ...
    public static Object appendReverse(Object rev$Mnhead, Object tail) {
        ...
        while (true) {
            ...
            obj = C1259lists.cdr.apply1(rev$Mnhead2);
            obj2 = C1259lists.cons(C1259lists.car.apply1(rev$Mnhead2), obj3);
        }
    }
    ...
    public static Object appendReverse$Ex(Object rev$Mnhead, Object tail) {
        ...
        while (true) {
            ...
            Object next$Mnrev = C1259lists.cdr.apply1(rev$Mnhead2);
            Object obj4 = rev$Mnhead2;
            Object obj5 = obj4;
            try {
                C1259lists.setCdr$Ex((Pair) obj4, obj3);
                obj = next$Mnrev;
                obj2 = rev$Mnhead2;
            } catch (ClassCastException e) {
                ClassCastException classCastException = e;
    ...
    public class frame55 extends ModuleBody {
        ...
        public Object lambda74recur(Object obj) {
            Object obj2;
            Object lists = obj;
            if (C1259lists.isPair(lists)) {
                Object lis = C1259lists.car.apply1(lists);
                obj2 = srfi1.isNullList(lis) != Boolean.FALSE ? this.abort.apply1(LList.Empty) : C1259lists.cons(C1259lists.cdr.apply1(lis), lambda74recur(C1259lists.cdr.apply1(lists)));
            } else {
                obj2 = LList.Empty;
            }
            return obj2;
    ...
    public class frame56 extends ModuleBody {
        ...
        public Object lambda75recur(Object obj) {
            Object lists = obj;
            return C1259lists.isPair(lists) ? C1259lists.cons(C1259lists.caar.apply1(lists), lambda75recur(C1259lists.cdr.apply1(lists))) : LList.list1(this.last$Mnelt);
        }
    }
    ...
    public class frame57 extends ModuleBody {
        ...
        public Object lambda76recur(Object lists) {
            ...
            if (C1259lists.isPair(frame583.lists)) {
    ...
    public class frame60 extends ModuleBody {
        ...
        public Object lambda82(Object cars, Object cdrs) {
            Object[] objArr = new Object[2];
            objArr[0] = C1259lists.cons(this.f136a, cars);
            Object[] objArr2 = objArr;
            objArr2[1] = C1259lists.cons(this.f137d, cdrs);
            return misc.values(objArr2);
        }
    ...
    public class frame63 extends ModuleBody {
        ...
        public Object lambda85recur(Object lists) {
            ...
            if (C1259lists.isPair(frame643.lists)) {
    ...
    public class frame66 extends ModuleBody {
        ...
        public Object lambda91(Object cars, Object cdrs) {
            Object[] objArr = new Object[2];
            objArr[0] = C1259lists.cons(this.f138a, cars);
            Object[] objArr2 = objArr;
            objArr2[1] = C1259lists.cons(this.f139d, cdrs);
            return misc.values(objArr2);
        }
    ...
    public class frame67 extends ModuleBody {
        ...
        public static Object lambda92recur(Object lists) {
            ...
            if (C1259lists.isPair(frame682.lists)) {
    ...
    public class frame70 extends ModuleBody {
        ...
        public Object lambda98(Object cars, Object cdrs) {
            Object[] objArr = new Object[2];
            objArr[0] = C1259lists.cons(this.f140a, cars);
            Object[] objArr2 = objArr;
            objArr2[1] = C1259lists.cons(this.f141d, cdrs);
            return misc.values(objArr2);
        }
    ...
    public static Object count$V(Procedure procedure, Object obj, Object[] argsArray) {
        ...
        if (C1259lists.isPair(lists)) {
            ...
            while (true) {
                ...
                Object a$Mns = C1259lists.car.apply1(split);
                Object d$Mns = C1259lists.cdr.apply1(split);
                if (C1259lists.isNull(a$Mns)) {
                    obj2 = i2;
                    break;
                }
                obj3 = C1259lists.cdr.apply1(list12);
                lList2 = d$Mns;
                if (Scheme.apply.apply3(pred, C1259lists.car.apply1(list12), a$Mns) != Boolean.FALSE) {
            ...
            while (true) {
                ...
                obj6 = C1259lists.cdr.apply1(lis);
                obj7 = pred.apply1(C1259lists.car.apply1(lis)) != Boolean.FALSE ? AddOp.$Pl.apply2(i, Lit1) : i;
            }
            obj2 = i;
        }
        return obj2;
    ...
    public static Object unfoldRight(Procedure procedure, Procedure procedure2, Procedure procedure3, Object seed, Object maybe$Mntail) {
        ...
        while (true) {
            ...
            obj = g.apply1(seed2);
            obj2 = C1259lists.cons(f.apply1(seed2), obj3);
        }
    }
    ...
    public static Object unfold$V(Procedure procedure, Procedure procedure2, Procedure procedure3, Object obj, Object[] argsArray) {
        ...
        if (C1259lists.isPair(maybe$Mntail$Mngen)) {
            Object tail$Mngen = C1259lists.car.apply1(maybe$Mntail$Mngen);
            if (C1259lists.isPair(C1259lists.cdr.apply1(maybe$Mntail$Mngen))) {
                ...
                while (true) {
                    ...
                    obj3 = g.apply1(seed);
                    obj4 = C1259lists.cons(f.apply1(seed), obj2);
                }
            ...
            while (true) {
                ...
                obj5 = g.apply1(seed3);
                lList3 = C1259lists.cons(f.apply1(seed3), lList);
            }
            LList lList4 = lList;
            LList lList5 = lList4;
            try {
                reverse$Ex = C1259lists.reverse$Ex(lList4);
            } catch (ClassCastException e) {
                ClassCastException classCastException = e;
                Throwable th2 = th;
    ...
    public static Object fold$V(Procedure kons, Object obj, Object obj2, Object[] argsArray) {
        ...
        LList lists = makeList;
        if (C1259lists.isPair(lists)) {
            obj4 = frame74.lambda14lp(C1259lists.cons(lis1, lists), knil);
        } else {
            Object obj5 = lis1;
            Object obj6 = knil;
            while (true) {
                ...
                obj5 = C1259lists.cdr.apply1(lis);
                obj6 = frame74.kons.apply2(C1259lists.car.apply1(lis), obj3);
            }
            obj4 = obj3;
        }
        return obj4;
    ...
    public class frame8 extends ModuleBody {
        ...
        public Object lambda16(Object obj, Object obj2) {
            ...
            Object cdrs = obj2;
            if (C1259lists.isNull(cars$Plans)) {
                lambda14lp = this.ans;
            } else {
    ...
    public static Object foldRight$V(Procedure kons, Object knil, Object obj, Object[] argsArray) {
        ...
        LList lists = makeList;
        if (C1259lists.isPair(lists)) {
            lambda18recur = frame93.lambda17recur(C1259lists.cons(lis1, lists));
        } else {
    ...
    public class frame9 extends ModuleBody {
        ...
        public Object lambda18recur(Object obj) {
            ...
            if (srfi1.isNullList(lis) != Boolean.FALSE) {
                ...
                apply2 = this.kons.apply2(C1259lists.car.apply1(lis), lambda18recur(C1259lists.cdr.apply1(lis)));
            }
            return apply2;
        }
    }
    ...
    public static Object pairFoldRight$V(Procedure f, Object zero, Object obj, Object[] argsArray) {
        ...
        LList lists = makeList;
        if (C1259lists.isPair(lists)) {
            lambda20recur = frame103.lambda19recur(C1259lists.cons(lis1, lists));
        } else {
    ...
    public class frame10 extends ModuleBody {
        ...
        public Object lambda20recur(Object obj) {
            Object lis = obj;
            return srfi1.isNullList(lis) != Boolean.FALSE ? this.zero : this.f121f.apply2(lis, lambda20recur(C1259lists.cdr.apply1(lis)));
        }
    }
    ...
    public static java.lang.Object pairFold$V(gnu.mapping.Procedure r16, java.lang.Object r17, java.lang.Object r18, java.lang.Object[] r19) {
        /*
            ...
            r4 = r8
            r8 = r4
            boolean r8 = kawa.lib.C1259lists.isPair(r8)
            if (r8 == 0) goto L_0x0057
            r8 = r2
            r9 = r4
            gnu.lists.Pair r8 = kawa.lib.C1259lists.cons(r8, r9)
            r9 = r1
            r6 = r9
            r5 = r8
        L_0x0023:
            ...
            r7 = r8
            r8 = r7
            boolean r8 = kawa.lib.C1259lists.isNull(r8)
        ...
        L_0x005b:
            ...
            goto L_0x0031
        L_0x0066:
            gnu.expr.GenericProc r8 = kawa.lib.C1259lists.cdr
            r9 = r5
    ...
    public static Object reduce(Procedure procedure, Object obj, Object obj2) {
        ...
        if (isNullList(lis) != Boolean.FALSE) {
            ...
            fold$V = fold$V(f, C1259lists.car.apply1(lis), C1259lists.cdr.apply1(lis), new Object[0]);
        }
        return fold$V;
    }
    ...
    public static Object reduceRight(Procedure f, Object obj, Object obj2) {
        ...
        if (isNullList(lis) != Boolean.FALSE) {
            ...
            lambda21recur = frame113.lambda21recur(C1259lists.car.apply1(lis), C1259lists.cdr.apply1(lis));
        }
    ...
    public class frame11 extends ModuleBody {
        ...
        public Object lambda21recur(Object obj, Object obj2) {
            ...
            Object head = obj;
            Object lis = obj2;
            if (C1259lists.isPair(lis)) {
                obj3 = this.f122f.apply2(head, lambda21recur(C1259lists.car.apply1(lis), C1259lists.cdr.apply1(lis)));
            } else {
                obj3 = head;
            }
            return obj3;
    ...
    public static java.lang.Object pairForEach$V(gnu.mapping.Procedure r10, java.lang.Object r11, java.lang.Object[] r12) {
        /*
            ...
            r3 = r6
            r6 = r3
            boolean r6 = kawa.lib.C1259lists.isPair(r6)
            if (r6 == 0) goto L_0x0038
            r6 = r1
            r7 = r3
            gnu.lists.Pair r6 = kawa.lib.C1259lists.cons(r6, r7)
            r4 = r6
        L_0x001c:
            r6 = r4
        ...
        L_0x003a:
            ...
            gnu.expr.GenericProc r6 = kawa.lib.C1259lists.cdr
            r7 = r4
    ...
    public static Object map$Ex$V(Procedure f, Object obj, Object[] argsArray) {
        ...
        if (C1259lists.isPair(lists)) {
            ...
            while (true) {
                ...
                Object heads = C1259lists.car.apply1(split);
                Object tails = C1259lists.cdr.apply1(split);
                Object obj4 = lis12;
                Object obj5 = obj4;
                try {
                    C1259lists.setCar$Ex((Pair) obj4, Scheme.apply.apply3(frame123.f123f, C1259lists.car.apply1(lis12), heads));
                    obj2 = C1259lists.cdr.apply1(lis12);
                    lList2 = tails;
                } catch (ClassCastException e) {
                    ClassCastException classCastException = e;
                    Throwable th2 = th;
    ...
    public static Object filterMap$V(Procedure f, Object obj, Object[] argsArray) {
        ...
        LList lists = makeList;
        if (C1259lists.isPair(lists)) {
            reverse$Ex = frame133.lambda23recur(C1259lists.cons(lis1, lists), LList.Empty);
        } else {
            Object obj2 = lis1;
            LList lList3 = LList.Empty;
            while (true) {
                ...
                Object apply1 = frame133.f124f.apply1(C1259lists.car.apply1(lis));
                Object tail = C1259lists.cdr.apply1(lis);
                Object head = apply1;
                if (head != Boolean.FALSE) {
                    obj2 = tail;
                    lList3 = C1259lists.cons(head, lList);
                } else {
                    obj2 = tail;
                    lList3 = lList;
                }
    ...
    public class frame14 extends ModuleBody {
        ...
        public Object lambda25(Object obj, Object obj2) {
            ...
            if (srfi1.isNotPair(cars)) {
                ...
                Object obj4 = obj3;
                try {
                    lambda23recur = C1259lists.reverse$Ex((LList) obj3);
                } catch (ClassCastException e) {
                    ClassCastException classCastException = e;
                    Throwable th2 = th;
                ...
                if (head != Boolean.FALSE) {
                    lambda23recur = this.staticLink.lambda23recur(cdrs, C1259lists.cons(head, this.res));
                } else {
    ...
    public static Object filter(Procedure procedure, Object lis) {
        ...
        while (true) {
            ...
            if (isNullList(lis2) != Boolean.FALSE) {
                ...
                Object apply1 = C1259lists.car.apply1(lis2);
                Object tail = C1259lists.cdr.apply1(lis2);
                Object head = apply1;
                if (pred.apply1(head) != Boolean.FALSE) {
                    obj = tail;
                    lList = C1259lists.cons(head, lList2);
                } else {
                    obj = tail;
                    lList = lList2;
                }
    ...
    public static Object filter$Ex(Procedure procedure, Object lis) {
        ...
        while (true) {
            ...
            if (isNullList(ans) != Boolean.FALSE) {
                obj = ans;
                break;
            } else if (pred.apply1(C1259lists.car.apply1(ans)) == Boolean.FALSE) {
                obj2 = C1259lists.cdr.apply1(ans);
            } else {
                Object obj3 = ans;
                Object apply1 = C1259lists.cdr.apply1(ans);
                loop1:
                while (true) {
                    Object obj4 = apply1;
                    Object prev = obj3;
                    if (!C1259lists.isPair(obj4)) {
                        break;
                    } else if (pred.apply1(C1259lists.car.apply1(obj4)) != Boolean.FALSE) {
                        obj3 = obj4;
                        apply1 = C1259lists.cdr.apply1(obj4);
                    } else {
                        Object prev2 = prev;
                        Object apply12 = C1259lists.cdr.apply1(obj4);
                        while (true) {
                            Object lis2 = apply12;
                            if (!C1259lists.isPair(lis2)) {
                                Object obj5 = prev2;
                                Object obj6 = obj5;
                                try {
                                    C1259lists.setCdr$Ex((Pair) obj5, lis2);
                                    break loop1;
                                } catch (ClassCastException e) {
                                    ClassCastException classCastException = e;
                                    Throwable th3 = th;
                            ...
                            } else if (pred.apply1(C1259lists.car.apply1(lis2)) != Boolean.FALSE) {
                                Object obj7 = prev2;
                                Object obj8 = obj7;
                                try {
                                    C1259lists.setCdr$Ex((Pair) obj7, lis2);
                                    obj3 = lis2;
                                    apply1 = C1259lists.cdr.apply1(lis2);
                                    break;
                                } catch (ClassCastException e2) {
                                    ClassCastException classCastException2 = e2;
                                    Throwable th4 = th2;
                                ...
                                apply12 = C1259lists.cdr.apply1(lis2);
                            }
                        }
                    }
                }
    ...
    public static Object partition(Procedure procedure, Object lis) {
        ...
        while (true) {
            ...
            if (isNullList(lis2) != Boolean.FALSE) {
                ...
                LList lList6 = lList5;
                try {
                    objArr3[0] = C1259lists.reverse$Ex(lList5);
                    Object[] objArr4 = objArr2;
                    Object[] objArr5 = objArr4;
                    ...
                    LList lList8 = lList7;
                    try {
                        objArr6[1] = C1259lists.reverse$Ex(lList7);
                        return misc.values(objArr5);
                    } catch (ClassCastException e) {
                        ClassCastException classCastException = e;
                        Throwable th3 = th2;
                ...
                if (pred.apply1(head) != Boolean.FALSE) {
                    obj = tail;
                    lList = C1259lists.cons(head, lList4);
                    lList2 = lList3;
                } else {
                    obj = tail;
                    lList = lList4;
                    lList2 = C1259lists.cons(head, lList3);
                }
            }
        }
    }
    ...
    public static Object partition$Ex(Procedure procedure, Object lis) {
        ...
        Throwable th4;
        Procedure pred = procedure;
        Pair cons = C1259lists.cons(Lit2, LList.Empty);
        Pair out$Mnhead = C1259lists.cons(Lit2, LList.Empty);
        Pair in$Mnhead = cons;
        Pair pair = in$Mnhead;
        ...
        while (true) {
            ...
            if (isNotPair(obj2)) {
                ...
                Pair pair5 = pair4;
                try {
                    C1259lists.setCdr$Ex(pair4, LList.Empty);
                    Object obj3 = out;
                    Object obj4 = obj3;
                    try {
                        C1259lists.setCdr$Ex((Pair) obj3, LList.Empty);
                        Object[] objArr = new Object[2];
                        objArr[0] = C1259lists.cdr.apply1(in$Mnhead);
                        Object[] objArr2 = objArr;
                        objArr2[1] = C1259lists.cdr.apply1(out$Mnhead);
                        return misc.values(objArr2);
                    } catch (ClassCastException e) {
                        ClassCastException classCastException = e;
                        Throwable th5 = th2;
            ...
            } else if (pred.apply1(C1259lists.car.apply1(obj2)) != Boolean.FALSE) {
                Pair pair6 = pair3;
                Pair pair7 = pair6;
                try {
                    C1259lists.setCdr$Ex(pair6, obj2);
                    pair = obj2;
                    pair2 = out;
                    obj = C1259lists.cdr.apply1(obj2);
                } catch (ClassCastException e3) {
                    ClassCastException classCastException3 = e3;
                    Throwable th7 = th4;
                ...
                Object obj6 = obj5;
                try {
                    C1259lists.setCdr$Ex((Pair) obj5, obj2);
                    pair = pair3;
                    pair2 = obj2;
                    obj = C1259lists.cdr.apply1(obj2);
    ...
    public class frame19 extends ModuleBody {
        ...
        public Object lambda30recur(Object obj) {
            ...
            if (srfi1.isNullList(lis) != Boolean.FALSE) {
                ...
                Object x = C1259lists.car.apply1(lis);
                Object tail = C1259lists.cdr.apply1(lis);
                Object new$Mntail = lambda30recur(srfi1.delete(x, tail, this.maybe$Mn$Eq));
                cons = tail == new$Mntail ? lis : C1259lists.cons(x, new$Mntail);
            }
            return cons;
        }
    }
    ...
    public static Pair alistCons(Object key, Object datum, Object alist) {
        return C1259lists.cons(C1259lists.cons(key, datum), alist);
    }
    ...
    public static LList alistCopy(Object alist) {
        ...
        while (true) {
            ...
            try {
                ...
                obj2 = Pair.make(C1259lists.cons(C1259lists.car.apply1(elt), C1259lists.cdr.apply1(elt)), obj3);
            } catch (ClassCastException e) {
                ClassCastException classCastException = e;
                Throwable th2 = th;
                new WrongType(classCastException, "arg0", -2, obj5);
    ...
    public static Object find(Object pred, Object list) {
        ...
        try {
            ...
            return temp != Boolean.FALSE ? C1259lists.car.apply1(temp) : Boolean.FALSE;
        } catch (ClassCastException e) {
            ClassCastException classCastException = e;
            Throwable th2 = th;
    ...
    public static Object findTail(Procedure procedure, Object list) {
        ...
        while (true) {
            ...
            try {
                ...
                } else if (pred.apply1(C1259lists.car.apply1(list2)) != Boolean.FALSE) {
                    obj = list2;
                    break;
                } else {
                    obj2 = C1259lists.cdr.apply1(list2);
                }
            } catch (ClassCastException e) {
                ClassCastException classCastException = e;
                Throwable th2 = th;
    ...
    public class frame23 extends ModuleBody {
        ...
        public Object lambda34recur(Object obj) {
            ...
            if (srfi1.isNullList(lis) != Boolean.FALSE) {
                ...
                Object x = C1259lists.car.apply1(lis);
                cons = this.pred.apply1(x) != Boolean.FALSE ? C1259lists.cons(x, lambda34recur(C1259lists.cdr.apply1(lis))) : LList.Empty;
            }
            return cons;
        }
    }
    ...
    public static Object dropWhile(Procedure procedure, Object lis) {
        ...
        while (true) {
            Object lis2 = obj2;
            if (isNullList(lis2) == Boolean.FALSE) {
                if (pred.apply1(C1259lists.car.apply1(lis2)) == Boolean.FALSE) {
                    obj = lis2;
                    break;
                }
                obj2 = C1259lists.cdr.apply1(lis2);
            } else {
                obj = LList.Empty;
                break;
            }
    ...
    public static Object takeWhile$Ex(Procedure procedure, Object obj) {
        ...
        if (x == Boolean.FALSE ? pred.apply1(C1259lists.car.apply1(lis)) != Boolean.FALSE : x == Boolean.FALSE) {
            Object obj3 = lis;
            Object apply1 = C1259lists.cdr.apply1(lis);
            while (true) {
                Object obj4 = apply1;
                Object prev = obj3;
                if (!C1259lists.isPair(obj4)) {
                ...
                if (pred.apply1(C1259lists.car.apply1(obj4)) != Boolean.FALSE) {
                    obj3 = obj4;
                    apply1 = C1259lists.cdr.apply1(obj4);
                } else {
                    Object obj5 = prev;
                    Object obj6 = obj5;
                    try {
                        C1259lists.setCdr$Ex((Pair) obj5, LList.Empty);
                        break;
                    } catch (ClassCastException e) {
                        ClassCastException classCastException = e;
                        Throwable th2 = th;
    ...
    public static Object span(Procedure procedure, Object lis) {
        ...
        while (true) {
            ...
            if (isNullList(lis2) != Boolean.FALSE) {
                ...
                Object head = C1259lists.car.apply1(lis2);
                if (pred.apply1(head) != Boolean.FALSE) {
                    obj = C1259lists.cdr.apply1(lis2);
                    lList = C1259lists.cons(head, lList2);
                } else {
                    ...
                    LList lList6 = lList5;
                    try {
                        objArr7[0] = C1259lists.reverse$Ex(lList5);
    ...
    public static Object span$Ex(Procedure procedure, Object obj) {
        ...
        if (x == Boolean.FALSE ? pred.apply1(C1259lists.car.apply1(lis)) != Boolean.FALSE : x == Boolean.FALSE) {
            ...
            while (true) {
                ...
                if (pred.apply1(C1259lists.car.apply1(obj3)) != Boolean.FALSE) {
                    obj2 = obj3;
                    apply1 = C1259lists.cdr.apply1(obj3);
                } else {
                    Object obj4 = prev;
    ...
    public static Object any$V(Procedure pred, Object lis1, Object[] argsArray) {
        ...
        if (C1259lists.isPair(frame263.lists)) {
            ...
            try {
                boolean x = ((isNullList != Boolean.FALSE ? 1 : 0) + 1) & true;
                if (x) {
                    Object apply1 = C1259lists.car.apply1(frame263.lis1);
                    Object apply12 = C1259lists.cdr.apply1(frame263.lis1);
                    while (true) {
                        Object obj3 = apply12;
                        Object head = apply1;
                        if (isNullList(obj3) != Boolean.FALSE) {
                        ...
                        apply1 = C1259lists.car.apply1(obj3);
                        apply12 = C1259lists.cdr.apply1(obj3);
                    }
                } else {
                    obj = x ? Boolean.TRUE : Boolean.FALSE;
                }
    ...
    public class frame26 extends ModuleBody {
        ...
        public Object lambda37() {
            return srfi1.$PcCars$PlCdrs(C1259lists.cons(this.lis1, this.lists));
        }
        ...
        public Object lambda38(Object obj, Object obj2) {
            ...
            Object heads = obj;
            Object tails = obj2;
            boolean x = C1259lists.isPair(heads);
            if (x) {
                Object obj4 = heads;
                Object obj5 = tails;
                while (true) {
                    ...
                    Object next$Mnheads = C1259lists.car.apply1(split);
                    Object next$Mntails = C1259lists.cdr.apply1(split);
                    if (!C1259lists.isPair(next$Mnheads)) {
    ...
    public static Object every$V(Procedure pred, Object lis1, Object[] argsArray) {
        ...
        if (!C1259lists.isPair(frame273.lists)) {
            Object x = isNullList(frame273.lis1);
            if (x == Boolean.FALSE) {
                Object apply12 = C1259lists.car.apply1(frame273.lis1);
                Object apply13 = C1259lists.cdr.apply1(frame273.lis1);
                while (true) {
                    Object obj = apply13;
                    Object head = apply12;
                    if (isNullList(obj) == Boolean.FALSE) {
                        ...
                        apply12 = C1259lists.car.apply1(obj);
                        apply13 = C1259lists.cdr.apply1(obj);
                    } else {
    ...
    public class frame27 extends ModuleBody {
        ...
        public Object lambda40(Object obj, Object obj2) {
            ...
            boolean x = ((C1259lists.isPair(heads) ? 1 : 0) + true) & true;
            if (x) {
    ...
    public static Object listIndex$V(Procedure pred, Object obj, Object[] argsArray) {
        ...
        LList lists = makeList;
        if (C1259lists.isPair(lists)) {
            obj2 = frame303.lambda44lp(C1259lists.cons(lis1, lists), Lit0);
        } else {
            Object obj3 = lis1;
            Object obj4 = Lit0;
            while (true) {
                ...
                try {
                    ...
                    } else if (frame303.pred.apply1(C1259lists.car.apply1(lis)) != Boolean.FALSE) {
                        obj2 = obj5;
                        break;
                    } else {
                        obj3 = C1259lists.cdr.apply1(lis);
    ...
    public static Object lset$Ls$Eq$V(Procedure procedure, Object[] argsArray) {
        ...
        LList lList = makeList;
        LList lists = makeList;
        boolean x = ((C1259lists.isPair(lists) ? 1 : 0) + true) & true;
        if (!x) {
            Object apply1 = C1259lists.car.apply1(lists);
            Object apply12 = C1259lists.cdr.apply1(lists);
            while (true) {
                Object obj2 = apply12;
                Object s1 = apply1;
                boolean x2 = ((C1259lists.isPair(obj2) ? 1 : 0) + true) & true;
                if (!x2) {
                    Object apply13 = C1259lists.car.apply1(obj2);
                    Object rest = C1259lists.cdr.apply1(obj2);
                    Object s2 = apply13;
                    boolean x3 = s2 == s1;
    ...
    public static Object lset$Eq$V(Procedure procedure, Object[] argsArray) {
        ...
        LList lList = makeList;
        LList lists = makeList;
        boolean x = (C1259lists.isPair(lists) + 1) & true;
        if (!x) {
            Object apply1 = C1259lists.car.apply1(lists);
            Object apply12 = C1259lists.cdr.apply1(lists);
            while (true) {
                Object obj2 = apply12;
                Object s1 = apply1;
                boolean x2 = (C1259lists.isPair(obj2) + 1) & true;
                if (!x2) {
                    Object apply13 = C1259lists.car.apply1(obj2);
                    Object rest = C1259lists.cdr.apply1(obj2);
                    Object s2 = apply13;
    ...
    public class frame33 extends ModuleBody {
        ...
        public Object lambda48(Object obj, Object obj2) {
            ...
            Object lis = obj;
            Object ans = obj2;
            if (C1259lists.isNull(lis)) {
                fold$V = ans;
            } else if (C1259lists.isNull(ans)) {
                fold$V = lis;
            } else if (lis == ans) {
                fold$V = ans;
            } else {
    ...
    public class frame35 extends ModuleBody {
        ...
        public Object lambda52(Object obj, Object obj2) {
            ...
            frame363.elt = C1259lists.car.apply1(pair);
            if (srfi1.any$V(frame363.lambda$Fn36, ans, new Object[0]) != Boolean.FALSE) {
                ...
                Object obj5 = obj4;
                try {
                    C1259lists.setCdr$Ex((Pair) obj4, ans);
                    obj3 = pair;
                } catch (ClassCastException e) {
                    ClassCastException classCastException = e;
                    Throwable th2 = th;
    ...
    public static Object lsetIntersection$V(Procedure $Eq, Object obj, Object[] argsArray) {
        ...
        if (any$V(null$Mnlist$Qu, frame373.lists, new Object[0]) != Boolean.FALSE) {
            filter2 = LList.Empty;
        } else if (C1259lists.isNull(frame373.lists)) {
            filter2 = lis1;
        } else {
    ...
    public class frame38 extends ModuleBody {
        ...
        public Object lambda55(Object lis) {
            return C1259lists.member(this.f128x, lis, this.staticLink.$Eq);
        }
    ...
    public static Object lsetIntersection$Ex$V(Procedure $Eq, Object obj, Object[] argsArray) {
        ...
        } else if (C1259lists.isNull(frame393.lists)) {
            filter$Ex2 = lis1;
        } else {
    ...
    public static Object lsetDifference$V(Procedure $Eq, Object obj, Object[] argsArray) {
        ...
        LList lists = LList.makeList(argsArray, 0);
        LList lList = lists;
        frame413.lists = filter(C1259lists.pair$Qu, lists);
        return C1259lists.isNull(frame413.lists) ? lis1 : C1259lists.memq(lis1, frame413.lists) != Boolean.FALSE ? LList.Empty : filter(frame413.lambda$Fn41, lis1);
    }
    ...
    public static Object lsetDifference$Ex$V(Procedure $Eq, Object obj, Object[] argsArray) {
        ...
        LList lists = LList.makeList(argsArray, 0);
        LList lList = lists;
        frame433.lists = filter(C1259lists.pair$Qu, lists);
        return C1259lists.isNull(frame433.lists) ? lis1 : C1259lists.memq(lis1, frame433.lists) != Boolean.FALSE ? LList.Empty : filter$Ex(frame433.lambda$Fn43, lis1);
    }
    ...
    public class frame44 extends ModuleBody {
        ...
        public boolean lambda61(Object lis) {
            return ((C1259lists.member(this.f131x, lis, this.staticLink.$Eq) != Boolean.FALSE ? 1 : 0) + 1) & true;
        }
    ...
    public class frame47 extends ModuleBody {
        ...
        public Object lambda65(Object obj, Object obj2) {
            Object xb = obj;
            Object ans = obj2;
            return C1259lists.member(xb, this.a$Mnint$Mnb, this.staticLink.staticLink.$Eq) != Boolean.FALSE ? ans : C1259lists.cons(xb, ans);
        }
    ...
    public class frame49 extends ModuleBody {
        ...
        public Object lambda68(Object obj, Object aIntB) {
            ...
            } else if (C1259lists.isNull(frame503.a$Mnint$Mnb)) {
                Object[] objArr = new Object[2];
                objArr[0] = this.f135b;
                Object[] objArr2 = objArr;
    ...
    public class frame50 extends ModuleBody {
        ...
        public Object lambda69(Object obj, Object obj2) {
            ...
            Object b$Mnpair = obj;
            Object ans = obj2;
            if (C1259lists.member(C1259lists.car.apply1(b$Mnpair), this.a$Mnint$Mnb, this.staticLink.staticLink.$Eq) != Boolean.FALSE) {
                obj3 = ans;
            } else {
    ...
    public static Object lsetDiff$PlIntersection$V(Procedure $Eq, Object obj, Object[] argsArray) {
        ...
        } else if (C1259lists.memq(lis1, frame513.lists) != Boolean.FALSE) {
            Object[] objArr3 = new Object[2];
            objArr3[0] = LList.Empty;
            Object[] objArr4 = objArr3;
            objArr4[1] = lis1;
    ...
    public static Object lsetDiff$PlIntersection$Ex$V(Procedure $Eq, Object obj, Object[] argsArray) {
        ...
        } else if (C1259lists.memq(lis1, frame533.lists) != Boolean.FALSE) {
            Object[] objArr3 = new Object[2];
            objArr3[0] = LList.Empty;
            Object[] objArr4 = objArr3;
            objArr4[1] = lis1;
        ...
        switch (moduleMethod2.selector) {
            ...
            case 122:
                ...
                try {
                    ...
                    ClassCastException classCastException = e;
                    Throwable th31 = th30;
                    new WrongType(classCastException, NewHtcHomeBadger.COUNT, 1, obj6);
                    throw th31;
                }
            case 123:
