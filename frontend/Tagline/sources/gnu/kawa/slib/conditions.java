...
public class conditions extends ModuleBody {
    ...
    public static condition.Mntype makeConditionType(Symbol symbol, condition.Mntype mntype, Object obj) {
        ...
        Object fields = obj;
        if (!C1259lists.isNull(srfi1.lsetIntersection$V(Scheme.isEq, supertype.all$Mnfields, new Object[]{fields}))) {
    ...
    static Object conditionTypeFieldSupertype(condition.Mntype condition$Mntype, Object obj) {
        ...
        while (true) {
            ...
            if (condition$Mntype2 == Boolean.FALSE) {
                obj2 = Boolean.FALSE;
                break;
            } else if (C1259lists.memq(field, condition$Mntype2.fields) != Boolean.FALSE) {
    ...
    public static condition makeCondition$V(condition.Mntype mntype, Object[] argsArray) {
        ...
        while (true) {
            ...
            try {
                ...
                obj2 = arg02.getCdr();
                obj3 = Pair.make(C1259lists.car.apply1(arg02.getCar()), obj);
            } catch (ClassCastException e) {
                ClassCastException classCastException = e;
                Throwable th2 = th;
        ...
        new condition(LList.list1(C1259lists.cons(type, alist)));
        return condition2;
    }
    ...
    public static Object lambda1label(Object obj) {
        Object plist;
        Object plist2 = obj;
        if (C1259lists.isNull(plist2)) {
            plist = LList.Empty;
        } else {
            plist = C1259lists.cons(C1259lists.cons(C1259lists.car.apply1(plist2), C1259lists.cadr.apply1(plist2)), lambda1label(C1259lists.cddr.apply1(plist2)));
        }
        return plist;
    }
    ...
    public static boolean isConditionHasType(Object condition2, condition.Mntype mntype) {
        ...
        while (true) {
            ...
            Object apply1 = C1259lists.car.apply1(types);
            Object obj = apply1;
            try {
                ...
                conditionTypes = C1259lists.cdr.apply1(types);
            } catch (ClassCastException e) {
                ClassCastException classCastException = e;
                Throwable th2 = th;
    ...
    static Object typeFieldAlistRef(Object type$Mnfield$Mnalist, Object obj) {
        ...
        while (true) {
            ...
            if (C1259lists.isNull(type$Mnfield$Mnalist2)) {
                Object[] objArr = new Object[2];
            ...
            Object temp = C1259lists.assq(field, C1259lists.cdr.apply1(C1259lists.car.apply1(type$Mnfield$Mnalist2)));
            if (temp != Boolean.FALSE) {
                error$V = C1259lists.cdr.apply1(temp);
                break;
            }
            obj2 = C1259lists.cdr.apply1(type$Mnfield$Mnalist2);
        }
        return error$V;
    }
    ...
    public static condition makeCompoundCondition$V(Object condition$Mn1, Object[] argsArray) {
        ...
        Object cons = C1259lists.cons(condition$Mn1, conditions);
    ...
    public static condition extractCondition(condition condition2, condition.Mntype type) {
        ...
        while (true) {
            ...
            Object arg0 = obj;
            if (arg0 == LList.Empty) {
                new condition(LList.list1(C1259lists.cons(mntype, LList.reverseInPlace(obj3))));
                return condition3;
            }
            Object obj4 = arg0;
            Object obj5 = obj4;
            try {
                Pair arg02 = (Pair) obj4;
                obj = arg02.getCdr();
                obj2 = Pair.make(C1259lists.assq(arg02.getCar(), C1259lists.cdr.apply1(entry)), obj3);
            } catch (ClassCastException e) {
                ClassCastException classCastException = e;
                Throwable th2 = th;
                new WrongType(classCastException, "arg0", -2, obj5);
    ...
    public class frame extends ModuleBody {
        ...
        public boolean lambda2(Object entry) {
            Throwable th;
            Object apply1 = C1259lists.car.apply1(entry);
            Object obj = apply1;
            try {
    ...
    public static condition typeFieldAlist$To$Condition(Object obj) {
        ...
        while (true) {
            ...
            try {
                ...
                Object apply1 = C1259lists.car.apply1(entry);
                Object obj8 = ((condition.Mntype) C1259lists.car.apply1(entry)).all$Mnfields;
                ...
                while (true) {
                    ...
                    try {
                        ...
                        Object x = C1259lists.assq(field, C1259lists.cdr.apply1(entry));
                        obj9 = Pair.make(x != Boolean.FALSE ? x : C1259lists.cons(field, typeFieldAlistRef(type$Mnfield$Mnalist, field)), obj2);
                    } catch (ClassCastException e) {
                        ClassCastException classCastException = e;
                        Throwable th3 = th2;
                ...
                obj4 = Pair.make(C1259lists.cons(apply1, LList.reverseInPlace(obj2)), obj5);
            } catch (ClassCastException e2) {
                ClassCastException classCastException2 = e2;
                Throwable th4 = th;
    ...
    static Object checkConditionTypeFieldAlist(Object obj) {
        ...
        while (true) {
            ...
            if (C1259lists.isNull(type$Mnfield$Mnalist)) {
                return Values.empty;
            }
            Object entry = C1259lists.car.apply1(type$Mnfield$Mnalist);
            Object apply1 = C1259lists.car.apply1(entry);
            Object obj4 = apply1;
            try {
                condition.Mntype type = (condition.Mntype) apply1;
                Object apply12 = C1259lists.cdr.apply1(entry);
                ...
                while (true) {
                    ...
                    try {
                        ...
                        obj5 = Pair.make(C1259lists.car.apply1(arg02.getCar()), obj2);
                    } catch (ClassCastException e) {
                        ClassCastException classCastException = e;
                        Throwable th6 = th5;
                ...
                while (true) {
                    ...
                    try {
                        ...
                        while (true) {
                            Object alist = obj10;
                            Object apply13 = C1259lists.car.apply1(C1259lists.car.apply1(alist));
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    obj10 = C1259lists.cdr.apply1(alist);
                                } catch (ClassCastException e2) {
                                    ClassCastException classCastException2 = e2;
                                    Throwable th7 = th4;
                ...
                obj3 = C1259lists.cdr.apply1(type$Mnfield$Mnalist);
