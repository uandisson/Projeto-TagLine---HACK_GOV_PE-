...
public class printf extends ModuleBody {
    ...
    static {
        ...
        objArr16[15] = GMLConstants.GML_COORD_Z;
        Object[] objArr17 = objArr16;
        objArr17[16] = GMLConstants.GML_COORD_Y;
        ...
        public Object lambda5(Object obj, Object sgn, Object digs, Object ex) {
            ...
            if (Scheme.numEqu.apply2(i, Integer.valueOf(this.f112n)) != Boolean.FALSE) {
                ...
                try {
                    ...
                    Object obj6 = obj5;
                    try {
                        if (C1259lists.memv(Char.make(strings.stringRef(charSequence, ((Number) obj5).intValue())), printf.Lit2) != Boolean.FALSE) {
        ...
        public Object lambda13(Object i, Object fdigs) {
            ...
            if (Scheme.numGEq.apply2(i2, Integer.valueOf(this.staticLink.staticLink.staticLink.f112n)) != Boolean.FALSE) {
                ...
                try {
                    ...
                    Object obj4 = obj3;
                    try {
                        if (C1259lists.memv(Char.make(strings.stringRef(charSequence, ((Number) obj3).intValue())), printf.Lit10) != Boolean.FALSE) {
    ...
    public static java.lang.Object stdio$ClIprintf$V(java.lang.Object r29, java.lang.Object r30, java.lang.Object[] r31) {
        ...
        L_0x04e7:
            ...
            java.lang.Object r0 = r0.args
            r19 = r0
            boolean r19 = kawa.lib.C1259lists.isNull(r19)
            ...
            java.lang.Object r19 = kawa.lib.C1259lists.memv(r19, r20)
            java.lang.Boolean r20 = java.lang.Boolean.FALSE
            r0 = r19
            r1 = r20
            ...
            gnu.lists.LList r0 = r0.args
            r23 = r0
            int r23 = kawa.lib.C1259lists.length(r23)
        ...
        L_0x058a:
            ...
            java.lang.Object r0 = r0.out
            r20 = r0
            gnu.expr.GenericProc r21 = kawa.lib.C1259lists.car
            r22 = r9
            r0 = r22
            java.lang.Object r0 = r0.args
            r22 = r0
        ...
        L_0x05b2:
            ...
            gnu.expr.GenericProc r19 = kawa.lib.C1259lists.cdr
            r20 = r9
            r0 = r20
            java.lang.Object r0 = r0.args
            r20 = r0
        ...
        L_0x066e:
            gnu.expr.GenericProc r19 = kawa.lib.C1259lists.car
            r20 = r9
            r0 = r20
            java.lang.Object r0 = r0.args
            r20 = r0
        ...
        L_0x0e70:
            r19 = r6
            gnu.expr.GenericProc r20 = kawa.lib.C1259lists.car
            r21 = r9
            r0 = r21
            java.lang.Object r0 = r0.args
            r21 = r0
    ...
    public class frame9 extends ModuleBody {
        ...
        public Object lambda21out$St(Object obj) {
            ...
            if (!strings.isString(strs)) {
                ...
                while (true) {
                    Object strs2 = obj3;
                    boolean x = C1259lists.isNull(strs2);
                    if (!x) {
                        Object x2 = Scheme.applyToArgs.apply2(this.out, C1259lists.car.apply1(strs2));
                        if (x2 == Boolean.FALSE) {
                            obj2 = x2;
                            break;
                        }
                        obj3 = C1259lists.cdr.apply1(strs2);
                    } else {
    ...
    public class frame10 extends ModuleBody {
        ...
        public Object lambda22readFormatNumber() {
            ...
            if (Scheme.isEqv.apply2(printf.Lit66, this.staticLink.f119fc) != Boolean.FALSE) {
                ...
                Object ans = C1259lists.car.apply1(this.args);
                this.args = C1259lists.cdr.apply1(this.args);
                obj2 = ans;
            } else {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (Scheme.numGEq.apply2(obj6, this.width) != Boolean.FALSE) {
                        cons = C1259lists.cons(pre, strs);
                        break;
                    } else if (!C1259lists.isNull(obj5)) {
                        AddOp addOp = AddOp.$Pl;
                        Object obj7 = obj6;
                        ...
                        try {
                            ...
                            cons = C1259lists.cons(obj9, append.append$V(objArr3));
                        } catch (ClassCastException e2) {
                            ClassCastException classCastException2 = e2;
                            Throwable th7 = th4;
                        ...
                        try {
                            cons = C1259lists.cons(obj11, C1259lists.cons(strings.makeString(((Number) apply22).intValue(), printf.Lit9), strs));
                        } catch (ClassCastException e3) {
                            ClassCastException classCastException3 = e3;
                            Throwable th8 = th3;
                        ...
                        try {
                            cons = C1259lists.cons(strings.makeString(((Number) apply23).intValue(), printf.Lit29), C1259lists.cons(pre, strs));
                        } catch (ClassCastException e4) {
                            ClassCastException classCastException4 = e4;
                            Throwable th9 = th2;
    ...
    public class frame11 extends ModuleBody {
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            try {
                                                ...
                                                list3 = C1259lists.cons(charSequence3, (!x ? !x : this.staticLink.alternate$Mnform != Boolean.FALSE) ? LList.list2(".", fdigs) : LList.Empty);
                                            } catch (ClassCastException e2) {
                                                ClassCastException classCastException2 = e2;
                                                Throwable th13 = th11;
        ...
        public java.lang.Object lambda30formatReal$V(java.lang.Object r29, java.lang.Object r30, java.lang.Object r31, java.lang.Object r32, java.lang.Object[] r33) {
            /*
                ...
                r8 = r17
                r17 = r8
                boolean r17 = kawa.lib.C1259lists.isNull(r17)
            ...
            L_0x01a6:
                ...
                gnu.lists.Pair r19 = gnu.lists.LList.chain1(r19, r20)
            L_0x01c2:
                gnu.lists.Pair r17 = kawa.lib.C1259lists.cons(r17, r18)
            L_0x01c6:
                r2 = r17
                return r2
            L_0x01c9:
