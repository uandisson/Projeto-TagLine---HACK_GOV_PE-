...
public class genwrite extends ModuleBody {
    ...
    public class frame extends ModuleBody {
        ...
        public static Object lambda1isReadMacro(Object obj) {
            ...
            Object x2;
            Object l = obj;
            Object apply1 = C1259lists.car.apply1(l);
            Object tail = C1259lists.cdr.apply1(l);
            Object head = apply1;
            ...
            if (x3 == Boolean.FALSE ? (x = Scheme.isEqv.apply2(head, genwrite.Lit31)) == Boolean.FALSE ? (x2 = Scheme.isEqv.apply2(head, genwrite.Lit32)) == Boolean.FALSE ? Scheme.isEqv.apply2(head, genwrite.Lit33) == Boolean.FALSE : x2 == Boolean.FALSE : x == Boolean.FALSE : x3 == Boolean.FALSE) {
                ...
                Object l2 = tail;
                boolean x4 = C1259lists.isPair(l2);
                bool = x4 ? C1259lists.isNull(C1259lists.cdr.apply1(l2)) ? Boolean.TRUE : Boolean.FALSE : x4 ? Boolean.TRUE : Boolean.FALSE;
            }
            return bool;
        }

        public static Object lambda2readMacroBody(Object l) {
            return C1259lists.cadr.apply1(l);
        }

        public static Object lambda3readMacroPrefix(Object obj) {
            String l;
            Object l2 = obj;
            Object apply1 = C1259lists.car.apply1(l2);
            Object apply12 = C1259lists.cdr.apply1(l2);
            Object head = apply1;
        ...
        public java.lang.Object lambda5wr(java.lang.Object r23, java.lang.Object r24) {
            /*
                ...
                r4 = r24
                r13 = r3
                boolean r13 = kawa.lib.C1259lists.isPair(r13)
            ...
            L_0x0039:
                ...
                gnu.expr.GenericProc r13 = kawa.lib.C1259lists.cdr
                r14 = r8
                ...
                r14 = r2
                gnu.expr.GenericProc r15 = kawa.lib.C1259lists.car
                r16 = r8
            ...
            L_0x009a:
                r13 = r11
                boolean r13 = kawa.lib.C1259lists.isNull(r13)
    ...
    public class frame0 extends ModuleBody {
        ...
        public Object lambda7pr(Object obj, Object obj2, Object obj3, Object obj4) {
            ...
            boolean x = C1259lists.isPair(obj5);
            if (!x ? !vectors.isVector(obj5) : !x) {
                ...
                } else if (C1259lists.isPair(obj5)) {
        ...
        public Object lambda8ppExpr(Object obj, Object obj2, Object obj3) {
            ...
            if (frame.lambda1isReadMacro(expr) != Boolean.FALSE) {
                ...
                Object head = C1259lists.car.apply1(expr);
        ...
        public Object lambda9ppCall(Object obj, Object obj2, Object obj3, Object obj4) {
            ...
            Object col$St = this.staticLink.lambda5wr(C1259lists.car.apply1(expr), this.staticLink.lambda4out("(", col));
            if (col != Boolean.FALSE) {
                obj5 = lambda11ppDown(C1259lists.cdr.apply1(expr), col$St, AddOp.$Pl.apply2(col$St, genwrite.Lit17), extra, pp$Mnitem);
            } else {
                obj5 = col;
            }
            return obj5;
        ...
        public Object lambda11ppDown(Object l, Object col1, Object obj, Object obj2, Object obj3) {
            ...
            while (true) {
                ...
                if (obj8 == Boolean.FALSE) {
                    obj4 = obj8;
                    break;
                } else if (C1259lists.isPair(l2)) {
                    Object rest = C1259lists.cdr.apply1(l2);
                    obj6 = rest;
                    obj7 = lambda7pr(C1259lists.car.apply1(l2), lambda6indent(col2, obj8), C1259lists.isNull(rest) ? AddOp.$Pl.apply2(obj5, genwrite.Lit17) : genwrite.Lit1, pp$Mnitem);
                } else {
                    obj4 = C1259lists.isNull(l2) ? this.staticLink.lambda4out(")", obj8) : this.staticLink.lambda4out(")", lambda7pr(l2, lambda6indent(col2, this.staticLink.lambda4out(".", lambda6indent(col2, obj8))), AddOp.$Pl.apply2(obj5, genwrite.Lit17), pp$Mnitem));
                }
            }
            return obj4;
        }
        ...
        public Object lambda12ppGeneral(Object obj, Object obj2, Object obj3, Object obj4, Object obj5, Object obj6, Object obj7) {
            ...
            Object pp$Mn3 = obj7;
            Object head = C1259lists.car.apply1(expr);
            Object rest = C1259lists.cdr.apply1(expr);
            Object col$St = this.staticLink.lambda5wr(head, this.staticLink.lambda4out("(", col));
            if (named$Qu == Boolean.FALSE ? named$Qu == Boolean.FALSE : !C1259lists.isPair(rest)) {
                ...
                Object name = C1259lists.car.apply1(rest);
                Object rest2 = C1259lists.cdr.apply1(rest);
                Object col$St$St = this.staticLink.lambda5wr(name, this.staticLink.lambda4out(" ", col$St));
            ...
            if (pp$Mn1 == Boolean.FALSE ? pp$Mn1 == Boolean.FALSE : !C1259lists.isPair(obj10)) {
                obj11 = apply2;
                obj12 = obj8;
                obj13 = obj9;
                obj14 = obj10;
            } else {
                Object val1 = C1259lists.car.apply1(obj10);
                Object rest3 = C1259lists.cdr.apply1(obj10);
                obj11 = apply2;
                obj12 = lambda7pr(val1, lambda6indent(apply2, obj8), C1259lists.isNull(rest3) ? AddOp.$Pl.apply2(extra, genwrite.Lit17) : genwrite.Lit1, pp$Mn1);
                obj13 = obj9;
                obj14 = rest3;
            }
            if (pp$Mn2 == Boolean.FALSE ? pp$Mn2 == Boolean.FALSE : !C1259lists.isPair(obj14)) {
                obj15 = obj12;
                obj16 = obj13;
                obj17 = obj14;
            } else {
                Object val12 = C1259lists.car.apply1(obj14);
                Object rest4 = C1259lists.cdr.apply1(obj14);
                obj15 = lambda7pr(val12, lambda6indent(obj11, obj12), C1259lists.isNull(rest4) ? AddOp.$Pl.apply2(extra, genwrite.Lit17) : genwrite.Lit1, pp$Mn2);
                obj16 = obj13;
                obj17 = rest4;
            }
        ...
        public Object lambda19pp$MnLET(Object obj, Object obj2, Object obj3) {
            ...
            Object extra = obj3;
            Object rest = C1259lists.cdr.apply1(expr);
            boolean x = C1259lists.isPair(rest);
            return lambda12ppGeneral(expr, col, extra, x ? misc.isSymbol(C1259lists.car.apply1(rest)) : x ? Boolean.TRUE : Boolean.FALSE, this.pp$Mnexpr$Mnlist, Boolean.FALSE, this.pp$Mnexpr);
        }
    ...
    public class frame1 extends ModuleBody {
        ...
        public boolean lambda22(Object obj) {
            Throwable th;
            Object str = obj;
            this.result = C1259lists.cons(str, this.result);
            Object obj2 = str;
            Object obj3 = obj2;
            try {
    ...
    public static java.lang.Object lambda23revStringAppend(java.lang.Object r16, java.lang.Object r17) {
        /*
            ...
            gnu.expr.GenericProc r8 = kawa.lib.C1259lists.car
            r9 = r0
