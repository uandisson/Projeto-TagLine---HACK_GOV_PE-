...
public class enums extends ModuleBody {
    ...
    static LList mapNames(Symbol symbol, LList lList, int i) {
        ...
        int i2 = i;
        if (C1259lists.isNull(e$Mnnames)) {
            cons = LList.Empty;
        } else {
            Symbol symbol2 = t$Mnname;
            Object apply1 = C1259lists.car.apply1(e$Mnnames);
            Object obj = apply1;
            try {
                Object makeFieldDesc = makeFieldDesc(symbol2, (Symbol) apply1, i2);
                Symbol symbol3 = t$Mnname;
                Object apply12 = C1259lists.cdr.apply1(e$Mnnames);
                Object obj2 = apply12;
                try {
                    cons = C1259lists.cons(makeFieldDesc, mapNames(symbol3, (LList) apply12, i2 + 1));
                } catch (ClassCastException e) {
                    ClassCastException classCastException = e;
                    Throwable th3 = th2;
        ...
        if (Lit22.match(form2, allocVars, 0)) {
            ...
            try {
                ...
                try {
                    ...
                    int length = C1259lists.length(e$Mnnames);
