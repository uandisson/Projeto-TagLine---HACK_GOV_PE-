...
public class syntax extends ModuleBody {
    ...
    public static final Macro f823import = Macro.make(Lit36, Lit37, $instance);
    ...
    public static final Macro f824synchronized;
    ...
    static {
        ...
        f824synchronized = Macro.make(Lit25, procedure2, $instance);
    ...
    public static Object importHandleOnly(Object obj, Object list) {
        Object name = obj;
        return C1259lists.memq(name, list) != Boolean.FALSE ? name : null;
    }
    ...
    public static Object importHandleExcept(Object obj, Object list) {
        Object name = obj;
        return C1259lists.memq(name, list) != Boolean.FALSE ? null : name;
    }
    ...
    public static Object importHandleRename(Object obj, Object obj2) {
        ...
        if (!C1259lists.isPair(rename$Mnpairs)) {
            name = name2;
        } else if (name2 == C1259lists.caar.apply1(rename$Mnpairs)) {
            name = C1259lists.cadar.apply1(rename$Mnpairs);
        } else {
            name = importHandleRename(name2, C1259lists.cdr.apply1(rename$Mnpairs));
        }
        return name;
    }
        ...
        public Object lambda1(Object name) {
            ...
            while (true) {
                ...
                if (x) {
                    ...
                    obj3 = Scheme.applyToArgs.apply3(C1259lists.caar.apply1(l), obj, C1259lists.cdar.apply1(l));
                } else if (C1259lists.isNull(l)) {
                    break;
                } else {
                    obj2 = C1259lists.cdr.apply1(l);
                    obj3 = Scheme.applyToArgs.apply3(C1259lists.caar.apply1(l), obj, C1259lists.cdar.apply1(l));
    ...
    static Object lambda4(Object obj) {
        ...
        if (Lit39.match(form2, allocVars, 0)) {
            if (isIdentifierPairList(Lit40.execute(allocVars, TemplateScope.make()))) {
                ...
                objArr9[0] = C1259lists.cons(C1259lists.cons(import$Mnhandle$Mnrename, Lit42.execute(allocVars, make)), Lit43.execute(allocVars, make));
                Object[] objArr10 = objArr9;
            ...
            if (isIdentifierList(Lit47.execute(allocVars, TemplateScope.make()))) {
                ...
                objArr16[0] = C1259lists.cons(C1259lists.cons(import$Mnhandle$Mnonly, Lit49.execute(allocVars, make2)), Lit50.execute(allocVars, make2));
                Object[] objArr17 = objArr16;
            ...
            if (isIdentifierList(Lit54.execute(allocVars, TemplateScope.make()))) {
                ...
                objArr23[0] = C1259lists.cons(C1259lists.cons(import$Mnhandle$Mnexcept, Lit56.execute(allocVars, make3)), Lit57.execute(allocVars, make3));
                Object[] objArr24 = objArr23;
            ...
            objArr30[0] = C1259lists.cons(C1259lists.cons(import$Mnhandle$Mnprefix, Lit62.execute(allocVars, make4)), Lit63.execute(allocVars, make4));
            Object[] objArr31 = objArr30;
