...
public class misc_syntax extends ModuleBody {
    ...
    static Object lambda1(Object obj) {
        ...
        if (Lit1.match(form2, allocVars, 0)) {
            ...
            try {
                ...
                form = C1259lists.cons(execute, C1259lists.cons(std_syntax.datum$To$SyntaxObject(obj3, misc.string$To$Symbol(strings.stringAppend(objArr4))), Lit4.execute(allocVars, TemplateScope.make())));
    ...
    static Object lambda3(Object obj) {
        ...
        if (Lit13.match(x2, allocVars, 0)) {
            ...
            new frame();
            frame frame3 = frame2;
            frame3.f265k = execute;
            Object obj3 = fn;
            Object obj4 = obj3;
            try {
                frame3.f266p = ports.openInputFile(Path.valueOf(obj3));
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda4f() {
            LList lList;
            LList lList2;
            Object x = ports.read(this.f266p);
            if (ports.isEofObject(x)) {
                Object closeInputPort = ports.closeInputPort(this.f266p);
                lList2 = LList.Empty;
            } else {
                lList2 = lList;
                new Pair(std_syntax.datum$To$SyntaxObject(this.f265k, x), lambda4f());
            }
            return lList2;
        }
    }
