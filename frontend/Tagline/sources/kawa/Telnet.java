...
public class Telnet implements Runnable {
    ...
    /* renamed from: DO */
    public static final int f257DO = 253;
    ...
    /* renamed from: SB */
    static final int f259SB = 250;

    /* renamed from: SE */
    static final int f260SE = 240;
    public static final int SUPPRESS_GO_AHEAD = 3;

    /* renamed from: TM */
    static final int f261TM = 6;
    static final int TTYPE = 24;
    public static final int WILL = 251;
    public static final int WONT = 252;

    /* renamed from: in */
    TelnetInputStream f262in;
    boolean isServer;
            ...
            case 0:
                if (wantOn) {
                    if (!change(command, option)) {
                        ...
                        state2 = 5;
                        this.out.writeCommand(otherSide ? f257DO : WILL, option);
                        break;
                    }
                } else {
                    return;
