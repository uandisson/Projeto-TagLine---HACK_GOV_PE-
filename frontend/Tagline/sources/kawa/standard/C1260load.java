...
public class C1260load extends Procedure1 {
    public static final C1260load load;
    public static final C1260load loadRelative;
    boolean relative;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C1260load(String name, boolean relative2) {
        super(name);
    ...
    static {
        C1260load load2;
        C1260load load3;
        new C1260load("load", false);
        load = load2;
        new C1260load("load-relative", true);
        loadRelative = load3;
    }
