...
public class C1261location extends Syntax {
    public static final C1261location location;
    private static ClassType thisType = ClassType.make("kawa.standard.location");

    public C1261location() {
    }

    static {
        C1261location location2;
        new C1261location();
        location = location2;
    ...
    public Expression rewrite(Object obj, Translator translator) {
        ...
        C1261location location2 = location;
