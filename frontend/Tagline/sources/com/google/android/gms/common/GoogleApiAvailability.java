...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public void showErrorNotification(Context context, int i) {
        int i2 = i;
        Context context2 = context;
        zaa(context2, i2, (String) null, getErrorResolutionPendingIntent(context2, i2, 0, RsaJsonWebKey.MODULUS_MEMBER_NAME));
    }
    ...
    public void setDefaultNotificationChannelId(@NonNull Context context, @NonNull String str) {
        ...
        if (PlatformVersion.isAtLeastO()) {
            Object checkNotNull = Preconditions.checkNotNull(((NotificationManager) context2.getSystemService(OneSignalDbContract.NotificationTable.TABLE_NAME)).getNotificationChannel(str2));
        }
        Object obj = mLock;
        Object obj2 = obj;
        synchronized (obj) {
