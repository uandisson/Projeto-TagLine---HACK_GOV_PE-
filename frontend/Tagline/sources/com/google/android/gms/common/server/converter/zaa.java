...
public final class zaa extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getStringToIntConverter", mo21370id = 2)
    private final StringToIntConverter zapl;

    @SafeParcelable.Constructor
    zaa(@SafeParcelable.Param(mo21373id = 1) int i, @SafeParcelable.Param(mo21373id = 2) StringToIntConverter stringToIntConverter) {
        this.zalf = i;
