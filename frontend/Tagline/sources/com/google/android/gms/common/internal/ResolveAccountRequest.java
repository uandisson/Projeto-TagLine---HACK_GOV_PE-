...
public class ResolveAccountRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getSessionId", mo21370id = 3)
    private final int zapa;
    @SafeParcelable.Field(getter = "getSignInAccountHint", mo21370id = 4)
    private final GoogleSignInAccount zapb;
    @SafeParcelable.Field(getter = "getAccount", mo21370id = 2)
    private final Account zax;

    @SafeParcelable.Constructor
    ResolveAccountRequest(@SafeParcelable.Param(mo21373id = 1) int i, @SafeParcelable.Param(mo21373id = 2) Account account, @SafeParcelable.Param(mo21373id = 3) int i2, @SafeParcelable.Param(mo21373id = 4) GoogleSignInAccount googleSignInAccount) {
        this.zalf = i;
        this.zax = account;
        this.zapa = i2;
