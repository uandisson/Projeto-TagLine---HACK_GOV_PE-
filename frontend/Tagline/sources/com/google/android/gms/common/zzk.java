...
public final class zzk extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getAllowTestKeys", mo21370id = 3)
    private final boolean zzaa;
    @SafeParcelable.Field(defaultValue = "false", getter = "getForbidTestKeys", mo21370id = 4)
    private final boolean zzab;
    @SafeParcelable.Field(getter = "getCallingPackage", mo21370id = 1)
    private final String zzy;
    @SafeParcelable.Field(getter = "getCallingCertificateBinder", mo21370id = 2, type = "android.os.IBinder")
    @Nullable
    private final zze zzz;

    @SafeParcelable.Constructor
    zzk(@SafeParcelable.Param(mo21373id = 1) String str, @SafeParcelable.Param(mo21373id = 2) @Nullable IBinder iBinder, @SafeParcelable.Param(mo21373id = 3) boolean z, @SafeParcelable.Param(mo21373id = 4) boolean z2) {
        this.zzy = str;
