...
public class Feature extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getName", mo21370id = 1)
    private final String name;
    @SafeParcelable.Field(getter = "getOldVersion", mo21370id = 2)
    @Deprecated
    private final int zzk;
    @SafeParcelable.Field(defaultValue = "-1", getter = "getVersion", mo21370id = 3)
    ...
    public Feature(@SafeParcelable.Param(mo21373id = 1) String str, @SafeParcelable.Param(mo21373id = 2) int i, @SafeParcelable.Param(mo21373id = 3) long j) {
        this.name = str;
        this.zzk = i;
        this.zzl = j;
    }
