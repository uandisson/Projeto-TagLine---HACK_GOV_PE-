...
public final class ConnectionErrorMessages {
    @GuardedBy("sCache")
    private static final C1625SimpleArrayMap<String, String> zaog;
    ...
    private static String zaa(Context context, String str) {
        ...
        Context context2 = context;
        String str6 = str;
        C1625SimpleArrayMap<String, String> simpleArrayMap = zaog;
        C1625SimpleArrayMap<String, String> simpleArrayMap2 = simpleArrayMap;
        synchronized (simpleArrayMap) {
            try {
                ...
                int identifier = resources.getIdentifier(str6, "string", "com.google.android.gms");
                int i = identifier;
                if (identifier == 0) {
                ...
                Throwable th2 = th;
                C1625SimpleArrayMap<String, String> simpleArrayMap3 = simpleArrayMap2;
                throw th2;
            }
        }
    }
    ...
    static {
        C1625SimpleArrayMap<String, String> simpleArrayMap;
