...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", mo21370id = 2)
    private final int zzh;
    @SafeParcelable.Field(getter = "getResolution", mo21370id = 3)
    private final PendingIntent zzi;
    @SafeParcelable.Field(getter = "getErrorMessage", mo21370id = 4)
    private final String zzj;

    @SafeParcelable.Constructor
    ConnectionResult(@SafeParcelable.Param(mo21373id = 1) int i, @SafeParcelable.Param(mo21373id = 2) int i2, @SafeParcelable.Param(mo21373id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(mo21373id = 4) String str) {
        this.zzg = i;
        this.zzh = i2;
