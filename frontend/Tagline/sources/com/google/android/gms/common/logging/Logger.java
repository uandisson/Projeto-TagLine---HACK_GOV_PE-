...
public class Logger {
    ...
    @KeepForSdk
    /* renamed from: v */
    public void mo21425v(String str, @Nullable Object... objArr) {
        String str2 = str;
    ...
    @KeepForSdk
    /* renamed from: d */
    public void mo21420d(String str, @Nullable Object... objArr) {
        String str2 = str;
        Object[] objArr2 = objArr;
        if (isLoggable(3)) {
    ...
    @KeepForSdk
    /* renamed from: i */
    public void mo21423i(String str, @Nullable Object... objArr) {
        int i = Log.i(this.mTag, format(str, objArr));
    }

    @KeepForSdk
    /* renamed from: w */
    public void mo21426w(String str, @Nullable Object... objArr) {
        int w = Log.w(this.mTag, format(str, objArr));
    }

    @KeepForSdk
    /* renamed from: e */
    public void mo21422e(String str, @Nullable Object... objArr) {
        int e = Log.e(this.mTag, format(str, objArr));
    }

    @KeepForSdk
    /* renamed from: e */
    public void mo21421e(String str, Throwable th, @Nullable Object... objArr) {
