...
public class ClientIdentity extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "0", mo21370id = 1)
    private final int uid;

    @SafeParcelable.Constructor
    public ClientIdentity(@SafeParcelable.Param(mo21373id = 1) int i, @Nullable @SafeParcelable.Param(mo21373id = 2) String str) {
        this.uid = i;
    ...
    public String toString() {
        ...
        return sb.append(i).append(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR).append(str).toString();
    }
