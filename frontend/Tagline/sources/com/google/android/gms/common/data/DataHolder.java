...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @SafeParcelable.VersionField(mo21376id = 1000)
    private final int zalf;
    @SafeParcelable.Field(getter = "getColumns", mo21370id = 1)
    private final String[] zalq;
    private Bundle zalr;
    @SafeParcelable.Field(getter = "getWindows", mo21370id = 2)
    private final CursorWindow[] zals;
    @SafeParcelable.Field(getter = "getStatusCode", mo21370id = 3)
    private final int zalt;
    @SafeParcelable.Field(getter = "getMetadata", mo21370id = 4)
    ...
    DataHolder(@SafeParcelable.Param(mo21373id = 1000) int i, @SafeParcelable.Param(mo21373id = 1) String[] strArr, @SafeParcelable.Param(mo21373id = 2) CursorWindow[] cursorWindowArr, @SafeParcelable.Param(mo21373id = 3) int i2, @SafeParcelable.Param(mo21373id = 4) Bundle bundle) {
        this.mClosed = false;
        this.zalx = true;
        this.zalf = i;
        this.zalq = strArr;
