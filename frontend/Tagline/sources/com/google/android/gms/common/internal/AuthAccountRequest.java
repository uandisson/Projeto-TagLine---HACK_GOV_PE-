...
public class AuthAccountRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(mo21370id = 6, type = "android.accounts.Account")
    private Account zax;

    @SafeParcelable.Constructor
    AuthAccountRequest(@SafeParcelable.Param(mo21373id = 1) int i, @SafeParcelable.Param(mo21373id = 2) IBinder iBinder, @SafeParcelable.Param(mo21373id = 3) Scope[] scopeArr, @SafeParcelable.Param(mo21373id = 4) Integer num, @SafeParcelable.Param(mo21373id = 5) Integer num2, @SafeParcelable.Param(mo21373id = 6) Account account) {
        this.zalf = i;
        this.zanx = iBinder;
        this.zany = scopeArr;
        this.zanz = num;
