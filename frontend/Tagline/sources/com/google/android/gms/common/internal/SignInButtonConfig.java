...
public class SignInButtonConfig extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getScopes", mo21370id = 4)
    @Deprecated
    private final Scope[] zany;
    @SafeParcelable.Field(getter = "getButtonSize", mo21370id = 2)
    private final int zapd;
    @SafeParcelable.Field(getter = "getColorScheme", mo21370id = 3)
    private final int zape;

    @SafeParcelable.Constructor
    SignInButtonConfig(@SafeParcelable.Param(mo21373id = 1) int i, @SafeParcelable.Param(mo21373id = 2) int i2, @SafeParcelable.Param(mo21373id = 3) int i3, @SafeParcelable.Param(mo21373id = 4) Scope[] scopeArr) {
        this.zalf = i;
        this.zapd = i2;
        this.zape = i3;
        this.zany = scopeArr;
