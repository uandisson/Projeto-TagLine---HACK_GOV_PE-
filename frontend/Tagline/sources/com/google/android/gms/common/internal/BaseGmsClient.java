                ...
                synchronized (obj3) {
                    try {
                        ...
                        if (this.zzbw > 0) {
                            ...
                            append6.println(sb3.append(j).append(" ").append(format).toString());
                        }
                        if (this.zzbv > 0) {
                            ...
                            append11.println(sb2.append(j2).append(" ").append(format2).toString());
                        }
                        if (this.zzby > 0) {
                            ...
                            append13.println(sb.append(j3).append(" ").append(format3).toString());
                        }
                    } catch (Throwable th) {
                        while (true) {
                            Throwable th2 = th;
