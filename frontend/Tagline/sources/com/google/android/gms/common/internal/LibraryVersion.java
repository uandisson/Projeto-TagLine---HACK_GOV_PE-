    ...
    public String getVersion(@NonNull String str) {
        ...
        try {
            ...
            if (resourceAsStream != null) {
                ...
                str7 = properties2.getProperty("version", (String) null);
                GmsLogger gmsLogger = zzel;
                String str8 = str7;
                new StringBuilder(12 + String.valueOf(str6).length() + String.valueOf(str8).length());
                gmsLogger.mo21314v("LibraryVersion", sb.append(str6).append(" version is ").append(str8).toString());
            } else {
                ...
                gmsLogger2.mo21307e("LibraryVersion", str5);
            }
        } catch (IOException e) {
            ...
            gmsLogger3.mo21308e("LibraryVersion", str3, iOException);
        }
        if (str7 == null) {
            str7 = "UNKNOWN";
            zzel.mo21305d("LibraryVersion", ".properties file is dropped during release process. Failure to read app version isexpected druing Google internal testing where locally-built libraries are used");
        }
