...
public class GetServiceRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(mo21370id = 2)
    private final int zzdg;
    @SafeParcelable.Field(mo21370id = 3)
    private int zzdh;
    @SafeParcelable.Field(mo21370id = 5)
    IBinder zzdi;
    @SafeParcelable.Field(mo21370id = 6)
    Scope[] zzdj;
    @SafeParcelable.Field(mo21370id = 7)
    Bundle zzdk;
    @SafeParcelable.Field(mo21370id = 8)
    Account zzdl;
    @SafeParcelable.Field(mo21370id = 10)
    Feature[] zzdm;
    @SafeParcelable.Field(mo21370id = 11)
    Feature[] zzdn;
    @SafeParcelable.Field(mo21370id = 12)
    private boolean zzdo;
    @SafeParcelable.Field(mo21370id = 4)
    String zzy;
    ...
    GetServiceRequest(@SafeParcelable.Param(mo21373id = 1) int i, @SafeParcelable.Param(mo21373id = 2) int i2, @SafeParcelable.Param(mo21373id = 3) int i3, @SafeParcelable.Param(mo21373id = 4) String str, @SafeParcelable.Param(mo21373id = 5) IBinder iBinder, @SafeParcelable.Param(mo21373id = 6) Scope[] scopeArr, @SafeParcelable.Param(mo21373id = 7) Bundle bundle, @SafeParcelable.Param(mo21373id = 8) Account account, @SafeParcelable.Param(mo21373id = 10) Feature[] featureArr, @SafeParcelable.Param(mo21373id = 11) Feature[] featureArr2, @SafeParcelable.Param(mo21373id = 12) boolean z) {
        int i4 = i;
        String str2 = str;
