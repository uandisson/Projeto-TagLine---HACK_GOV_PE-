...
public class zaj extends zal {
    ...
    public final void zaa(int i, GoogleApiClient googleApiClient, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
        ...
        int d = Log.d("AutoManageHelper", sb2.append("starting AutoManage for client ").append(i2).append(" ").append(z2).append(" ").append(valueOf).toString());
    ...
    public void onStart() {
        ...
        int d = Log.d("AutoManageHelper", sb.append("onStart ").append(z).append(" ").append(valueOf).toString());
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        for (int i = 0; i < this.zacw.size(); i++) {
            ...
            if (zab != null) {
                ...
                printWriter3.println(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR);
