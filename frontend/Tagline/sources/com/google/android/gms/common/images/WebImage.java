...
public final class WebImage extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getWidth", mo21370id = 3)
    private final int zane;
    @SafeParcelable.Field(getter = "getHeight", mo21370id = 4)
    private final int zanf;
    @SafeParcelable.Field(getter = "getUrl", mo21370id = 2)
    private final Uri zang;

    @SafeParcelable.Constructor
    WebImage(@SafeParcelable.Param(mo21373id = 1) int i, @SafeParcelable.Param(mo21373id = 2) Uri uri, @SafeParcelable.Param(mo21373id = 3) int i2, @SafeParcelable.Param(mo21373id = 4) int i3) {
        this.zalf = i;
        this.zang = uri;
        this.zane = i2;
        this.zanf = i3;
