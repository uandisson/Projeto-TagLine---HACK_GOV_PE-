...
public class ResolveAccountResponse extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getConnectionResult", mo21370id = 3)
    private ConnectionResult zadi;
    @SafeParcelable.Field(getter = "getSaveDefaultAccount", mo21370id = 4)
    private boolean zagg;
    @SafeParcelable.VersionField(mo21376id = 1)
    private final int zalf;
    @SafeParcelable.Field(mo21370id = 2)
    private IBinder zanx;
    @SafeParcelable.Field(getter = "isFromCrossClientAuth", mo21370id = 5)
    private boolean zapc;

    @SafeParcelable.Constructor
    ResolveAccountResponse(@SafeParcelable.Param(mo21373id = 1) int i, @SafeParcelable.Param(mo21373id = 2) IBinder iBinder, @SafeParcelable.Param(mo21373id = 3) ConnectionResult connectionResult, @SafeParcelable.Param(mo21373id = 4) boolean z, @SafeParcelable.Param(mo21373id = 5) boolean z2) {
        this.zalf = i;
        this.zanx = iBinder;
