...
public class AvailabilityException extends Exception {
    private final C1617ArrayMap<zai<?>, ConnectionResult> zaay;

    public AvailabilityException(C1617ArrayMap<zai<?>, ConnectionResult> arrayMap) {
        this.zaay = arrayMap;
    }
    ...
    public final C1617ArrayMap<zai<?>, ConnectionResult> zaj() {
        return this.zaay;
    }
