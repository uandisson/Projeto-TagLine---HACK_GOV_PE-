...
public final class DynamiteModule {
    ...
    public static DynamiteModule load(Context context, VersionPolicy versionPolicy, String str) throws LoadingException {
        ...
        try {
            ...
            int i3 = Log.i("DynamiteModule", sb.append("Considering local module ").append(str4).append(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR).append(i).append(" and remote module ").append(str4).append(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR).append(i2).toString());
