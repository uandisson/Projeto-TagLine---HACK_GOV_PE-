...
public class GcmReceiver extends WakefulBroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        boolean z2 = (intent4.getFlags() & Declaration.IS_DYNAMIC) != 0;
        if (!z || z2) {
            ...
            if (!PlatformVersion.isAtLeastO() || zze != 402) {
                ...
                i = ErrorMessages.ERROR_NXT_INVALID_RETURN_PACKAGE;
            }
        } else {
    ...
    private static int zze(Context context, Intent intent) {
        ...
        try {
            ...
            return ErrorMessages.ERROR_NXT_BLUETOOTH_NOT_SET;
            ...
            return ErrorMessages.ERROR_NXT_NOT_CONNECTED_TO_ROBOT;
        }
    }
}
