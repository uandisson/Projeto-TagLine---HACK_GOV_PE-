            ...
            switch (message2.what) {
                case 1:
                    ...
                    if (!data.isEmpty()) {
                        ...
                        if (messenger != null) {
                            String string = bundle.getString(HeaderParameterNames.AUTHENTICATION_TAG);
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        try {
            ...
            if (SERVICE_ACTION_EXECUTE_TASK.equals(action)) {
                String stringExtra = intent2.getStringExtra(HeaderParameterNames.AUTHENTICATION_TAG);
