...
public final class zaj extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getConnectionResult", mo21370id = 2)
    private final ConnectionResult zadi;
    @SafeParcelable.VersionField(mo21376id = 1)
    private final int zalf;
    @SafeParcelable.Field(getter = "getResolveAccountResponse", mo21370id = 3)
    private final ResolveAccountResponse zase;

    @SafeParcelable.Constructor
    zaj(@SafeParcelable.Param(mo21373id = 1) int i, @SafeParcelable.Param(mo21373id = 2) ConnectionResult connectionResult, @SafeParcelable.Param(mo21373id = 3) ResolveAccountResponse resolveAccountResponse) {
        this.zalf = i;
