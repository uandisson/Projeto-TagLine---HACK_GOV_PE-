...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Api.ApiOptions.Optional, ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "isForceCodeForRefreshToken", mo21370id = 6)
    public final boolean zaaa;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getServerClientId", mo21370id = 7)
    public String zaab;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getHostedDomain", mo21370id = 8)
    public String zaac;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getExtensions", mo21370id = 9)
    ...
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getScopes", mo21370id = 2)
    public final ArrayList<Scope> zaw;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getAccount", mo21370id = 3)
    public Account zax;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "isIdTokenRequested", mo21370id = 4)
    public boolean zay;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "isServerAuthCodeRequested", mo21370id = 5)
    ...
    GoogleSignInOptions(@SafeParcelable.Param(mo21373id = 1) int i, @SafeParcelable.Param(mo21373id = 2) ArrayList<Scope> arrayList, @SafeParcelable.Param(mo21373id = 3) Account account, @SafeParcelable.Param(mo21373id = 4) boolean z, @SafeParcelable.Param(mo21373id = 5) boolean z2, @SafeParcelable.Param(mo21373id = 6) boolean z3, @SafeParcelable.Param(mo21373id = 7) String str, @SafeParcelable.Param(mo21373id = 8) String str2, @SafeParcelable.Param(mo21373id = 9) ArrayList<GoogleSignInOptionsExtensionParcelable> arrayList2) {
