...
public final class zzm extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "null", mo21370id = 3)
    @Nullable
    private String tag;
    @SafeParcelable.Field(defaultValueUnchecked = "DeviceOrientationRequestInternal.DEFAULT_DEVICE_ORIENTATION_REQUEST", mo21370id = 1)
    private zzj zzcf;
    @SafeParcelable.Field(defaultValueUnchecked = "DeviceOrientationRequestInternal.DEFAULT_CLIENTS", mo21370id = 2)
    ...
    zzm(@SafeParcelable.Param(mo21373id = 1) zzj zzj, @SafeParcelable.Param(mo21373id = 2) List<ClientIdentity> list, @SafeParcelable.Param(mo21373id = 3) String str) {
        this.zzcf = zzj;
        this.zzm = list;
        this.tag = str;
    }
