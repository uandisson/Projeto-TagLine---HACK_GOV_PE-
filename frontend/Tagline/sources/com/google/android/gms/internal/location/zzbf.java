...
public final class zzbf extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "null", mo21370id = 4)
    private PendingIntent zzbv;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequestUpdateData.OPERATION_ADD", mo21370id = 1)
    private int zzcg;
    @SafeParcelable.Field(defaultValueUnchecked = "null", getter = "getFusedLocationProviderCallbackBinder", mo21370id = 6, type = "android.os.IBinder")
    private zzaj zzcj;
    @SafeParcelable.Field(defaultValueUnchecked = "null", mo21370id = 2)
    private zzbd zzdl;
    @SafeParcelable.Field(defaultValueUnchecked = "null", getter = "getLocationListenerBinder", mo21370id = 3, type = "android.os.IBinder")
    private zzx zzdm;
    @SafeParcelable.Field(defaultValueUnchecked = "null", getter = "getLocationCallbackBinder", mo21370id = 5, type = "android.os.IBinder")
    private zzu zzdn;
    ...
    zzbf(@SafeParcelable.Param(mo21373id = 1) int i, @SafeParcelable.Param(mo21373id = 2) zzbd zzbd, @SafeParcelable.Param(mo21373id = 3) IBinder iBinder, @SafeParcelable.Param(mo21373id = 4) PendingIntent pendingIntent, @SafeParcelable.Param(mo21373id = 5) IBinder iBinder2, @SafeParcelable.Param(mo21373id = 6) IBinder iBinder3) {
        zzaj zzaj;
        zzaj zzaj2;
