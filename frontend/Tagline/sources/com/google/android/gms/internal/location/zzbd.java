...
public final class zzbd extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "null", mo21370id = 10)
    @Nullable
    private String moduleId;
    @SafeParcelable.Field(defaultValueUnchecked = "null", mo21370id = 6)
    @Nullable
    private String tag;
    @SafeParcelable.Field(defaultValueUnchecked = "null", mo21370id = 1)
    private LocationRequest zzdg;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_HIDE_FROM_APP_OPS", mo21370id = 7)
    private boolean zzdh;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_FORCE_COARSE_LOCATION", mo21370id = 8)
    private boolean zzdi;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_EXEMPT_FROM_THROTTLE", mo21370id = 9)
    private boolean zzdj;
    private boolean zzdk = true;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_CLIENTS", mo21370id = 5)
    ...
    zzbd(@SafeParcelable.Param(mo21373id = 1) LocationRequest locationRequest, @SafeParcelable.Param(mo21373id = 5) List<ClientIdentity> list, @SafeParcelable.Param(mo21373id = 6) @Nullable String str, @SafeParcelable.Param(mo21373id = 7) boolean z, @SafeParcelable.Param(mo21373id = 8) boolean z2, @SafeParcelable.Param(mo21373id = 9) boolean z3, @SafeParcelable.Param(mo21373id = 10) String str2) {
