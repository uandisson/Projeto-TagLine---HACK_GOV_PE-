...
public final class zzbh extends AbstractSafeParcelable implements Geofence {
    ...
    @SafeParcelable.Field(getter = "getRequestId", mo21370id = 1)
    private final String zzad;
    @SafeParcelable.Field(getter = "getTransitionTypes", mo21370id = 7)
    private final int zzae;
    @SafeParcelable.Field(getter = "getType", mo21370id = 3)
    private final short zzag;
    @SafeParcelable.Field(getter = "getLatitude", mo21370id = 4)
    private final double zzah;
    @SafeParcelable.Field(getter = "getLongitude", mo21370id = 5)
    private final double zzai;
    @SafeParcelable.Field(getter = "getRadius", mo21370id = 6)
    private final float zzaj;
    @SafeParcelable.Field(defaultValue = "0", getter = "getNotificationResponsiveness", mo21370id = 8)
    private final int zzak;
    @SafeParcelable.Field(defaultValue = "-1", getter = "getLoiteringDelay", mo21370id = 9)
    private final int zzal;
    @SafeParcelable.Field(getter = "getExpirationTime", mo21370id = 2)
    ...
    public zzbh(@SafeParcelable.Param(mo21373id = 1) String str, @SafeParcelable.Param(mo21373id = 7) int i, @SafeParcelable.Param(mo21373id = 3) short s, @SafeParcelable.Param(mo21373id = 4) double d, @SafeParcelable.Param(mo21373id = 5) double d2, @SafeParcelable.Param(mo21373id = 6) float f, @SafeParcelable.Param(mo21373id = 2) long j, @SafeParcelable.Param(mo21373id = 8) int i2, @SafeParcelable.Param(mo21373id = 9) int i3) {
        String str2;
        String str3;
        Throwable th;
        StringBuilder sb;
