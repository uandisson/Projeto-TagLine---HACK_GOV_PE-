...
public final class zzo extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "DeviceOrientationRequestUpdateData.OPERATION_ADD", mo21370id = 1)
    private int zzcg;
    @SafeParcelable.Field(defaultValueUnchecked = "null", mo21370id = 2)
    private zzm zzch;
    @SafeParcelable.Field(defaultValueUnchecked = "null", getter = "getDeviceOrientationListenerBinder", mo21370id = 3, type = "android.os.IBinder")
    private zzr zzci;
    @SafeParcelable.Field(defaultValueUnchecked = "null", getter = "getFusedLocationProviderCallbackBinder", mo21370id = 4, type = "android.os.IBinder")
    private zzaj zzcj;
    ...
    zzo(@SafeParcelable.Param(mo21373id = 1) int i, @SafeParcelable.Param(mo21373id = 2) zzm zzm, @SafeParcelable.Param(mo21373id = 3) IBinder iBinder, @SafeParcelable.Param(mo21373id = 4) IBinder iBinder2) {
        zzaj zzaj;
        zzaj zzaj2;
