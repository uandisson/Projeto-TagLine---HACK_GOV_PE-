...
public class GeofencingRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getParcelableGeofences", mo21370id = 1)
    private final List<zzbh> zzap;
    @SafeParcelable.Field(getter = "getInitialTrigger", mo21370id = 2)
    ...
    GeofencingRequest(@SafeParcelable.Param(mo21373id = 1) List<zzbh> list, @SafeParcelable.Param(mo21373id = 2) int i, @SafeParcelable.Param(mo21373id = 3) String str) {
        this.zzap = list;
        this.zzaq = i;
        this.tag = str;
    }
