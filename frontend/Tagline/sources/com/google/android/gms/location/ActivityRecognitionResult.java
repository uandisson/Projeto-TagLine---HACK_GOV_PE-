...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(mo21370id = 1)
    ...
    public ActivityRecognitionResult(@SafeParcelable.Param(mo21373id = 1) List<DetectedActivity> list, @SafeParcelable.Param(mo21373id = 2) long j, @SafeParcelable.Param(mo21373id = 3) long j2, @SafeParcelable.Param(mo21373id = 4) int i, @SafeParcelable.Param(mo21373id = 5) Bundle bundle) {
