...
public final class LocationAvailability extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNKNOWN", mo21370id = 1)
    @Deprecated
    private int zzar;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNKNOWN", mo21370id = 2)
    @Deprecated
    private int zzas;
    @SafeParcelable.Field(defaultValueUnchecked = "0", mo21370id = 3)
    private long zzat;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNSUCCESSFUL", mo21370id = 4)
    private int zzau;
    ...
    LocationAvailability(@SafeParcelable.Param(mo21373id = 4) int i, @SafeParcelable.Param(mo21373id = 1) int i2, @SafeParcelable.Param(mo21373id = 2) int i3, @SafeParcelable.Param(mo21373id = 3) long j, @SafeParcelable.Param(mo21373id = 5) zzaj[] zzajArr) {
        this.zzau = i;
        this.zzar = i2;
        this.zzas = i3;
        this.zzat = j;
