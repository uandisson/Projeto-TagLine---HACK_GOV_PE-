...
public final class LocationSettingsResult extends AbstractSafeParcelable implements Result {
    ...
    @SafeParcelable.Field(getter = "getStatus", mo21370id = 1)
    private final Status zzbl;
    @SafeParcelable.Field(getter = "getLocationSettingsStates", mo21370id = 2)
    ...
    public LocationSettingsResult(@SafeParcelable.Param(mo21373id = 1) Status status, @SafeParcelable.Param(mo21373id = 2) LocationSettingsStates locationSettingsStates) {
        this.zzbl = status;
