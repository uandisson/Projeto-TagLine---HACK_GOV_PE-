...
public class PlaceReport extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getTag", mo21370id = 3)
    private final String tag;
    @SafeParcelable.VersionField(mo21376id = 1)
    private final int versionCode;
    @SafeParcelable.Field(getter = "getPlaceId", mo21370id = 2)
    private final String zza;
    @SafeParcelable.Field(getter = "getSource", mo21370id = 4)
    ...
    PlaceReport(@SafeParcelable.Param(mo21373id = 1) int i, @SafeParcelable.Param(mo21373id = 2) String str, @SafeParcelable.Param(mo21373id = 3) String str2, @SafeParcelable.Param(mo21373id = 4) String str3) {
        this.versionCode = i;
        this.zza = str;
        this.tag = str2;
        this.zzb = str3;
    ...
    public String toString() {
        ...
        Objects.ToStringHelper add2 = toStringHelper.add(HeaderParameterNames.AUTHENTICATION_TAG, this.tag);
