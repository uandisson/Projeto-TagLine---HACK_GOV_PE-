...
public final class zzal extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValue = "", getter = "getTag", mo21370id = 3)
    private final String tag;
    @SafeParcelable.Field(getter = "getGeofenceIds", mo21370id = 1)
    private final List<String> zzbu;
    @SafeParcelable.Field(getter = "getPendingIntent", mo21370id = 2)
    ...
    zzal(@SafeParcelable.Param(mo21373id = 1) @Nullable List<String> list, @SafeParcelable.Param(mo21373id = 2) @Nullable PendingIntent pendingIntent, @SafeParcelable.Param(mo21373id = 3) String str) {
