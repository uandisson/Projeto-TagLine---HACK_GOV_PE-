...
public final class LocationSettingsRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getLocationRequests", mo21370id = 1)
    private final List<LocationRequest> zzbg;
    @SafeParcelable.Field(defaultValue = "false", getter = "alwaysShow", mo21370id = 2)
    private final boolean zzbh;
    @SafeParcelable.Field(getter = "needBle", mo21370id = 3)
    private final boolean zzbi;
    @SafeParcelable.Field(getter = "getConfiguration", mo21370id = 5)
    private zzae zzbj;
    ...
    LocationSettingsRequest(@SafeParcelable.Param(mo21373id = 1) List<LocationRequest> list, @SafeParcelable.Param(mo21373id = 2) boolean z, @SafeParcelable.Param(mo21373id = 3) boolean z2, @SafeParcelable.Param(mo21373id = 5) zzae zzae) {
        this.zzbg = list;
        this.zzbh = z;
        this.zzbi = z2;
        this.zzbj = zzae;
