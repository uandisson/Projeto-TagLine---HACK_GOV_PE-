...
public class ActivityTransitionRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getTag", mo21370id = 2)
    @Nullable
    private final String tag;
    @SafeParcelable.Field(getter = "getActivityTransitions", mo21370id = 1)
    private final List<ActivityTransition> zzl;
    @SafeParcelable.Field(getter = "getClients", mo21370id = 3)
    ...
    public ActivityTransitionRequest(@SafeParcelable.Param(mo21373id = 1) List<ActivityTransition> list, @SafeParcelable.Param(mo21373id = 2) @Nullable String str, @SafeParcelable.Param(mo21373id = 3) @Nullable List<ClientIdentity> list2) {
        TreeSet treeSet;
