...
public class ActivityTransitionEvent extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getActivityType", mo21370id = 1)
    private final int zzi;
    @SafeParcelable.Field(getter = "getTransitionType", mo21370id = 2)
    private final int zzj;
    @SafeParcelable.Field(getter = "getElapsedRealTimeNanos", mo21370id = 3)
    ...
    public ActivityTransitionEvent(@SafeParcelable.Param(mo21373id = 1) int i, @SafeParcelable.Param(mo21373id = 2) int i2, @SafeParcelable.Param(mo21373id = 3) long j) {
        int i3 = i;
        int i4 = i2;
