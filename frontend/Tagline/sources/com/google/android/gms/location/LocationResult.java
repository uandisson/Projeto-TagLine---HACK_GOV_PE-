...
public final class LocationResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "LocationResult.DEFAULT_LOCATIONS", getter = "getLocations", mo21370id = 1)
    ...
    LocationResult(@SafeParcelable.Param(mo21373id = 1) List<Location> list) {
        this.zzbc = list;
    }
