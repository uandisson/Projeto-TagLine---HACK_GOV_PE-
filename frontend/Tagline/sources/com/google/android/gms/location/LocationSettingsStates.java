...
public final class LocationSettingsStates extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "isGpsUsable", mo21370id = 1)
    private final boolean zzbn;
    @SafeParcelable.Field(getter = "isNetworkLocationUsable", mo21370id = 2)
    private final boolean zzbo;
    @SafeParcelable.Field(getter = "isBleUsable", mo21370id = 3)
    private final boolean zzbp;
    @SafeParcelable.Field(getter = "isGpsPresent", mo21370id = 4)
    private final boolean zzbq;
    @SafeParcelable.Field(getter = "isNetworkLocationPresent", mo21370id = 5)
    private final boolean zzbr;
    @SafeParcelable.Field(getter = "isBlePresent", mo21370id = 6)
    ...
    public LocationSettingsStates(@SafeParcelable.Param(mo21373id = 1) boolean z, @SafeParcelable.Param(mo21373id = 2) boolean z2, @SafeParcelable.Param(mo21373id = 3) boolean z3, @SafeParcelable.Param(mo21373id = 4) boolean z4, @SafeParcelable.Param(mo21373id = 5) boolean z5, @SafeParcelable.Param(mo21373id = 6) boolean z6) {
        this.zzbn = z;
        this.zzbo = z2;
        this.zzbp = z3;
        this.zzbq = z4;
