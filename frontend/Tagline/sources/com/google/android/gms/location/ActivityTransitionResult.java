...
public class ActivityTransitionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getTransitionEvents", mo21370id = 1)
    ...
    public ActivityTransitionResult(@SafeParcelable.Param(mo21373id = 1) List<ActivityTransitionEvent> list) {
