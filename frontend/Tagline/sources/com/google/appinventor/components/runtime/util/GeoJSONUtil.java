...
public final class GeoJSONUtil {
    ...
    static {
        ...
        PropertyApplication put26 = LYVRHQlR5uMq9RmVQLgPQwQp4HVKuBDt7Jnpu0jTztYClgnk53NSpkUmjjPPbYn.put(OneSignalDbContract.NotificationTable.COLUMN_NAME_TITLE, obj13);
        new PropertyApplication() {
            public final void apply(MapFactory.MapFeature mapFeature, Object obj) {
                MapFactory.MapFeature mapFeature2 = mapFeature;
                Object obj2 = obj;
    ...
    private static MapFactory.MapFeature hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(String str, MapFactory.MapFeatureContainer mapFeatureContainer, YailList yailList) {
        ...
        while (it.hasNext()) {
            ...
            if (CommonProperties.TYPE.equals(string)) {
                str3 = (String) object;
            } else if (GMLConstants.GML_COORDINATES.equals(string)) {
                yailList2 = (YailList) object;
            } else {
                int w = Log.w(str2, String.format("Unsupported field \"%s\" in JSON format", new Object[]{string}));
            }
        ...
        if ("Point".equals(str4)) {
            ...
            return marker3;
        } else if ("LineString".equals(str4)) {
            ...
            polygon2.Initialize();
            return polygon2;
        } else if ("MultiPolygon".equals(str4)) {
    ...
    static int m75hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(Object obj) {
        Throwable th;
        Object obj2 = obj;
        if (obj2 instanceof Number) {
    ...
    static final class C1152a implements MapFactory.MapFeatureVisitor<Void> {
        private final PrintStream hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

        /* JADX INFO: this call moved to the top of the method (can break code semantics) */
        /* synthetic */ C1152a(PrintStream printStream, byte b) {
            this(printStream);
            byte b2 = b;
        }
        ...
        private C1152a(PrintStream printStream) {
        ...
        private void hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(MapFactory.MapFeature mapFeature) {
            ...
            B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T(OneSignalDbContract.NotificationTable.COLUMN_NAME_TITLE, mapFeature2.Title());
        ...
        /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other method in class */
        private static boolean m76hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(GeoPoint geoPoint) {
    ...
    public static void writeFeaturesAsGeoJSON(List<MapFactory.MapFeature> list, String str) throws IOException {
        ...
        try {
            ...
            new C1152a(printStream2, (byte) 0);
