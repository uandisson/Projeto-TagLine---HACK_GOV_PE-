...
public class ReplForm extends Form {
    ...
    private static final String iMWvjaqDlqi8shqdETWDeLkDbaCwtdVfJFSzyvUX79cgwtU4Twvc8XyMVbnGcmik;
    ...
    private boolean TcZoKXUijRhvOFm1gZ0ppEfXWxECqlUNNvncSPIfT3ZrTDcozo05OAb21mkMXciT = false;
    ...
    private AppInvHTTPD f730hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = null;

    /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
    private WebRTCNativeMgr f731hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    String iz2AUXs4pv4EMA73duiR1R3OfWItF7gDqk3oMKKRO3MIyuqvZdoefifHvTvEAhn = null;
    ...
    static {
        ...
        new StringBuilder();
        iMWvjaqDlqi8shqdETWDeLkDbaCwtdVfJFSzyvUX79cgwtU4Twvc8XyMVbnGcmik = sb2.append(REPL_ASSET_DIR).append("external_comps/").toString();
    }
    ...
    public class SchemeInterface {
        ...
        /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
        Language f732hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = Scheme.getInstance("scheme");
                ...
                public final void run() {
                    try {
                        ...
                        if (str2.equals("#DONE#")) {
                            ...
                            Object eval = this.B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T.f732hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.eval(str2);
                        }
                    } catch (Throwable th) {
    ...
    public void onDestroy() {
        super.onDestroy();
        if (this.f730hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            this.f730hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.stop();
            this.f730hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = null;
        }
        finish();
        System.exit(0);
    }
    ...
    public void setResult(Object obj) {
        ...
        this.iz2AUXs4pv4EMA73duiR1R3OfWItF7gDqk3oMKKRO3MIyuqvZdoefifHvTvEAhn = this.formName;
    }
    ...
    public void processExtras(Intent intent, boolean z) {
        ...
        if (bundle != null && bundle.getBoolean("rundirect")) {
            ...
            if (z2) {
                clear();
                if (this.f730hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
                    this.f730hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.resetSeq();
                    return;
                }
                startHTTPD(true);
    ...
    public void startHTTPD(boolean z) {
        ...
        try {
            if (this.f730hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME == null) {
                ...
                this.f730hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = appInvHTTPD;
    ...
    public void loadComponents(List<String> list) {
        ...
        new File(iMWvjaqDlqi8shqdETWDeLkDbaCwtdVfJFSzyvUX79cgwtU4Twvc8XyMVbnGcmik);
        File file5 = file;
        new File(iMWvjaqDlqi8shqdETWDeLkDbaCwtdVfJFSzyvUX79cgwtU4Twvc8XyMVbnGcmik);
        File file6 = file2;
        File file7 = file6;
    ...
    public void sendToCompanion(String str) {
        String str2 = str;
        if (this.f731hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME == null) {
            int i = Log.i(LOG_TAG, "No WebRTCNativeMgr!");
        } else {
            this.f731hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.send(str2);
        }
    }

    public void setWebRTCMgr(WebRTCNativeMgr webRTCNativeMgr) {
        WebRTCNativeMgr webRTCNativeMgr2 = webRTCNativeMgr;
        this.f731hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = webRTCNativeMgr2;
    }
    ...
    public String getAssetPathForExtension(Component component, String str) throws FileNotFoundException {
        ...
        while (true) {
            ...
            new StringBuilder();
            new File(sb3.append(iMWvjaqDlqi8shqdETWDeLkDbaCwtdVfJFSzyvUX79cgwtU4Twvc8XyMVbnGcmik).append(name).append("/assets").toString());
            File file3 = file2;
            File file4 = file3;
