...
final class C1120b {
    ...
    private static C1121a hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(RandomAccessFile randomAccessFile) throws IOException, ZipException {
        C1121a aVar;
        long j;
        Throwable th;
        Throwable th2;
    ...
    private static long hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(RandomAccessFile randomAccessFile, C1121a aVar) throws IOException {
        CRC32 crc32;
        RandomAccessFile randomAccessFile2 = randomAccessFile;
        C1121a aVar2 = aVar;
        new CRC32();
        ...
        int read = randomAccessFile2.read(bArr, 0, (int) Math.min(PlaybackStateCompat.ACTION_PREPARE, j));
        while (true) {
            int i = read;
            if (i == -1) {
                break;
            ...
            read = randomAccessFile2.read(bArr, 0, (int) Math.min(PlaybackStateCompat.ACTION_PREPARE, j));
        }
