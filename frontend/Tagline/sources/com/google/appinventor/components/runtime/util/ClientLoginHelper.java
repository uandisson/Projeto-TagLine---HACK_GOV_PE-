...
public class ClientLoginHelper implements IClientLoginHelper {
    ...
    private HttpClient f765hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public ClientLoginHelper(Activity activity2, String str, String str2, HttpClient httpClient) {
        ...
        this.UnxMFGkcOXM6xsX56zG6IiZYxtO3aB3YAZ9KtPD7LpEQMRTmKJfme555SHlBUQeS = str3;
        if (httpClient4 == null) {
        ...
        this.f765hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = httpClient2;
    ...
    public HttpResponse execute(HttpUriRequest httpUriRequest) throws ClientProtocolException, IOException {
        ...
        HttpResponse execute = this.f765hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.execute(httpUriRequest2);
        ...
        if (execute.getStatusLine().getStatusCode() == 401) {
            ...
            httpResponse = this.f765hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.execute(httpUriRequest2);
        }
        return httpResponse;
    }
    ...
    private static void hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(HttpUriRequest httpUriRequest, String str) {
        ...
        if (str2 != null) {
            ...
            httpUriRequest2.addHeader(Constants.AUTHORIZATION_HEADER, "GoogleLogin auth=".concat(String.valueOf(str2)));
        }
    }
    ...
    private static void hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(HttpUriRequest httpUriRequest) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (header.getName().equalsIgnoreCase(Constants.AUTHORIZATION_HEADER) && header2.getValue().startsWith("GoogleLogin auth=")) {
    ...
    public String getAuthToken() throws ClientProtocolException {
        ...
        if (findAccount != null) {
            AccountManagerFuture<Bundle> authToken2 = this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getAuthToken(account, this.UnxMFGkcOXM6xsX56zG6IiZYxtO3aB3YAZ9KtPD7LpEQMRTmKJfme555SHlBUQeS, (Bundle) null, this.activity, (AccountManagerCallback) null, (Handler) null);
