...
public class MakeroidListViewImageText extends MakeroidListViewBase {
    ...
    private boolean cOmDbOC978RubVhXjun4VkHg9OxeO5ZzRCTQEv8rZa8E7YdcVv7aSE4TjAXwfuwN = false;
    ...
    private ArrayList<ArrayList<String>> f693hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public MakeroidListViewImageText(ComponentContainer componentContainer) {
        ...
        new ArrayList<>();
        this.f693hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = arrayList;
        TextViewUtil.setContext(this.context);
        ItemSize(1);
        ImageSide(1);
        TitleTextSize(this.n86Bi3TT8lkq4OIAY6TQzz40yEQcROLeML3EOzGKfDOtlcMXWXcB7P2XOFzT0DDv);
        TitleBold(this.cOmDbOC978RubVhXjun4VkHg9OxeO5ZzRCTQEv8rZa8E7YdcVv7aSE4TjAXwfuwN);
        ...
        TitleHTML(this.O8YFlD3Safgd5vkxHRoLznZm2if21MG0IxIn5jepRi6FBTeulibRFlvEXsnDANgS);
        TitleItalic(this.OFXnSk7pjyu5TDlQcCs0Ee2Ss8ceD26gQ4XJfzIMtdlcKhGXQ2j7Mh9NsuvjNyC);
        SubtitleTextSize(this.gti6bIqu0aXgALoDtkq1foMnPcdzXO0EAPAgw4lcaEF132GirFLns82VqwKc8x6R);
        SubtitleBold(this.gKFqoeV0mIepwKqPzQqyF42NDV4lXNBYlbBqvrWypn3hvG8Ace2UniGxwzdDn1SZ);
        ...
        SubtitleHTML(this.MYUGxENNZgpsWEBTVSKDauXfXur6zyPKrPdlATl7m89YCcguzmIKP8wXNDkxMYaw);
        SubtitleItalic(this.z819s2db3SwWOaVhKbPTp947sGRXlCsEqH9IfB6VLe6W07abBod2oRho8IvcelHj);
    }

    public void click(int i) {
        int i2 = i;
        try {
            Click(i2, (String) this.f693hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.get(i2).get(1), (String) this.f693hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.get(i2).get(2), (String) this.f693hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.get(i2).get(0));
    ...
    public void longClick(int i) {
        int i2 = i;
        try {
            LongClick(i2, (String) this.f693hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.get(i2).get(1), (String) this.f693hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.get(i2).get(2), (String) this.f693hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.get(i2).get(0));
        } catch (ArrayIndexOutOfBoundsException e) {
            this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.notifyDataSetChanged();
        }
    }
    ...
    public void AddItem(String str, String str2, String str3) {
        ...
        boolean add4 = this.f693hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.add(arrayList3);
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.notifyDataSetChanged();
    }
    ...
    public void ClearList() {
        this.f693hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.clear();
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.notifyDataSetChanged();
    }
    ...
    public void UpdateItem(int i, String str, String str2, String str3) throws ArrayIndexOutOfBoundsException {
        ...
        boolean add2 = arrayList3.add(str2);
        boolean add3 = arrayList3.add(str3);
        ArrayList<String> arrayList4 = this.f693hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.set(i, arrayList3);
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.notifyDataSetChanged();
    }

    @SimpleFunction(description = "Remove a item from the list")
    public void RemoveItem(int i) throws ArrayIndexOutOfBoundsException {
        ArrayList<String> remove = this.f693hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.remove(i);
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.notifyDataSetChanged();
    }
    ...
    public class ListAdapter extends RecyclerView.Adapter<C0885a> {
        ...
        public void onBindViewHolder(C0885a aVar, int i) {
            ...
            if (((String) arrayList.get(1)).length() > 0) {
                ...
                if (this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.O8YFlD3Safgd5vkxHRoLznZm2if21MG0IxIn5jepRi6FBTeulibRFlvEXsnDANgS) {
        ...
        class C0885a extends RecyclerView.ViewHolder {
            ...
            C0885a(com.google.appinventor.components.runtime.MakeroidListViewImageText.ListAdapter r10, android.view.View r11) {
                /*
                    r9 = this;
                    r0 = r9
                    r1 = r10
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.appinventor.components.runtime.MakeroidListViewImageText.ListAdapter.C0885a.<init>(com.google.appinventor.components.runtime.MakeroidListViewImageText$ListAdapter, android.view.View):void");
            }
        }
    }
}
