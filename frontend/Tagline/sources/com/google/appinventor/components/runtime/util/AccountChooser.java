...
public class AccountChooser {
    private String ArOjKO7pqAIWG8ZZlv3YBxnAZj1pb9t33KRX1FDn1YZBKlUfegr0dDdXoq3tBTrf;
    ...
    private String yBWgr1TFnOTkj12JSinX7tDktLYDdE0hbjWh6SJ840mGKDqolkYZlpsg76XJs9ig;

    public AccountChooser(Activity activity2, String str, String str2, String str3) {
        Activity activity3 = activity2;
        this.activity = activity3;
        this.UnxMFGkcOXM6xsX56zG6IiZYxtO3aB3YAZ9KtPD7LpEQMRTmKJfme555SHlBUQeS = str;
        this.ArOjKO7pqAIWG8ZZlv3YBxnAZj1pb9t33KRX1FDn1YZBKlUfegr0dDdXoq3tBTrf = str2;
        this.yBWgr1TFnOTkj12JSinX7tDktLYDdE0hbjWh6SJ840mGKDqolkYZlpsg76XJs9ig = str3;
    ...
    private String hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO() {
        ...
        try {
            String string = this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.addAccount(AccountType.GOOGLE, this.UnxMFGkcOXM6xsX56zG6IiZYxtO3aB3YAZ9KtPD7LpEQMRTmKJfme555SHlBUQeS, (String[]) null, (Bundle) null, this.activity, (AccountManagerCallback) null, (Handler) null).getResult().getString("authAccount");
    ...
    private String hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(Account[] accountArr) {
        ...
        new C1122a(this, accountArr, synchronousQueue2);
        aVar.start();
    ...
    private SharedPreferences B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T() {
        return this.activity.getSharedPreferences(this.yBWgr1TFnOTkj12JSinX7tDktLYDdE0hbjWh6SJ840mGKDqolkYZlpsg76XJs9ig, 0);
    }
    ...
    class C1122a extends Thread implements DialogInterface.OnCancelListener, DialogInterface.OnClickListener {
        final /* synthetic */ AccountChooser hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

        /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
        private SynchronousQueue<String> f763hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
        /* access modifiers changed from: private */
        public String[] vOibdtOfNxMVixWab9VDGgvD9L4Kqb2ZDQBius3PMdhiP1dPN68Z9GzWJA49TUbE;

        C1122a(AccountChooser accountChooser, Account[] accountArr, SynchronousQueue<String> synchronousQueue) {
            Account[] accountArr2 = accountArr;
            this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = accountChooser;
            this.f763hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = synchronousQueue;
        ...
        public final void run() {
            Runnable runnable;
            new Runnable(this) {
                private /* synthetic */ C1122a hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
        ...
        public final void onClick(DialogInterface dialogInterface, int i) {
            ...
            if (i2 >= 0) {
                try {
                    ...
                    this.f763hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.put(str);
                } catch (InterruptedException e) {
                }
            } else {
                this.f763hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.put("");
            }
