...
public class LegoMindstormsNxtBase extends AndroidNonvisibleComponent implements Component, Deleteable, GeoJSONUtil.PropertyApplication {
    ...
    static {
        ...
        String put29 = vwEpIRqEf6xdtwTR9dehwBO7JUhyLV6iEzEK2WqfPN10eUMQDPn3AUmqAFfsnr6R.put(224, "Specified channel/connection not configured or busy");
    ...
    public final boolean checkBluetooth(String str) {
        String str2 = str;
        if (this.bluetooth == null) {
            this.form.dispatchErrorOccurredEvent(this, str2, ErrorMessages.ERROR_NXT_BLUETOOTH_NOT_SET, new Object[0]);
            return false;
        } else if (this.bluetooth.IsConnected()) {
            return true;
        } else {
            this.form.dispatchErrorOccurredEvent(this, str2, ErrorMessages.ERROR_NXT_NOT_CONNECTED_TO_ROBOT, new Object[0]);
            return false;
        }
    }
    ...
    public final byte[] sendCommandAndReceiveReturnPackage(String str, byte[] bArr) {
        ...
        this.form.dispatchErrorOccurredEvent(this, str3, ErrorMessages.ERROR_NXT_INVALID_RETURN_PACKAGE, new Object[0]);
        return new byte[0];
    }
