...
public class MemoryLeakUtil {
    private static final Map<String, WeakReference<Object>> PpoaLB2hgzDTOuqu9FkRmbGOAi4DOSz44cSb2WOQzHfJN0AfA0f9dWyZXVLXkHHC = Maps.newTreeMap();
    ...
    public static String trackObject(String str, Object obj) {
        ...
        WeakReference<Object> put = PpoaLB2hgzDTOuqu9FkRmbGOAi4DOSz44cSb2WOQzHfJN0AfA0f9dWyZXVLXkHHC.put(str3, obj2);
        return str3;
    }
    ...
    public static boolean isTrackedObjectCollected(String str, boolean z) {
        ...
        boolean z2 = z;
        System.gc();
        WeakReference weakReference = PpoaLB2hgzDTOuqu9FkRmbGOAi4DOSz44cSb2WOQzHfJN0AfA0f9dWyZXVLXkHHC.get(str2);
        ...
        if (weakReference != null) {
            ...
            if (z2 && obj == null) {
                WeakReference<Object> remove = PpoaLB2hgzDTOuqu9FkRmbGOAi4DOSz44cSb2WOQzHfJN0AfA0f9dWyZXVLXkHHC.remove(str2);
            }
            if (obj == null) {
                return true;
            }
    ...
    public static void checkAllTrackedObjects(boolean z, boolean z2) {
        ...
        int i2 = 0;
        int i3 = 0;
        Iterator<Map.Entry<String, WeakReference<Object>>> it = PpoaLB2hgzDTOuqu9FkRmbGOAi4DOSz44cSb2WOQzHfJN0AfA0f9dWyZXVLXkHHC.entrySet().iterator();
        while (it.hasNext()) {
