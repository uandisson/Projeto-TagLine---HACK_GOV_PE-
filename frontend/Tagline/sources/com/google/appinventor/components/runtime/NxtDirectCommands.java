...
public class NxtDirectCommands extends LegoMindstormsNxtBase {
    ...
    public void StartProgram(String str) {
        ...
        if (checkBluetooth(str3)) {
            if (str2.length() == 0) {
                this.form.dispatchErrorOccurredEvent(this, str3, ErrorMessages.ERROR_NXT_INVALID_PROGRAM_NAME, new Object[0]);
                return;
            }
            if (str2.indexOf(".") == -1) {
                new StringBuilder();
    ...
    public void PlaySoundFile(String str) {
        ...
        if (checkBluetooth(str3)) {
            if (str2.length() == 0) {
                this.form.dispatchErrorOccurredEvent(this, str3, ErrorMessages.ERROR_NXT_INVALID_FILE_NAME, new Object[0]);
                return;
            }
            if (str2.indexOf(".") == -1) {
                new StringBuilder();
    ...
    public void SetOutputState(String str, int i, int i2, int i3, int i4, int i5, long j) {
        ...
        if (checkBluetooth(str3)) {
            try {
                ...
                this.form.dispatchErrorOccurredEvent(this, str3, ErrorMessages.ERROR_NXT_INVALID_MOTOR_PORT, str2);
            }
        }
    }
    ...
    public void MessageWrite(int i, String str) {
        ...
        if (checkBluetooth(str3)) {
            if (i2 <= 0 || i2 > 10) {
                this.form.dispatchErrorOccurredEvent(this, str3, ErrorMessages.ERROR_NXT_INVALID_MAILBOX, Integer.valueOf(i2));
                return;
            }
            int length = str2.length();
            int i3 = length;
            if (length > 58) {
                this.form.dispatchErrorOccurredEvent(this, str3, ErrorMessages.ERROR_NXT_MESSAGE_TOO_LONG, new Object[0]);
                return;
            }
        ...
        if (checkBluetooth(str3)) {
            try {
                ...
                if (yailList2.size() > 16) {
                    this.form.dispatchErrorOccurredEvent(this, str3, ErrorMessages.ERROR_NXT_DATA_TOO_LARGE, new Object[0]);
                    return;
                }
                ...
                while (i3 < objArr.length) {
                    try {
                        ...
                        if (i4 == 0 || i5 == -1) {
                            ...
                            this.form.dispatchErrorOccurredEvent(this, str3, ErrorMessages.ERROR_NXT_COULD_NOT_FIT_ELEMENT_IN_BYTE, Integer.valueOf(i3 + 1));
                            return;
                        }
                    } catch (NumberFormatException e) {
                        this.form.dispatchErrorOccurredEvent(this, str3, ErrorMessages.ERROR_NXT_COULD_NOT_DECODE_ELEMENT, Integer.valueOf(i3 + 1));
                        return;
                    }
                }
    ...
    public String MessageRead(int i) {
        ...
        if (i2 <= 0 || i2 > 10) {
            this.form.dispatchErrorOccurredEvent(this, str, ErrorMessages.ERROR_NXT_INVALID_MAILBOX, Integer.valueOf(i2));
            return "";
        }
        int i3 = i2 - 1;
    ...
    public void DownloadFile(String str, String str2) {
        ...
        if (checkBluetooth(str5)) {
            if (str3.length() == 0) {
                this.form.dispatchErrorOccurredEvent(this, str5, ErrorMessages.ERROR_NXT_INVALID_SOURCE_ARGUMENT, new Object[0]);
            } else if (str4.length() == 0) {
                this.form.dispatchErrorOccurredEvent(this, str5, ErrorMessages.ERROR_NXT_INVALID_DESTINATION_ARGUMENT, new Object[0]);
            } else {
                try {
                    ...
                    new StringBuilder();
                    this.form.dispatchErrorOccurredEvent(this, str5, ErrorMessages.ERROR_NXT_UNABLE_TO_DOWNLOAD_FILE, sb.append(e2.getMessage()).toString());
                }
            }
        }
    }
