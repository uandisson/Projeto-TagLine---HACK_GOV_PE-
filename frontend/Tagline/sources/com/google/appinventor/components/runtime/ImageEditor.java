...
public class ImageEditor extends AndroidNonvisibleComponent implements Component {
    ...
    public String BlurEffect(String str, float f, int i) {
        ...
        int[] iArr = new int[(width * height)];
        new StringBuilder();
        int e = Log.e("ImageEditor", sb.append(width).append(" ").append(height).append(" ").append(iArr.length).toString());
        ...
        new StringBuilder();
        int e2 = Log.e("ImageEditor", sb2.append(width).append(" ").append(height).append(" ").append(i5).toString());
