...
public abstract class MapFeatureBase implements MapFactory.HasStroke, MapFactory.MapFeature {
    ...
    private GeoPoint f718B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T = null;
    private String BG2b8dRaEUNcWY5vxXAWfSqyg8ZvS4tysLlCvHPUDp1bRFO56FHQ3a9NvDEKgkS = "";
    private boolean DHXdVBD10imZD254vgJdvVnoNnGi6ltYnt493xQ866MP9unX6nAi8XBtATXxBfV8 = false;
    ...
    private Geometry f719hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public void EnableInfobox(boolean z) {
        this.DHXdVBD10imZD254vgJdvVnoNnGi6ltYnt493xQ866MP9unX6nAi8XBtATXxBfV8 = z;
        this.map.getController().updateFeatureText(this);
    }
    ...
    public final synchronized GeoPoint getCentroid() {
        GeoPoint geoPoint;
        synchronized (this) {
            if (this.f718B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T == null) {
                this.f718B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T = GeometryUtil.jtsPointToGeoPoint(getGeometry().getCentroid());
            }
            geoPoint = this.f718B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T;
        }
        return geoPoint;
    }
    ...
    public final synchronized Geometry getGeometry() {
        Geometry geometry;
        synchronized (this) {
            if (this.f719hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME == null) {
                this.f719hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = computeGeometry();
            }
            geometry = this.f719hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
        }
        return geometry;
    }
