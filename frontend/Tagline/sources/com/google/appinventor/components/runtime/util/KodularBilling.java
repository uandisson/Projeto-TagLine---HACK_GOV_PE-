...
public class KodularBilling {
    ...
    static class C1167a extends AsyncTask<Form, Void, Boolean> {
    ...
    static class C1168b extends AsyncTask<Form, Void, Boolean> {
        private String LOG_TAG;
        private Form hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO;
