...
public class Ev3BinaryParser {
    ...
    public static byte[] pack(String str, Object... objArr) throws IllegalArgumentException {
        ...
        String[] strArr = split;
        C1131a[] aVarArr = new C1131a[split.length];
        int i = 0;
        int i2 = 0;
        ...
        C1131a[] aVarArr2 = aVarArr;
        C1131a[] aVarArr3 = aVarArr2;
        int length = aVarArr2.length;
        for (int i6 = 0; i6 < length; i6++) {
            C1131a aVar2 = aVarArr3[i6];
            C1131a aVar3 = aVar2;
            switch (aVar2.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME) {
                ...
                case 'S':
                    try {
                        ByteBuffer put2 = byteBuffer.put(((String) objArr2[i5]).getBytes(StringUtil.US_ASCII));
                ...
                case 's':
                    try {
                        ByteBuffer put5 = byteBuffer.put(((String) objArr2[i5]).getBytes(StringUtil.US_ASCII));
                        i5++;
                        break;
    ...
    public static byte[] encodeSystemCommand(byte b, boolean z, Object... objArr) {
        ...
        for (int i3 = 0; i3 < length2; i3++) {
            ...
            if (obj3 instanceof Byte) {
                ...
                try {
                    ByteBuffer put4 = byteBuffer.put(((String) obj4).getBytes(StringUtil.US_ASCII));
        ...
        for (int i5 = 0; i5 < str2.length(); i5++) {
            ...
            switch (charAt) {
                ...
                case 's':
                    ...
                    try {
                        new StringBuilder();
                        boolean add13 = arrayList3.add(sb.append((String) obj).append(0).toString().getBytes(StringUtil.US_ASCII));
                        break;
                    } catch (UnsupportedEncodingException e) {
                        Throwable th13 = th4;
                        new IllegalArgumentException();
