...
public class MakeroidFtp extends AndroidNonvisibleComponent implements Component {
    ...
    class C0880b extends AsyncTask<Void, Void, Boolean> {
        ...
        private C0880b(MakeroidFtp makeroidFtp) {
            this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = makeroidFtp;
        }

        /* JADX INFO: this call moved to the top of the method (can break code semantics) */
        /* synthetic */ C0880b(MakeroidFtp makeroidFtp, byte b) {
            this(makeroidFtp);
            byte b2 = b;
        }
        ...
        new PermissionResultHandler(this) {
            ...
            public final void HandlePermissionResponse(String str, boolean z) {
                ...
                if (z) {
                    try {
                        C0882d dVar2 = dVar;
                        new C0882d(this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, (byte) 0);
    ...
    class C0882d extends AsyncTask<String, Void, String> {
        private /* synthetic */ MakeroidFtp hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
        ...
        private C0882d(MakeroidFtp makeroidFtp) {
            this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = makeroidFtp;
        }

        /* JADX INFO: this call moved to the top of the method (can break code semantics) */
        /* synthetic */ C0882d(MakeroidFtp makeroidFtp, byte b) {
            this(makeroidFtp);
            byte b2 = b;
        }
        ...
        public java.lang.String doInBackground(java.lang.String... r10) {
            ...
            L_0x007a:
                ...
                goto L_0x0045
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.appinventor.components.runtime.MakeroidFtp.C0882d.doInBackground(java.lang.String[]):java.lang.String");
        }
    }
        ...
        new PermissionResultHandler(this) {
            ...
            public final void HandlePermissionResponse(String str, boolean z) {
                ...
                if (z) {
                    try {
                        C0881c cVar2 = cVar;
                        new C0881c(this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, (byte) 0);
                        String[] strArr = new String[2];
                        strArr[0] = str3;
                        String[] strArr2 = strArr;
                        strArr2[1] = str4;
    ...
    class C0881c extends AsyncTask<String, Void, String> {
        private /* synthetic */ MakeroidFtp hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
        ...
        private C0881c(MakeroidFtp makeroidFtp) {
            this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = makeroidFtp;
        }

        /* JADX INFO: this call moved to the top of the method (can break code semantics) */
        /* synthetic */ C0881c(MakeroidFtp makeroidFtp, byte b) {
            this(makeroidFtp);
            byte b2 = b;
        }
