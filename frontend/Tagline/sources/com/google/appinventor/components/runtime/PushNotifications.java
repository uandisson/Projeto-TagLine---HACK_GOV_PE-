...
public final class PushNotifications extends AndroidNonvisibleComponent implements Component {
        ...
        new Runnable(this) {
            ...
            public final void run() {
                ...
                new OneSignal.GetTagsHandler(this) {
                    private /* synthetic */ C10021 hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public final void GetValue(String str, String str2) {
        ...
        new Runnable(this) {
            ...
            public final void run() {
                OneSignal.GetTagsHandler getTagsHandler;
                new OneSignal.GetTagsHandler(this) {
                    private /* synthetic */ C10042 hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    class C1010b implements OneSignal.NotificationReceivedHandler {
        private /* synthetic */ PushNotifications hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

        private C1010b(PushNotifications pushNotifications) {
            this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = pushNotifications;
        }

        /* JADX INFO: this call moved to the top of the method (can break code semantics) */
        /* synthetic */ C1010b(PushNotifications pushNotifications, byte b) {
    ...
    class C1009a implements OneSignal.NotificationOpenedHandler {
        private /* synthetic */ PushNotifications hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

        private C1009a(PushNotifications pushNotifications) {
            this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = pushNotifications;
        }

        /* JADX INFO: this call moved to the top of the method (can break code semantics) */
        /* synthetic */ C1009a(PushNotifications pushNotifications, byte b) {
            this(pushNotifications);
            byte b2 = b;
        }
    ...
    public boolean B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T(String str, String str2, String str3) {
        ...
        try {
            ...
            httpURLConnection.setRequestProperty(Constants.AUTHORIZATION_HEADER, "Basic ".concat(String.valueOf(str6)));
