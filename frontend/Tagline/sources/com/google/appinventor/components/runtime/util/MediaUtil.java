...
public class MediaUtil {
    ...
    private static final Map<String, File> oDikMCstR6tlR2dTNi9SmHhjXnOW8gvVc7RVCpamOJDxjRqCmBMqmRVoMYhtpjS;
    /* access modifiers changed from: private */
    public static boolean yHAbLPerXNK4pCwn5nqbt3OeUjDvQdxh29RmVa0moB4dUtgatbeaGoP5jClPUWFb = true;
    ...
    static {
        ...
        new HashMap();
        oDikMCstR6tlR2dTNi9SmHhjXnOW8gvVc7RVCpamOJDxjRqCmBMqmRVoMYhtpjS = map;
    ...
    static class C1185c<T> {
        String GqEao9b9YWjqJfm0U8G9R1Onjg5BiUMTCoMqRIVO602C1plqYKUzgjm5B5hvlTms;
        private volatile boolean Sj3UMCQcT7f46E8U4TVavenawPElr174psURarVHJJBTqMXe22hIekct3fzxe7Vm;
        T vOibdtOfNxMVixWab9VDGgvD9L4Kqb2ZDQBius3PMdhiP1dPN68Z9GzWJA49TUbE;

        private C1185c() {
            this.Sj3UMCQcT7f46E8U4TVavenawPElr174psURarVHJJBTqMXe22hIekct3fzxe7Vm = false;
        }

        /* JADX INFO: this call moved to the top of the method (can break code semantics) */
        /* synthetic */ C1185c(byte b) {
            this();
            byte b2 = b;
        }
        ...
        public final synchronized void BG2b8dRaEUNcWY5vxXAWfSqyg8ZvS4tysLlCvHPUDp1bRFO56FHQ3a9NvDEKgkS() {
            synchronized (this) {
                while (!this.Sj3UMCQcT7f46E8U4TVavenawPElr174psURarVHJJBTqMXe22hIekct3fzxe7Vm) {
                    try {
                        wait();
    ...
    private static String mBLKdPlRolYfdtud5Z8giGWyhURWoCw9yHsOv08fUnIBAM4MuKAWkHVD8nEhBmIT(String str) {
        StringBuilder sb;
        StringBuilder sb2;
        String str2 = str;
    ...
    private static String l557Ll1q9gLt3cEfyQaLTgWgvIutpQIPuKKLXX2glk42j33zjQ1xoBSDeCkOGk6j(String str) throws IOException {
        Throwable th;
        Throwable th2;
        File file;
        URL url;
    ...
    private static int hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(Form form, String str) {
        ...
        if (str2.contains(sb.append(form2.getExternalFilesDir("")).toString())) {
            return C1184b.Y32BqWfeOgj0oQvRmJ9m9e2zU29bRliwner9JMtAtUwBfF75tSr3PcVpECeplsq5;
        }
        if (str2.startsWith(form2.getFilesDir().getAbsolutePath())) {
            return C1184b.qGWPhAhbC1tFmaPVJJBRlTuvq3PUzuXLHqwJdn0xNpZNZK6IOnxu2nEwTjRZ3Ww;
        }
        if (str2.startsWith("/sdcard/") || str2.startsWith(Environment.getExternalStorageDirectory().getAbsolutePath())) {
            return C1184b.siVQGK7skYIQ7zI3RxZVmSEN1N3qEwDlBDPORHd716EIgwqH2EWQFUJrvV0SXYUL;
        }
        if (str2.startsWith("content://contacts/")) {
            return C1184b.zsMcUi8jymhI0yeycaZW56W8YNMDBLoH4OZHLSlj2A3S38zGlu25pkABN4p8cs;
        }
        if (str2.startsWith("content://")) {
            return C1184b.kkTI9AxohjOECYVBpzZOuVO0b9llYVM2xqggkPHvpPoNGTREwN5YZmwC10Gk8X2Q;
        }
        try {
            new URL(str2);
            if (str2.startsWith("file:")) {
                return C1184b.KYHvnTv0AWOO8SeFCXsiNXCxcIirISbo8kAOvMnivJLnqAuCVxfixET1OT3ZpHhw;
            }
            return C1184b.LYXVmrSApJtjkX58iaWYcT93zXSX0GhbrHTAKbm3TBRJ5avsjGCN1sJz61Za2zkA;
        } catch (MalformedURLException e) {
            if (!(form2 instanceof ReplForm)) {
                return C1184b.CfJsMCmg8U782C2ivbbep8ZFrAD6R9Wq7P09zMpUKCFkpiEYodk6t8FdSxHzlHKV;
            }
            if (((ReplForm) form2).isAssetsLoaded()) {
                return C1184b.f3jXQdr7SaO4jKCWPTlGDFsZc4anfRmkf59KPIcTiLfRAexdccxYBXXB8h0vpeF7;
            }
            return C1184b.CfJsMCmg8U782C2ivbbep8ZFrAD6R9Wq7P09zMpUKCFkpiEYodk6t8FdSxHzlHKV;
        }
    }
    ...
    private static String m80hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(Form form, String str) throws IOException {
        String str2;
        Form form2 = form;
        String str3 = str;
    ...
    /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other method in class */
    private static InputStream m78hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(Form form, String str) throws IOException {
        Form form2 = form;
        String str2 = str;
        try {
    ...
    static /* synthetic */ class C11823 {
        static final /* synthetic */ int[] hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO = new int[C1184b.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME().length];

        static {
            try {
                int[] iArr = hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO;
                int i = C1184b.CfJsMCmg8U782C2ivbbep8ZFrAD6R9Wq7P09zMpUKCFkpiEYodk6t8FdSxHzlHKV;
                iArr[0] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                int[] iArr2 = hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO;
                int i2 = C1184b.qGWPhAhbC1tFmaPVJJBRlTuvq3PUzuXLHqwJdn0xNpZNZK6IOnxu2nEwTjRZ3Ww;
                iArr2[8] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                int[] iArr3 = hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO;
                int i3 = C1184b.Y32BqWfeOgj0oQvRmJ9m9e2zU29bRliwner9JMtAtUwBfF75tSr3PcVpECeplsq5;
                iArr3[7] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                int[] iArr4 = hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO;
                int i4 = C1184b.f3jXQdr7SaO4jKCWPTlGDFsZc4anfRmkf59KPIcTiLfRAexdccxYBXXB8h0vpeF7;
                iArr4[1] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                int[] iArr5 = hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO;
                int i5 = C1184b.siVQGK7skYIQ7zI3RxZVmSEN1N3qEwDlBDPORHd716EIgwqH2EWQFUJrvV0SXYUL;
                iArr5[2] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                int[] iArr6 = hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO;
                int i6 = C1184b.KYHvnTv0AWOO8SeFCXsiNXCxcIirISbo8kAOvMnivJLnqAuCVxfixET1OT3ZpHhw;
                iArr6[3] = 6;
            } catch (NoSuchFieldError e6) {
            }
            try {
                int[] iArr7 = hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO;
                int i7 = C1184b.LYXVmrSApJtjkX58iaWYcT93zXSX0GhbrHTAKbm3TBRJ5avsjGCN1sJz61Za2zkA;
                iArr7[4] = 7;
            } catch (NoSuchFieldError e7) {
            }
            try {
                int[] iArr8 = hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO;
                int i8 = C1184b.kkTI9AxohjOECYVBpzZOuVO0b9llYVM2xqggkPHvpPoNGTREwN5YZmwC10Gk8X2Q;
                iArr8[5] = 8;
            } catch (NoSuchFieldError e8) {
            }
            try {
                int[] iArr9 = hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO;
                int i9 = C1184b.zsMcUi8jymhI0yeycaZW56W8YNMDBLoH4OZHLSlj2A3S38zGlu25pkABN4p8cs;
                iArr9[6] = 9;
    ...
    /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other method in class */
    private static InputStream m79hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(Form form, String str, int i) throws IOException {
        Throwable th;
        StringBuilder sb;
        URL url;
        ...
        Form form2 = form;
        String str2 = str;
        switch (C11823.hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO[i - 1]) {
            case 1:
            ...
            case 4:
                ...
                new FileInputStream(mBLKdPlRolYfdtud5Z8giGWyhURWoCw9yHsOv08fUnIBAM4MuKAWkHVD8nEhBmIT(str2));
                return inputStream2;
            case 5:
                form2.assertPermission("android.permission.READ_EXTERNAL_STORAGE");
                new FileInputStream(str2);
    ...
    private static File B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T(Form form, String str, int i) throws IOException {
        ...
        String str2 = str;
        int i2 = i;
        File file = oDikMCstR6tlR2dTNi9SmHhjXnOW8gvVc7RVCpamOJDxjRqCmBMqmRVoMYhtpjS.get(str2);
        File file2 = file;
        if (file == null || !file2.exists()) {
            ...
            File put = oDikMCstR6tlR2dTNi9SmHhjXnOW8gvVc7RVCpamOJDxjRqCmBMqmRVoMYhtpjS.put(str2, file2);
        }
        return file2;
    }
    ...
    public static BitmapDrawable getBitmapDrawable(Form form, String str) throws IOException {
        ...
        String str3 = cVar2.GqEao9b9YWjqJfm0U8G9R1Onjg5BiUMTCoMqRIVO602C1plqYKUzgjm5B5hvlTms;
        String str4 = str3;
            ...
            public final void run() {
                ...
                try {
                    ...
                    try {
                        ...
                        if (MediaUtil.yHAbLPerXNK4pCwn5nqbt3OeUjDvQdxh29RmVa0moB4dUtgatbeaGoP5jClPUWFb || hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME2.inSampleSize != 1 || form3.deviceDensity() == 1.0f) {
                    ...
                    Exception exc2 = e11;
                    if (hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME2 == C1184b.zsMcUi8jymhI0yeycaZW56W8YNMDBLoH4OZHLSlj2A3S38zGlu25pkABN4p8cs) {
    ...
    static class C1183a extends FilterInputStream {
        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public C1183a(InputStream inputStream) {
            super(inputStream);
        }
    ...
    /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other method in class */
    private static AssetFileDescriptor m77hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(Form form, String str) throws IOException {
        Form form2 = form;
        String str2 = str;
        try {
    ...
    public static int loadSoundPool(SoundPool soundPool, Form form, String str) throws IOException {
        ...
        switch (C11823.hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO[hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME2 - 1]) {
            case 1:
            ...
            case 6:
                ...
                return soundPool2.load(l557Ll1q9gLt3cEfyQaLTgWgvIutpQIPuKKLXX2glk42j33zjQ1xoBSDeCkOGk6j(str2), 1);
            case 7:
            case 8:
    ...
    public static void loadMediaPlayer(MediaPlayer mediaPlayer, Form form, String str) throws IOException {
        ...
        Form form2 = form;
        String str2 = str;
        switch (C11823.hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO[hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(form2, str2) - 1]) {
            case 1:
            ...
            case 6:
                ...
                mediaPlayer2.setDataSource(l557Ll1q9gLt3cEfyQaLTgWgvIutpQIPuKKLXX2glk42j33zjQ1xoBSDeCkOGk6j(str2));
                return;
            case 7:
                mediaPlayer2.setDataSource(str2);
                return;
    ...
    public static void loadVideoView(VideoView videoView, Form form, String str) throws IOException {
        ...
        switch (C11823.hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO[hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME2 - 1]) {
            ...
            case 6:
                ...
                videoView2.setVideoPath(l557Ll1q9gLt3cEfyQaLTgWgvIutpQIPuKKLXX2glk42j33zjQ1xoBSDeCkOGk6j(str2));
                return;
            case 7:
    ...
    public static String getAssetFilePath(Form form, String str) {
        ...
        return mBLKdPlRolYfdtud5Z8giGWyhURWoCw9yHsOv08fUnIBAM4MuKAWkHVD8nEhBmIT(str2);
    }
    ...
    public static Drawable getHighQualityImage(Form form, String str) {
        ...
        if (hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME2 == C1184b.CfJsMCmg8U782C2ivbbep8ZFrAD6R9Wq7P09zMpUKCFkpiEYodk6t8FdSxHzlHKV) {
            try {
        ...
        } else if (i == C1184b.f3jXQdr7SaO4jKCWPTlGDFsZc4anfRmkf59KPIcTiLfRAexdccxYBXXB8h0vpeF7) {
            try {
        ...
        } else if (i == C1184b.siVQGK7skYIQ7zI3RxZVmSEN1N3qEwDlBDPORHd716EIgwqH2EWQFUJrvV0SXYUL) {
            try {
        ...
        } else if (i == C1184b.kkTI9AxohjOECYVBpzZOuVO0b9llYVM2xqggkPHvpPoNGTREwN5YZmwC10Gk8X2Q) {
            try {
        ...
        } else if (i == C1184b.KYHvnTv0AWOO8SeFCXsiNXCxcIirISbo8kAOvMnivJLnqAuCVxfixET1OT3ZpHhw || i == C1184b.LYXVmrSApJtjkX58iaWYcT93zXSX0GhbrHTAKbm3TBRJ5avsjGCN1sJz61Za2zkA) {
            try {
                new URL(str2);
        ...
        } else if (i == C1184b.zsMcUi8jymhI0yeycaZW56W8YNMDBLoH4OZHLSlj2A3S38zGlu25pkABN4p8cs) {
            try {
