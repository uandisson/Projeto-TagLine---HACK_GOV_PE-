        ...
        new Runnable(this) {
            ...
            public final void run() {
                ...
                try {
                    ...
                    new StringBuilder();
                    JSONObject put3 = jSONObject.put(DatabaseFileArchive.COLUMN_KEY, sb.append(this.B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T.rCode).append("-r").toString());
