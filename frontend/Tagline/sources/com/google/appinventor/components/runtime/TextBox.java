...
public final class TextBox extends TextBoxBase {
    ...
    public final void ShowError() {
        this.view.setError(this.nItr2rEUwjLh7peU3NgfalZQrx3V2u3REmTnCv6vRXk7VqyYqrNzZhPvrb2eDYTE);
    }
    ...
    public final void ErrorText(String str) {
        String str2 = str;
        this.nItr2rEUwjLh7peU3NgfalZQrx3V2u3REmTnCv6vRXk7VqyYqrNzZhPvrb2eDYTE = str2;
    }
