...
public final class CloudDB extends AndroidNonvisibleComponent implements Component, OnClearListener, OnDestroyListener {
    ...
    /* access modifiers changed from: private */
    public final List<C0625a> storeQueue;
    ...
    static class C0625a {
        ...
        C0625a(String str, JSONArray jSONArray) {
    ...
    public final void StoreValue(String str, Object obj) {
        ...
        if (z) {
            List<C0625a> list = this.storeQueue;
            List<C0625a> list2 = list;
            synchronized (list) {
                boolean z2 = false;
                try {
                                    ...
                                    try {
                                        ...
                                        synchronized (access$600) {
                                            if (this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.storeQueue.size() == 0) {
                                                ...
                                                aVar = (C0625a) this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.storeQueue.remove(0);
                                            }
                                            if (aVar == null) {
                                                break;
                                            }
            ...
            new Runnable(this) {
                ...
                public final void run() {
                    ...
                    try {
                        ...
                        new Runnable(this) {
                            private /* synthetic */ C06195 hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
            ...
            new Runnable(this) {
                ...
                public final void run() {
                    ...
                    try {
                        ...
                        new Runnable(this) {
                            private /* synthetic */ C061310 hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
