...
public class KodularChatView extends AndroidViewComponent implements Component {
    ...
    private void addDateTimestamp(String str, int i, int i2, int i3) {
        ...
        TextView newTextView = getNewTextView(OneSignalDbContract.OutcomeEventsTable.COLUMN_NAME_TIMESTAMP, str2);
    ...
    private void addMessage(String str, String str2, String str3, String str4, int i, boolean z, String str5, boolean z2, AndroidViewComponent androidViewComponent, boolean z3, String str6, String str7, boolean z4) {
        ...
        if (str12.isEmpty() && z6) {
            ...
            if (!str9.isEmpty()) {
                TextView newTextView = getNewTextView(OneSignalDbContract.NotificationTable.COLUMN_NAME_TITLE, str9);
            ...
            if (!str10.isEmpty()) {
                TextView newTextView2 = getNewTextView(OneSignalDbContract.NotificationTable.COLUMN_NAME_MESSAGE, str10);
            ...
            if (str11 != null && !str11.isEmpty()) {
                textView3 = getNewTextView(OneSignalDbContract.OutcomeEventsTable.COLUMN_NAME_TIMESTAMP, str11);
                LinearLayout.LayoutParams layoutParams2 = getLayoutParams(false);
    ...
    public void UpdateTimestampContent(int i, String str, int i2) {
        updateMessage(OneSignalDbContract.OutcomeEventsTable.COLUMN_NAME_TIMESTAMP, i, str, i2);
    }
