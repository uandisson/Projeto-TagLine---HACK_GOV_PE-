...
public class MakeroidDataProtection {
    ...
    private InterstitialAd f774B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T;

    /* renamed from: B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T  reason: collision with other field name */
    private RewardedVideoAd f775B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T;
    private String CjxGCkQSTAjvR1nNlMdbKil40XRwRktLBU1cWxZmNEv2KEZKq1wwOgz5H2xrzq8N = "Makeroid Data Protection Database 18";
    ...
    private String FrTvqStiZO2F73haZ4c62UUmwpyiTR0Q3saFC1nYzrvmpyGkgyFFxTtzoQAKnoll;
    private String LOG_TAG = "Makeroid Data Protection";
    private boolean PMWpqVMsyfTUgqkfqh3FKX4Q3IYlcybzKrBGEl7qtzs6HNVssJ63V430Ige89pyP;
    private String Sa0jypR6YD5j7ayqbvuoqzuaJRSrX8yjkvtL3QPciDNsj5IsamevCs24OFmH7uZQ;
    private int T3TEUSUxjrJVucuujQ9pjstrX3UcxHV1L9cOGs7CI5pfz9hjmRfdL7GRyW8ebdVq = 0;
    private String WXrxsncNaI12QELoywiijcLROkSQSR7QVFw2zT3BVYf147C9TZQ4jsxpxFZAUav;
    private boolean WrlQqhIKmKuB9b4JVzpHXmCJrSlbkHSNA5ubvsLC9K31KYZzZrethddcAVSmF8Zp = false;
    private int ZFwQoaMsdRwNqOTkWG5sFNIKnTcrKyb4dIRsDmVa68cFIA9m1jUiaqOHngvgXrvD;
    private String be5lhYh9WoRxaz90fLCwutY7P2UOOSHvgVGbV0kf2Fz5aZ7Z6ntVyTwptyFUH2WW = "";
    ...
    private OnConsentListener f776hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    private Context wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou;

    /* renamed from: wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou  reason: collision with other field name */
    private SharedPreferences f777wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou;

    /* renamed from: wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou  reason: collision with other field name */
    private Bundle f778wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou;
    ...
    public MakeroidDataProtection(Context context) {
        Bundle bundle;
        new Bundle();
        this.f778wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou = bundle;
        setContext(context);
    }
    ...
    private void setContext(Context context) {
        this.wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou = context;
        this.f777wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou = this.wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou.getSharedPreferences(this.CjxGCkQSTAjvR1nNlMdbKil40XRwRktLBU1cWxZmNEv2KEZKq1wwOgz5H2xrzq8N, 0);
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = this.f777wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou.edit();
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.apply();
        this.f778wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou.putString("npa", "1");
    ...
    public void setInterstitialAd(InterstitialAd interstitialAd) {
        this.f774B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T = interstitialAd;
        int i = Log.i(this.LOG_TAG, "InterstitialAd was added.");
    }

    public void setRewardedVideoAd(RewardedVideoAd rewardedVideoAd) {
        this.f775B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T = rewardedVideoAd;
    ...
    public void setInterstitialOptions(boolean z, String str, int i) {
        String str2 = str;
        int i2 = i;
        this.PMWpqVMsyfTUgqkfqh3FKX4Q3IYlcybzKrBGEl7qtzs6HNVssJ63V430Ige89pyP = z;
        if (str2.equalsIgnoreCase("female")) {
            this.T3TEUSUxjrJVucuujQ9pjstrX3UcxHV1L9cOGs7CI5pfz9hjmRfdL7GRyW8ebdVq = 2;
        } else if (str2.equalsIgnoreCase("male")) {
            this.T3TEUSUxjrJVucuujQ9pjstrX3UcxHV1L9cOGs7CI5pfz9hjmRfdL7GRyW8ebdVq = 1;
        } else {
            this.T3TEUSUxjrJVucuujQ9pjstrX3UcxHV1L9cOGs7CI5pfz9hjmRfdL7GRyW8ebdVq = 0;
        }
        this.ZFwQoaMsdRwNqOTkWG5sFNIKnTcrKyb4dIRsDmVa68cFIA9m1jUiaqOHngvgXrvD = i2;
    ...
    public void setRewardedOptions(String str) {
        ...
        this.ik13O8j78hPb27XeipAJHUcJmdHxYMJFw4gYbTGvLKIOs7SX1F7x61gocQ17TlNc = true;
    }

    public void setComponentType(String str) {
        StringBuilder sb;
        String str2 = str;
        this.Sa0jypR6YD5j7ayqbvuoqzuaJRSrX8yjkvtL3QPciDNsj5IsamevCs24OFmH7uZQ = str2;
    ...
    private String vwEpIRqEf6xdtwTR9dehwBO7JUhyLV6iEzEK2WqfPN10eUMQDPn3AUmqAFfsnr6R() {
        return vSp02fkBXgM8EI0gm0rKWXHQ6wdQINJBQuAtCR15YU8g4XNqVKV8r32SYxkQYxkq(this.Sa0jypR6YD5j7ayqbvuoqzuaJRSrX8yjkvtL3QPciDNsj5IsamevCs24OFmH7uZQ, "TYPE_WAS_NOT_FOUND");
    }

    public void setTitle(String str) {
        this.FrTvqStiZO2F73haZ4c62UUmwpyiTR0Q3saFC1nYzrvmpyGkgyFFxTtzoQAKnoll = str;
        int i = Log.i(this.LOG_TAG, "DialogTitle was added.");
    }

    public String getTitle() {
        return vSp02fkBXgM8EI0gm0rKWXHQ6wdQINJBQuAtCR15YU8g4XNqVKV8r32SYxkQYxkq(this.FrTvqStiZO2F73haZ4c62UUmwpyiTR0Q3saFC1nYzrvmpyGkgyFFxTtzoQAKnoll, "Data Protection");
    }

    public void setMessage(String str) {
        this.WXrxsncNaI12QELoywiijcLROkSQSR7QVFw2zT3BVYf147C9TZQ4jsxpxFZAUav = str;
        int i = Log.i(this.LOG_TAG, "DialogMessage was added.");
    }

    public String getMessage() {
        return vSp02fkBXgM8EI0gm0rKWXHQ6wdQINJBQuAtCR15YU8g4XNqVKV8r32SYxkQYxkq(this.WXrxsncNaI12QELoywiijcLROkSQSR7QVFw2zT3BVYf147C9TZQ4jsxpxFZAUav, "Can we continue to use your data to tailor ads for you?");
    }
    ...
    public void setDevelopmentMode(boolean z) {
        boolean z2 = z;
        this.WrlQqhIKmKuB9b4JVzpHXmCJrSlbkHSNA5ubvsLC9K31KYZzZrethddcAVSmF8Zp = z2;
    }
    ...
    public void Start() {
        ...
        if (!KodularGDPRUtil.isRequestLocationInEurope(this.wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou) && !this.WrlQqhIKmKuB9b4JVzpHXmCJrSlbkHSNA5ubvsLC9K31KYZzZrethddcAVSmF8Zp) {
        ...
        } else if (!this.WrlQqhIKmKuB9b4JVzpHXmCJrSlbkHSNA5ubvsLC9K31KYZzZrethddcAVSmF8Zp && !this.f777wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou.getBoolean("FirstTime", true)) {
            int i2 = Log.i(this.LOG_TAG, "The user has already made a selection.");
            if (this.f777wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou.getBoolean("Personalized", false)) {
                int i3 = Log.i(this.LOG_TAG, "Personalized was loaded from the db.");
                B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T(1);
            } else if (this.f777wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou.getBoolean("AdsFree", false)) {
        ...
        } else if (this.wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou == null) {
            ...
            int i6 = Log.i(str, sb.append(this.WrlQqhIKmKuB9b4JVzpHXmCJrSlbkHSNA5ubvsLC9K31KYZzZrethddcAVSmF8Zp).toString());
            if (Build.VERSION.SDK_INT >= 21) {
                new AlertDialog.Builder(this.wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou, 16974393);
                create = builder2.create();
            } else {
                new AlertDialog.Builder(this.wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou, 16974130);
            ...
            create.setButton(-1, this.wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou.getResources().getString(17039379), onClickListener);
            new DialogInterface.OnClickListener(this) {
                private /* synthetic */ MakeroidDataProtection B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T;
            ...
            create.setButton(-2, this.wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou.getResources().getString(17039369), onClickListener2);
            create.show();
        }
    }
    ...
    public void B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T(int i) {
        ...
        if (vwEpIRqEf6xdtwTR9dehwBO7JUhyLV6iEzEK2WqfPN10eUMQDPn3AUmqAFfsnr6R().equalsIgnoreCase(TYPE_AD_MOB_BANNER)) {
            if (this.B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T == null) {
                ...
                new AdRequest.Builder();
                adView2.loadAd(builder3.addNetworkExtrasBundle(AdMobAdapter.class, this.f778wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou).build());
            }
        } else if (vwEpIRqEf6xdtwTR9dehwBO7JUhyLV6iEzEK2WqfPN10eUMQDPn3AUmqAFfsnr6R().equalsIgnoreCase(TYPE_AD_MOB_INTERSTITIAL)) {
            if (this.f774B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T == null) {
                int e2 = Log.e(this.LOG_TAG, "Please add your InterstitialAd in 'void setInterstitialAd(InterstitialAd interstitialAd);'");
            } else if (!this.vzOZHmUO5BPgEzqFqapthv9IfOCdoiue7DhwcposBCrplFafOlnwvaDCI1FzofZg) {
                ...
                if (this.ZFwQoaMsdRwNqOTkWG5sFNIKnTcrKyb4dIRsDmVa68cFIA9m1jUiaqOHngvgXrvD > 0) {
            ...
            if (this.f775B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T == null) {
                int e4 = Log.e(this.LOG_TAG, "Please add your RewardedVideoAd in 'void setRewardedOptions(RewardedVideoAd rewardedVideoAd);'");
            } else if (!this.ik13O8j78hPb27XeipAJHUcJmdHxYMJFw4gYbTGvLKIOs7SX1F7x61gocQ17TlNc) {
                ...
                RewardedVideoAd rewardedVideoAd = this.f775B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T;
                String str = this.EF39AXcqvcVSzkIDlhtBxpJQpYLF2tkAZ1Yh8aWSrM6HvDBggPKm9DsfgSWrxWia;
                new AdRequest.Builder();
                ...
                RewardedVideoAd rewardedVideoAd2 = this.f775B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T;
                String str2 = this.EF39AXcqvcVSzkIDlhtBxpJQpYLF2tkAZ1Yh8aWSrM6HvDBggPKm9DsfgSWrxWia;
                new AdRequest.Builder();
                rewardedVideoAd2.loadAd(str2, builder.addNetworkExtrasBundle(AdMobAdapter.class, this.f778wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou).build());
            }
    ...
    private void hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO(boolean z) {
        ...
        boolean commit = this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.commit();
        if (this.f776hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            this.f776hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.result(false, z2);
        }
        this.FWhlgAfItZPAj52Sbrmx0NIMbFKmURdRAyv8T1hdxDpczs3OJmULpy7aDRNSO45K = false;
        this.bxHyewHDU6tjPjcIzbzXfzV01j8NQWoss5bSPV3aTV9R2HuXrtdJDRKZiMMA21Bn = z2;
    ...
    private void zWdiPvy9THbs14kS37O202JH95jn5GzRAXQdLdM0hhw5e6hZSAshBMBb0bJkJXW5() {
        AdRequest.Builder builder;
        new AdRequest.Builder();
        AdRequest.Builder gender = builder.tagForChildDirectedTreatment(this.PMWpqVMsyfTUgqkfqh3FKX4Q3IYlcybzKrBGEl7qtzs6HNVssJ63V430Ige89pyP).setGender(this.T3TEUSUxjrJVucuujQ9pjstrX3UcxHV1L9cOGs7CI5pfz9hjmRfdL7GRyW8ebdVq);
        this.f774B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T.loadAd(gender.setBirthday(hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(this.ZFwQoaMsdRwNqOTkWG5sFNIKnTcrKyb4dIRsDmVa68cFIA9m1jUiaqOHngvgXrvD)).build());
    }
    ...
    private void bVeTzqSexGvEaauwiYAVDIi0rEKwP38hsr4zIk14QJ70YrYaNw4t0FSa76teZ34b() {
        ...
        new AdRequest.Builder();
        AdRequest.Builder gender = builder.tagForChildDirectedTreatment(this.PMWpqVMsyfTUgqkfqh3FKX4Q3IYlcybzKrBGEl7qtzs6HNVssJ63V430Ige89pyP).setGender(this.T3TEUSUxjrJVucuujQ9pjstrX3UcxHV1L9cOGs7CI5pfz9hjmRfdL7GRyW8ebdVq);
        this.f774B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T.loadAd(gender.setBirthday(hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(this.ZFwQoaMsdRwNqOTkWG5sFNIKnTcrKyb4dIRsDmVa68cFIA9m1jUiaqOHngvgXrvD)).addNetworkExtrasBundle(AdMobAdapter.class, this.f778wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou).build());
    }

    private void J9GCddMpW5m7K6b7f8nFol5AuYTClyx20NTbEibimiSwx7sDFiwQjZjPs0Mw8DwU() {
        AdRequest.Builder builder;
        new AdRequest.Builder();
        this.f774B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T.loadAd(builder.tagForChildDirectedTreatment(this.PMWpqVMsyfTUgqkfqh3FKX4Q3IYlcybzKrBGEl7qtzs6HNVssJ63V430Ige89pyP).setGender(this.T3TEUSUxjrJVucuujQ9pjstrX3UcxHV1L9cOGs7CI5pfz9hjmRfdL7GRyW8ebdVq).build());
    }

    private void KZERK4FJjgj00YJ12FkBt8g0XGe7fRlOujzm0QMQzA20gzGqez6qkZCId3aKJaes() {
        AdRequest.Builder builder;
        new AdRequest.Builder();
        this.f774B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T.loadAd(builder.tagForChildDirectedTreatment(this.PMWpqVMsyfTUgqkfqh3FKX4Q3IYlcybzKrBGEl7qtzs6HNVssJ63V430Ige89pyP).setGender(this.T3TEUSUxjrJVucuujQ9pjstrX3UcxHV1L9cOGs7CI5pfz9hjmRfdL7GRyW8ebdVq).addNetworkExtrasBundle(AdMobAdapter.class, this.f778wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou).build());
    }
    ...
    public void setOnConsentListener(OnConsentListener onConsentListener) {
        ...
        this.f776hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = onConsentListener2;
    }
}
