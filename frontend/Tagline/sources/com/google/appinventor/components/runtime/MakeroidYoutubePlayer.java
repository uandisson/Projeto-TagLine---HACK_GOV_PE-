...
public class MakeroidYoutubePlayer extends AndroidViewComponent {
    private boolean Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW = false;
    ...
    private YouTubePlayerView f708hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

    /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
    private PlayerUIController f709hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

    /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
    private YouTubePlayerTracker f710hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    static /* synthetic */ PlayerUIController hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(MakeroidYoutubePlayer makeroidYoutubePlayer, PlayerUIController playerUIController) {
        ...
        makeroidYoutubePlayer.f709hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = playerUIController3;
    ...
    public MakeroidYoutubePlayer(com.google.appinventor.components.runtime.ComponentContainer r8) {
        /*
            ...
            r2 = r0
            r3 = 0
            r2.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW = r3
            r2 = r0
            r3 = r1
            r2.container = r3
            r2 = r0
            ...
            r4.<init>(r5)
            r2.f708hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r3
            r2 = r0
            ...
            r4 = r6
            r4.<init>()
            r2.f710hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r3
            r2 = r0
            com.pierfrancescosoffritti.androidyoutubeplayer.player.YouTubePlayerView r2 = r2.f708hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME
    ...
    public YouTubePlayerView getView() {
        return this.f708hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    }
    ...
    public boolean IsFullscreen() {
        return this.f708hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.isFullScreen();
    }

    @SimpleFunction(description = "Toggle the state of the video player.")
    public void ToggleFullscreen() {
        this.f708hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.toggleFullScreen();
    }

    @SimpleFunction(description = "Enter the video in fullscreen mode.")
    public void EnterFullscreen() {
        this.f708hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.enterFullScreen();
    }

    @SimpleFunction(description = "Exit the video from fullscreen mode.")
    public void ExitFullscreen() {
        this.f708hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.exitFullScreen();
    }

    @SimpleProperty(description = "Returns the current second.")
    public float GetCurrentSecond() {
        if (this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            return this.f710hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getCurrentSecond();
        }
        return 0.0f;
    }
    ...
    public float GetVideoDuration() {
        if (this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            return this.f710hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getVideoDuration();
        }
        return 0.0f;
    }
    ...
    public void EnableLiveVideoUI(boolean z) {
        ...
        if (this.f709hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            this.f709hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.enableLiveVideoUI(z2);
        }
    }
