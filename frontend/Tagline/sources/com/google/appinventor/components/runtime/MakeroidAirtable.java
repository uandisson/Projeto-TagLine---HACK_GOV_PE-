...
public class MakeroidAirtable extends AndroidNonvisibleComponent {
    ...
    public void GetAllData() throws Exception {
        ...
        try {
            ...
            new URL(sb3.append(this.jKPsNUTq382ltO4Ct4VOTi9lUb0GK32zS6afcWmZUk1wuONzG2KH4rBMniXwxrgH).append("/").append(this.AjvYp2jprm0xITJdrrGGtoOyEc1YvelLDxRNqR8p3eG4UJR1UusSlSmznC0GO8Nd).append("?&view=").append(this.Ta6bjdQXoFeEb44hWQ7kTTTXw2rT1LHw6UX7lms7WU7H0AkpETH9D9EhELUfywQi).toString().replaceAll(" ", "%20"));
            HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
            HttpURLConnection httpURLConnection2 = httpURLConnection;
            httpURLConnection.setRequestProperty(Constants.AUTHORIZATION_HEADER, sb5);
    ...
    public void Cell(int i, String str) throws Exception {
        ...
        new StringBuilder("https://api.airtable.com/v0/");
        new URL(sb2.append(this.jKPsNUTq382ltO4Ct4VOTi9lUb0GK32zS6afcWmZUk1wuONzG2KH4rBMniXwxrgH).append("/").append(this.AjvYp2jprm0xITJdrrGGtoOyEc1YvelLDxRNqR8p3eG4UJR1UusSlSmznC0GO8Nd).append("?fields[]=").append(str2).append("&view=").append(this.Ta6bjdQXoFeEb44hWQ7kTTTXw2rT1LHw6UX7lms7WU7H0AkpETH9D9EhELUfywQi).toString().replaceAll(" ", "%20"));
        HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
        HttpURLConnection httpURLConnection2 = httpURLConnection;
        httpURLConnection.setRequestProperty(Constants.AUTHORIZATION_HEADER, sb4);
        httpURLConnection2.setRequestProperty(DefaultHttpClient.CONTENT_TYPE_KEY, "application/json");
        int responseCode = httpURLConnection2.getResponseCode();
        new InputStreamReader(httpURLConnection2.getInputStream());
        new BufferedReader(reader);
        ...
        String string = jSONObject4.getString(CommonProperties.f295ID);
    ...
    public void GetCellWithOffset(String str, JSONArray jSONArray, String str2, int i) {
        ...
        try {
            new StringBuilder("https://api.airtable.com/v0/");
            new URL(sb3.append(this.jKPsNUTq382ltO4Ct4VOTi9lUb0GK32zS6afcWmZUk1wuONzG2KH4rBMniXwxrgH).append("/").append(this.AjvYp2jprm0xITJdrrGGtoOyEc1YvelLDxRNqR8p3eG4UJR1UusSlSmznC0GO8Nd).append("?fields[]=").append(str4).append("&view=").append(this.Ta6bjdQXoFeEb44hWQ7kTTTXw2rT1LHw6UX7lms7WU7H0AkpETH9D9EhELUfywQi).append("&offset=").append(str3).toString().replaceAll(" ", "%20"));
            HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
            HttpURLConnection httpURLConnection2 = httpURLConnection;
            httpURLConnection.setRequestProperty(Constants.AUTHORIZATION_HEADER, sb5);
            httpURLConnection2.setRequestProperty(DefaultHttpClient.CONTENT_TYPE_KEY, "application/json");
    ...
    public void setCell(int i, String str, String str2) throws Exception {
        ...
        String string = jSONArray.getJSONObject(i - 1).getString(CommonProperties.f295ID);
        DataOutputStream dataOutputStream2 = null;
        try {
            new StringBuilder("https://api.airtable.com/v0/");
            new URL(sb2.append(this.jKPsNUTq382ltO4Ct4VOTi9lUb0GK32zS6afcWmZUk1wuONzG2KH4rBMniXwxrgH).append("/").append(this.AjvYp2jprm0xITJdrrGGtoOyEc1YvelLDxRNqR8p3eG4UJR1UusSlSmznC0GO8Nd).append("/").append(string).toString().replaceAll(" ", "%20"));
            HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
            ...
            httpURLConnection.addRequestProperty(Constants.AUTHORIZATION_HEADER, sb5);
    ...
    public void deleteRowNum(int i) throws Exception {
        ...
        httpURLConnection.setRequestProperty(Constants.AUTHORIZATION_HEADER, sb4);
        httpURLConnection2.setRequestProperty(DefaultHttpClient.CONTENT_TYPE_KEY, "application/json");
        httpURLConnection2.setRequestMethod(DefaultHttpClient.METHOD_DELETE);
        int responseCode = httpURLConnection2.getResponseCode();
        new InputStreamReader(httpURLConnection2.getInputStream());
        new BufferedReader(reader);
        BufferedReader bufferedReader2 = bufferedReader;
    ...
    public void createRow(YailList yailList, YailList yailList2) throws Exception {
        ...
        try {
            new StringBuilder("https://api.airtable.com/v0/");
            new URL(sb2.append(this.jKPsNUTq382ltO4Ct4VOTi9lUb0GK32zS6afcWmZUk1wuONzG2KH4rBMniXwxrgH).append("/").append(this.AjvYp2jprm0xITJdrrGGtoOyEc1YvelLDxRNqR8p3eG4UJR1UusSlSmznC0GO8Nd).toString().replaceAll(" ", "%20"));
            HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
            new StringBuilder("{\"fields\":");
