...
public class KodularAnalyticsUtil {
    ...
    /* renamed from: com.google.appinventor.components.runtime.util.KodularAnalyticsUtil$a */
    static class C1166a {
        final Map<String, String> yKzj3OK1ig8r7pqFZ5OXQyoqJiWnRvwjZPZ1kORJGZPQRb8FuKJuM2qAKu5QCSLT;

        public C1166a() {
            Map<String, String> map;
            new HashMap();
            this.yKzj3OK1ig8r7pqFZ5OXQyoqJiWnRvwjZPZ1kORJGZPQRb8FuKJuM2qAKu5QCSLT = map;
        }

        public final C1166a hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(String str, String str2) {
            String put = this.yKzj3OK1ig8r7pqFZ5OXQyoqJiWnRvwjZPZ1kORJGZPQRb8FuKJuM2qAKu5QCSLT.put(str, str2);
            return this;
        }
    }
}
