...
public final class BluetoothClient extends BluetoothConnectionBase {
    ...
    public final boolean IsDevicePaired(String str) {
        ...
        if (bluetoothAdapter == null) {
            this.form.dispatchErrorOccurredEvent(this, str3, ErrorMessages.ERROR_BLUETOOTH_NOT_AVAILABLE, new Object[0]);
            return false;
        } else if (!BluetoothReflection.isBluetoothEnabled(obj)) {
            this.form.dispatchErrorOccurredEvent(this, str3, ErrorMessages.ERROR_BLUETOOTH_NOT_ENABLED, new Object[0]);
            return false;
        } else {
            ...
            this.form.dispatchErrorOccurredEvent(this, str3, ErrorMessages.ERROR_BLUETOOTH_INVALID_ADDRESS, new Object[0]);
            return false;
        }
    }
        ...
        if (bluetoothAdapter != null && BluetoothReflection.isBluetoothEnabled(obj)) {
            for (Object next : BluetoothReflection.getBondedDevices(obj)) {
                if (hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(next)) {
                    ...
                    new StringBuilder();
                    boolean add = list2.add(sb.append(bluetoothDeviceAddress).append(" ").append(bluetoothDeviceName).toString());
                }
            }
        }
        return list2;
    ...
    private boolean hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(String str, String str2, String str3) {
        ...
        Object obj = bluetoothAdapter;
        if (bluetoothAdapter == null) {
            this.form.dispatchErrorOccurredEvent(this, str4, ErrorMessages.ERROR_BLUETOOTH_NOT_AVAILABLE, new Object[0]);
            return false;
        } else if (!BluetoothReflection.isBluetoothEnabled(obj)) {
            this.form.dispatchErrorOccurredEvent(this, str4, ErrorMessages.ERROR_BLUETOOTH_NOT_ENABLED, new Object[0]);
            return false;
        } else {
            ...
            if (!BluetoothReflection.checkBluetoothAddress(obj, str5)) {
                this.form.dispatchErrorOccurredEvent(this, str4, ErrorMessages.ERROR_BLUETOOTH_INVALID_ADDRESS, new Object[0]);
                return false;
            }
            ...
            if (!BluetoothReflection.isBonded(remoteDevice)) {
                this.form.dispatchErrorOccurredEvent(this, str4, ErrorMessages.ERROR_BLUETOOTH_NOT_PAIRED_DEVICE, new Object[0]);
                return false;
            } else if (!hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(obj2)) {
                this.form.dispatchErrorOccurredEvent(this, str4, ErrorMessages.ERROR_BLUETOOTH_NOT_REQUIRED_CLASS_OF_DEVICE, new Object[0]);
                return false;
            } else {
                try {
                    ...
                    try {
                        ...
                        int i2 = Log.i(str7, sb.append(BluetoothReflection.getBluetoothDeviceAddress(obj3)).append(" ").append(BluetoothReflection.getBluetoothDeviceName(obj3)).append(".").toString());
                        return true;
                    } catch (Exception e) {
                        Disconnect();
                        this.form.dispatchErrorOccurredEvent(this, str4, ErrorMessages.ERROR_BLUETOOTH_UNABLE_TO_CONNECT, new Object[0]);
                        return false;
                    }
