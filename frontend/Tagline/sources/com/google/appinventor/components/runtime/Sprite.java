...
public abstract class Sprite extends VisibleComponent implements AlarmHandler, Deleteable, OnDestroyListener {
    ...
    private void m70hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(double d) {
        double d2 = d;
    ...
    private void m69B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T(double d) {
        double d2 = d;
        if (this.originAtCenter) {
            this.yCenter = d2;
    ...
    public void mo13880Z(double d) {
        ...
        canvas3.f565hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.invalidate();
    }
