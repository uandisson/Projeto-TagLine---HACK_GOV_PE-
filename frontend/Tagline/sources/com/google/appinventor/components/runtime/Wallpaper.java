...
public class Wallpaper extends AndroidNonvisibleComponent implements Component {
    private String OwdMPkBe57XgAj0YzjiQROmM9oaAuHcFVDiJ8FBhJvH3sMzMunZOSbYX19xrqcxQ = "wallpaperPicture.png";
    ...
    public Wallpaper(com.google.appinventor.components.runtime.ComponentContainer r6) {
        /*
            ...
            r2.OwdMPkBe57XgAj0YzjiQROmM9oaAuHcFVDiJ8FBhJvH3sMzMunZOSbYX19xrqcxQ = r3
            r2 = r0
            r3 = r1
            r2.container = r3
            r2 = r0
    ...
    class C1090b extends AsyncTask<String, String, String> {
        ...
        C1090b(Wallpaper wallpaper, boolean z) {
            this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = wallpaper;
            this.dNRA8zk5IiUh4Pp3hPTF1cOQ5zFA2APl8kyLVDxMBtQN7HXMvFLEdGqNCHj4PKNw = z;
        }
        ...
        public String doInBackground(String... strArr) {
            try {
                ...
                if (!this.dNRA8zk5IiUh4Pp3hPTF1cOQ5zFA2APl8kyLVDxMBtQN7HXMvFLEdGqNCHj4PKNw) {
    ...
    public void GetWallpaper() {
        ...
        new PermissionResultHandler(this) {
            ...
            public final void HandlePermissionResponse(String str, boolean z) {
                ...
                String str2 = str;
                if (z) {
                    new C1089a(this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, (byte) 0);
    ...
    class C1089a extends AsyncTask<String, String, String> {
        private /* synthetic */ Wallpaper hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
        ...
        private C1089a(Wallpaper wallpaper) {
            this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = wallpaper;
        }

        /* JADX INFO: this call moved to the top of the method (can break code semantics) */
        /* synthetic */ C1089a(Wallpaper wallpaper, byte b) {
            this(wallpaper);
            byte b2 = b;
        }
    }
    ...
    public void SaveWallpaperAs(String str) {
        ...
        String str2 = str;
        if (str2 == null || str2.isEmpty()) {
            this.OwdMPkBe57XgAj0YzjiQROmM9oaAuHcFVDiJ8FBhJvH3sMzMunZOSbYX19xrqcxQ = "wallpaperPicture.png";
        } else {
            this.OwdMPkBe57XgAj0YzjiQROmM9oaAuHcFVDiJ8FBhJvH3sMzMunZOSbYX19xrqcxQ = str2;
        }
        new StringBuilder("Wallpaper save name is: ");
        int i = Log.i("Wallpaper", sb.append(this.OwdMPkBe57XgAj0YzjiQROmM9oaAuHcFVDiJ8FBhJvH3sMzMunZOSbYX19xrqcxQ).toString());
    }
    ...
    public java.lang.String SaveUtil(android.graphics.drawable.Drawable r10) {
        /*
            ...
            java.lang.StringBuilder r6 = r6.append(r7)     // Catch:{ PermissionException -> 0x0086, FileNotFoundException -> 0x00b2, Exception -> 0x00db }
            r7 = r0
            java.lang.String r7 = r7.OwdMPkBe57XgAj0YzjiQROmM9oaAuHcFVDiJ8FBhJvH3sMzMunZOSbYX19xrqcxQ     // Catch:{ PermissionException -> 0x0086, FileNotFoundException -> 0x00b2, Exception -> 0x00db }
            java.lang.StringBuilder r6 = r6.append(r7)     // Catch:{ PermissionException -> 0x0086, FileNotFoundException -> 0x00b2, Exception -> 0x00db }
