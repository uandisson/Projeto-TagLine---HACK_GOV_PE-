...
public abstract class BufferedSingleValueSensor extends SingleValueSensor {
    private C0604a hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (this.enabled && sensorEvent2.sensor.getType() == this.sensorType) {
            ...
            C0604a aVar = this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
            Float valueOf = Float.valueOf(fArr[0]);
            C0604a aVar2 = aVar;
            C0604a aVar3 = aVar2;
            Float[] fArr2 = aVar2.f554hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
            C0604a aVar4 = aVar3;
            ...
            fArr2[i] = valueOf;
            if (aVar3.hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO == aVar3.f554hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.length) {
    ...
    public float getAverageValue() {
        ...
        double d2 = 0.0d;
        int i = 0;
        for (int i2 = 0; i2 < aVar.f554hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.length; i2++) {
            if (aVar.f554hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME[i2] != null) {
                d2 += (double) aVar.f554hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME[i2].floatValue();
                i++;
            }
        }
        if (i == 0) {
    ...
    class C0604a {
        ...
        Float[] f554hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

        /* JADX INFO: this call moved to the top of the method (can break code semantics) */
        /* synthetic */ C0604a(BufferedSingleValueSensor bufferedSingleValueSensor, int i, byte b) {
            this(bufferedSingleValueSensor, i);
            byte b2 = b;
        }

        private C0604a(BufferedSingleValueSensor bufferedSingleValueSensor, int i) {
            this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = bufferedSingleValueSensor;
            this.f554hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = new Float[i];
