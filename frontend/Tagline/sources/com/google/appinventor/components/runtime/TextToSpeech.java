...
public class TextToSpeech extends AndroidNonvisibleComponent implements Component, OnDestroyListener, OnResumeListener, OnStopListener {
    ...
    private YailList F0SK4gPRNmAI2jCyU6DpJpRxlfo5Y8j9ZujjeLuDeDzReJBeSNN2RZtCnkXv1dho;
    ...
    private boolean plg04zzrdr0Ht9HKV9W5nEWP5Bmt4Culb23NXhe3Y9LVDLRrW71oAQyHt0KrFVdM;
    ...
    static /* synthetic */ boolean hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(TextToSpeech textToSpeech, boolean z) {
        boolean z2 = z;
        boolean z3 = z2;
        textToSpeech.nrk4qDbuonwjAUi7HPDytbtabfk6KLkf1OM4Z1o9O6dUiFPBfNVpTU1RRHKJKimM = z3;
        return z2;
    }
    ...
    public TextToSpeech(com.google.appinventor.components.runtime.ComponentContainer r11) {
        ...
        L_0x006d:
            ...
            r4 = r0
            r5 = 0
            r4.plg04zzrdr0Ht9HKV9W5nEWP5Bmt4Culb23NXhe3Y9LVDLRrW71oAQyHt0KrFVdM = r5
            r4 = r0
            ...
            r4.F0SK4gPRNmAI2jCyU6DpJpRxlfo5Y8j9ZujjeLuDeDzReJBeSNN2RZtCnkXv1dho = r5
            r4 = r0
            r9 = r4
            r4 = r9
            r5 = r9
            ...
            com.google.appinventor.components.runtime.util.YailList r5 = com.google.appinventor.components.runtime.util.YailList.makeList((java.util.List) r5)
            r4.LYVRHQlR5uMq9RmVQLgPQwQp4HVKuBDt7Jnpu0jTztYClgnk53NSpkUmjjPPbYn = r5
            return
        L_0x00be:
            r4 = 0
            goto L_0x002d
    ...
    public void Language(String str) {
        ...
        switch (str2.length()) {
            case 2:
                new Locale(str2);
                locale2 = locale;
                this.TVKenNjujur1C1Ft9Gj8dhchvJBwuJV9GDuQOmGg2gZVCkxzGoaa0a88A5IZ9COq = locale2.getLanguage();
                break;
            case 3:
                ...
                locale2 = locale3;
                this.TVKenNjujur1C1Ft9Gj8dhchvJBwuJV9GDuQOmGg2gZVCkxzGoaa0a88A5IZ9COq = locale2.getISO3Language();
                break;
            default:
        ...
        this.T3TEUSUxjrJVucuujQ9pjstrX3UcxHV1L9cOGs7CI5pfz9hjmRfdL7GRyW8ebdVq = locale2.getLanguage();
    }
    ...
    public void Country(String str) {
        ...
        switch (str2.length()) {
            ...
            case 3:
                ...
                locale2 = locale3;
                this.peQa36WzmOGDKVPxAtWvq1pN83yXrV2fw2e1QvLyEngIwdojN2EAkDoWXzH8bj7w = locale2.getISO3Country();
                break;
            default:
                locale2 = Locale.getDefault();
                this.peQa36WzmOGDKVPxAtWvq1pN83yXrV2fw2e1QvLyEngIwdojN2EAkDoWXzH8bj7w = locale2.getCountry();
        ...
        this.ZFwQoaMsdRwNqOTkWG5sFNIKnTcrKyb4dIRsDmVa68cFIA9m1jUiaqOHngvgXrvD = locale2.getCountry();
    }
    ...
    public void prepareLanguageAndCountryProperties() {
        ...
        if (Build.VERSION.SDK_INT >= 4) {
            ...
            this.F0SK4gPRNmAI2jCyU6DpJpRxlfo5Y8j9ZujjeLuDeDzReJBeSNN2RZtCnkXv1dho = YailList.makeList((List) this.hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO);
            this.LYVRHQlR5uMq9RmVQLgPQwQp4HVKuBDt7Jnpu0jTztYClgnk53NSpkUmjjPPbYn = YailList.makeList((List) this.vwEpIRqEf6xdtwTR9dehwBO7JUhyLV6iEzEK2WqfPN10eUMQDPn3AUmqAFfsnr6R);
        }
    ...
    public void Speak(String str) {
        Locale locale;
        BeforeSpeaking();
        new Locale(this.T3TEUSUxjrJVucuujQ9pjstrX3UcxHV1L9cOGs7CI5pfz9hjmRfdL7GRyW8ebdVq, this.ZFwQoaMsdRwNqOTkWG5sFNIKnTcrKyb4dIRsDmVa68cFIA9m1jUiaqOHngvgXrvD);
