...
public class GingerbreadUtil {
    ...
    public static NdefRecord createTextRecord(String str, boolean z) {
        ...
        String str2 = str;
        boolean z2 = z;
        byte[] bytes = Locale.getDefault().getLanguage().getBytes(Charset.forName(StringUtil.US_ASCII));
        byte[] bytes2 = str2.getBytes(z2 ? Charset.forName("UTF-8") : Charset.forName("UTF-16"));
