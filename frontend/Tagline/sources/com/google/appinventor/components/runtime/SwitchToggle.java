...
public final class SwitchToggle extends AndroidViewComponent implements CompoundButton.OnCheckedChangeListener {
    ...
    private String uB4tu69UCQ2bAIAJLxBrazJ0pEJF4D6biU0hi2lcEJLr1A0KTbjBgSa8eZhiikvR = "Switch Off";
    private String wOjOOBWoVyNzDzaWXgy1S9rRvmLqhYagLoPiKuHlw4Kpu5E5zVoSLSrwTs2bXyKG = "Switch On";
    ...
    public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        ...
        if (z2) {
            ...
            new StringBuilder();
            switchR.setText(TextViewUtil.fromHtml(sb2.append(this.wOjOOBWoVyNzDzaWXgy1S9rRvmLqhYagLoPiKuHlw4Kpu5E5zVoSLSrwTs2bXyKG).append("  ").toString()));
        } else {
            Switch switchR2 = this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
            new StringBuilder();
            switchR2.setText(TextViewUtil.fromHtml(sb.append(this.uB4tu69UCQ2bAIAJLxBrazJ0pEJF4D6biU0hi2lcEJLr1A0KTbjBgSa8eZhiikvR).append("  ").toString()));
        }
        Clicked(z2);
    }
    ...
    public final void TextOn(String str) {
        StringBuilder sb;
        StringBuilder sb2;
        this.wOjOOBWoVyNzDzaWXgy1S9rRvmLqhYagLoPiKuHlw4Kpu5E5zVoSLSrwTs2bXyKG = str;
    ...
    public final void TextOff(String str) {
        StringBuilder sb;
        StringBuilder sb2;
        this.uB4tu69UCQ2bAIAJLxBrazJ0pEJF4D6biU0hi2lcEJLr1A0KTbjBgSa8eZhiikvR = str;
        if (this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.isChecked()) {
            Switch switchR = this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
            new StringBuilder();
            switchR.setText(TextViewUtil.fromHtml(sb2.append(this.wOjOOBWoVyNzDzaWXgy1S9rRvmLqhYagLoPiKuHlw4Kpu5E5zVoSLSrwTs2bXyKG).append("  ").toString()));
