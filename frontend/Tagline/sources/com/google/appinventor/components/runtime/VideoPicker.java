...
public class VideoPicker extends Picker implements ActivityResultListener {
    ...
    public void resultReturned(int i, int i2, Intent intent) {
        ...
        if (i == this.requestCode && i3 == -1) {
            this.o44k8hwFXRIuKuKg7I6eMiQW7wHpqg26TYVWrO9lZMXcmI90qRFVIpxzAa71jXpQ = wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou(intent2.getData());
            AfterPicking(this.o44k8hwFXRIuKuKg7I6eMiQW7wHpqg26TYVWrO9lZMXcmI90qRFVIpxzAa71jXpQ);
        }
    }
