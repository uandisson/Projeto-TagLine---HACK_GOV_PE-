...
public class KodularEnigma {
    ...
    public char[] plugBoard = {'A', 'B', Access.CLASS_CONTEXT, 'D', 'E', 'F', 'G', 'H', Access.INNERCLASS_CONTEXT, 'J', 'K', 'L', Access.METHOD_CONTEXT, 'N', 'O', 'P', 'Q', 'R', 'S', Dimension.SYM_TRUE, 'U', 'V', 'W', 'X', 'Y', 'Z'};
    ...
    static {
        ...
        new StringBuffer(GMLConstants.GML_COORD_Z);
    ...
    public StringBuffer[] getValue(String str) {
        ...
        if (str2.equals("RotorI") || str2.equals("1")) {
            ...
            return stringBufferArr;
        } else if (str2.equals("RotorV") || str2.equals("5")) {
