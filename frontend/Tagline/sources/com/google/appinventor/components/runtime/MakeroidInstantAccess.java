...
public class MakeroidInstantAccess extends AndroidNonvisibleComponent implements Component {
    ...
    class C0883a extends AsyncTask<String, Void, String> {
        ...
        private C0883a(MakeroidInstantAccess makeroidInstantAccess) {
        ...
        /* synthetic */ C0883a(MakeroidInstantAccess makeroidInstantAccess, byte b) {
