...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f270CR = 13;

    /* renamed from: LF */
    private static final byte f271LF = 10;
    private byte[] buf;
    ...
    /* renamed from: in */
    private final InputStream f272in;
    private int pos;
    ...
    public void close() throws IOException {
        InputStream inputStream = this.f272in;
    ...
    private void fillBuf() throws IOException {
        Throwable th;
        int result = this.f272in.read(this.buf, 0, this.buf.length);
        if (result == -1) {
            Throwable th2 = th;
            new EOFException();
            throw th2;
