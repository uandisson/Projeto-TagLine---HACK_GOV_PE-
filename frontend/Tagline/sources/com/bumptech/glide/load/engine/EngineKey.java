...
class EngineKey implements Key {
    ...
    public Key getOriginalKey() {
        ...
        if (this.originalKey == null) {
            new OriginalKey(this.f280id, this.signature);
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.f280id.equals(engineKey.f280id)) {
            return false;
        }
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            this.hashCode = this.f280id.hashCode();
    ...
    public String toString() {
        ...
        if (this.stringKey == null) {
            new StringBuilder();
            StringBuilder append = sb.append("EngineKey{").append(this.f280id).append('+').append(this.signature).append("+[").append(this.width).append('x').append(this.height).append("]+").append('\'');
    ...
    public void updateDiskCacheKey(MessageDigest messageDigest) throws UnsupportedEncodingException {
        ...
        messageDigest2.update(this.f280id.getBytes("UTF-8"));
