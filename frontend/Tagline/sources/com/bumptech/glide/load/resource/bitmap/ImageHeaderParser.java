...
public class ImageHeaderParser {
    ...
    private static class StreamReader {
        ...
        /* renamed from: is */
        private final InputStream f284is;
        ...
        public int getUInt16() throws IOException {
            return ((this.f284is.read() << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK) | (this.f284is.read() & 255);
        }

        public short getUInt8() throws IOException {
            return (short) (this.f284is.read() & 255);
        }
        ...
        public long skip(long j) throws IOException {
            ...
            while (true) {
                ...
                long skipped = this.f284is.skip(toSkip);
                if (skipped > 0) {
                    j2 = toSkip - skipped;
                } else if (this.f284is.read() == -1) {
                    break;
                } else {
                    j2 = toSkip - 1;
                }
        ...
        public int read(byte[] bArr) throws IOException {
            ...
            while (true) {
                ...
                int read = this.f284is.read(buffer, buffer.length - toRead, toRead);
                int read2 = read;
                if (read == -1) {
                    break;
                }
