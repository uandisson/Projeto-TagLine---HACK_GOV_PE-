...
public class StreamBitmapDecoder implements ResourceDecoder<InputStream, Bitmap> {
    ...
    /* renamed from: ID */
    private static final String f285ID = "StreamBitmapDecoder.com.bumptech.glide.load.resource.bitmap";
    ...
    public String getId() {
        ...
        if (this.f286id == null) {
            new StringBuilder();
            this.f286id = sb.append(f285ID).append(this.downsampler.getId()).append(this.decodeFormat.name()).toString();
        }
        return this.f286id;
    }
}
