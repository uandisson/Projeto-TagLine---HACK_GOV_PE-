...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f275ix = readShort();
        this.header.currentFrame.f276iy = readShort();
        this.header.currentFrame.f274iw = readShort();
        this.header.currentFrame.f273ih = readShort();
        int packed = read();
