...
public class ErrorAttachmentLog extends AbstractLog {
    ...
    public void write(JSONStringer jSONStringer) throws JSONException {
        ...
        super.write(writer);
        JSONUtils.write(writer, CommonProperties.f295ID, getId());
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f291id == null ? that.f291id != null : !this.f291id.equals(that.f291id)) {
            return false;
        }
    ...
    public int hashCode() {
        return (31 * ((31 * ((31 * ((31 * ((31 * super.hashCode()) + (this.f291id != null ? this.f291id.hashCode() : 0))) + (this.errorId != null ? this.errorId.hashCode() : 0))) + (this.contentType != null ? this.contentType.hashCode() : 0))) + (this.fileName != null ? this.fileName.hashCode() : 0))) + Arrays.hashCode(this.data);
    }
}
