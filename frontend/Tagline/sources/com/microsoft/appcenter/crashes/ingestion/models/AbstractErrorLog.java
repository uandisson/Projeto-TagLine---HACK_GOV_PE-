...
public abstract class AbstractErrorLog extends AbstractLog {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f290id == null ? that.f290id != null : !this.f290id.equals(that.f290id)) {
            return false;
        }
