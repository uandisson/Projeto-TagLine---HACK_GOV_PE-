...
public class Extensions implements Model {
    ...
    /* renamed from: OS */
    private static final String f300OS = "os";
    ...
    public void setOs(OsExtension os) {
        OsExtension osExtension = os;
        this.f301os = osExtension;
    }
    ...
    public void read(JSONObject jSONObject) throws JSONException {
        ...
        if (object.has(f300OS)) {
            new OsExtension();
            OsExtension os = osExtension;
            os.read(object.getJSONObject(f300OS));
            setOs(os);
        }
        if (object.has(APP)) {
            new AppExtension();
    ...
    public void write(JSONStringer jSONStringer) throws JSONException {
        ...
        if (getOs() != null) {
            JSONStringer object5 = writer.key(f300OS).object();
            getOs().write(writer);
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f301os == null ? that.f301os != null : !this.f301os.equals(that.f301os)) {
            return false;
        }
    ...
    public int hashCode() {
        return (31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * (this.metadata != null ? this.metadata.hashCode() : 0)) + (this.protocol != null ? this.protocol.hashCode() : 0))) + (this.user != null ? this.user.hashCode() : 0))) + (this.device != null ? this.device.hashCode() : 0))) + (this.f301os != null ? this.f301os.hashCode() : 0))) + (this.app != null ? this.app.hashCode() : 0))) + (this.net != null ? this.net.hashCode() : 0))) + (this.sdk != null ? this.sdk.hashCode() : 0))) + (this.loc != null ? this.loc.hashCode() : 0);
    }
}
