...
public class AppExtension implements Model {
    ...
    /* renamed from: ID */
    private static final String f296ID = "id";
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f297id == null ? that.f297id != null : !this.f297id.equals(that.f297id)) {
            return false;
        }
    ...
    public int hashCode() {
        return (31 * ((31 * ((31 * ((31 * (this.f297id != null ? this.f297id.hashCode() : 0)) + (this.ver != null ? this.ver.hashCode() : 0))) + (this.name != null ? this.name.hashCode() : 0))) + (this.locale != null ? this.locale.hashCode() : 0))) + (this.userId != null ? this.userId.hashCode() : 0);
    }
}
