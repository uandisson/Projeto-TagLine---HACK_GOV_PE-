...
public abstract class CommonSchemaLog extends AbstractLog {
    ...
    /* renamed from: CV */
    private static final String f298CV = "cV";
    ...
    public void read(JSONObject jSONObject) throws JSONException {
        ...
        setCV(object.optString(f298CV, (String) null));
        if (object.has(EXT)) {
            new Extensions();
    ...
    public void write(JSONStringer jSONStringer) throws JSONException {
        ...
        JSONUtils.write(writer, f298CV, getCV());
        if (getExt() != null) {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f299cV == null ? that.f299cV != null : !this.f299cV.equals(that.f299cV)) {
            return false;
        }
