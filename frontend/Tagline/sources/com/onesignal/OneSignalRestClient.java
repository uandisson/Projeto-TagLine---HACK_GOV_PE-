...
class OneSignalRestClient {
    ...
    public static void put(String url, JSONObject jsonBody, ResponseHandler responseHandler) {
        ...
        new Runnable() {
            public void run() {
                OneSignalRestClient.makeRequest(str, "PUT", jSONObject, responseHandler2, OneSignalRestClient.TIMEOUT, (String) null);
            }
        };
    ...
    public static void post(String url, JSONObject jsonBody, ResponseHandler responseHandler) {
        ...
        new Runnable() {
            public void run() {
                OneSignalRestClient.makeRequest(str, DefaultHttpClient.METHOD_POST, jSONObject, responseHandler2, OneSignalRestClient.TIMEOUT, (String) null);
            }
        };
    ...
    public static void putSync(String url, JSONObject jsonBody, ResponseHandler responseHandler) {
        makeRequest(url, "PUT", jsonBody, responseHandler, TIMEOUT, (String) null);
    }

    public static void postSync(String url, JSONObject jsonBody, ResponseHandler responseHandler) {
        makeRequest(url, DefaultHttpClient.METHOD_POST, jsonBody, responseHandler, TIMEOUT, (String) null);
    }
    ...
    public static void makeRequest(String str, String str2, JSONObject jSONObject, ResponseHandler responseHandler, int i, String str3) {
        ...
        if (method == null || !OneSignal.shouldLogUserPrivacyConsentErrorMessageForMethodName((String) null)) {
    ...
    public static Thread startHTTPConnection(String str, String str2, JSONObject jSONObject, ResponseHandler responseHandler, int i, @Nullable String str3) {
        ...
        try {
            ...
            con.setRequestProperty("SDK-Version", "onesignal/android/031302");
            con.setRequestProperty("Accept", OS_ACCEPT_HEADER);
            if (jsonBody != null) {
                con.setDoInput(true);
            }
            if (method != null) {
                con.setRequestProperty(DefaultHttpClient.CONTENT_TYPE_KEY, "application/json; charset=UTF-8");
            ...
            switch (httpResponse) {
                ...
                case ErrorMessages.ERROR_NO_CAMERA_PERMISSION:
                    ...
                    new StringBuilder();
                    OneSignal.Log(log_level6, sb6.append("OneSignalRestClient: ").append(method == null ? DefaultHttpClient.METHOD_GET : method).append(" RECEIVED JSON: ").append(json).toString());
                ...
                case ErrorMessages.ERROR_TWITTER_UNABLE_TO_GET_ACCESS_TOKEN:
                    ...
                    new StringBuilder();
                    OneSignal.Log(log_level8, sb11.append("OneSignalRestClient: ").append(method == null ? DefaultHttpClient.METHOD_GET : method).append(" - Using Cached response due to 304: ").append(cachedResponse).toString());
