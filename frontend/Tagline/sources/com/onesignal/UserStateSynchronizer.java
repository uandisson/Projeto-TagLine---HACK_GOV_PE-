...
abstract class UserStateSynchronizer {
    ...
    private boolean isSessionCall() {
        return (getToSyncUserState().dependValues.optBoolean(OneSignalDbContract.OutcomeEventsTable.COLUMN_NAME_SESSION) || getId() == null) && !this.waitingForSessionResponse;
    }
        ...
        if (!syncEmailLogout() || userId == null) {
            ...
            synchronized (obj) {
                try {
                    ...
                    JSONObject dependDiff = generateJsonDiff(this.currentUserState.dependValues, getToSyncUserState().dependValues, (JSONObject) null, (Set<String>) null);
                    if (jsonBody == null) {
    ...
    public void logoutEmailSyncSuccess() {
        StringBuilder sb;
        Object remove = getToSyncUserState().dependValues.remove("logoutEmail");
        Object remove2 = this.toSyncUserState.dependValues.remove("email_auth_hash");
        Object remove3 = this.toSyncUserState.syncValues.remove("parent_player_id");
        this.toSyncUserState.persistState();
        Object remove4 = this.currentUserState.dependValues.remove("email_auth_hash");
        Object remove5 = this.currentUserState.syncValues.remove("parent_player_id");
        String emailLoggedOut = this.currentUserState.syncValues.optString("email");
        Object remove6 = this.currentUserState.syncValues.remove("email");
    ...
    private void doPutSync(String str, JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        new OneSignalRestClient.ResponseHandler(this) {
            ...
            public void onFailure(int i, String str, Throwable th) {
                ...
                Object obj = this.this$0.syncLock;
                Object obj2 = obj;
                synchronized (obj) {
                    try {
            ...
            public void onSuccess(String str) {
                ...
                synchronized (obj) {
                    try {
                        ...
                        if (jsonResponse.has(CommonProperties.f295ID)) {
                            String newUserId = jsonResponse.optString(CommonProperties.f295ID);
                        ...
                        JSONObject put = this.this$0.getUserStateForModification().dependValues.put(OneSignalDbContract.OutcomeEventsTable.COLUMN_NAME_SESSION, false);
                        ...
                        if (jsonResponse.has(OSInAppMessageController.IN_APP_MESSAGES_JSON_KEY)) {
                            OSInAppMessageController.getController().receivedInAppMessageJson(jsonResponse.getJSONArray(OSInAppMessageController.IN_APP_MESSAGES_JSON_KEY));
                        }
    ...
    public void updateDeviceInfo(JSONObject deviceInfo) {
        ...
        JSONObject generateJsonDiff = generateJsonDiff(toSync, deviceInfo, toSync, (Set<String>) null);
    }
    ...
    public void setNewSession() {
        ...
        try {
            ...
            obj = obj2;
            synchronized (obj2) {
                JSONObject put = getUserStateForModification().dependValues.put(OneSignalDbContract.OutcomeEventsTable.COLUMN_NAME_SESSION, true);
    ...
    public boolean getSyncAsNewSession() {
        return getUserStateForModification().dependValues.optBoolean(OneSignalDbContract.OutcomeEventsTable.COLUMN_NAME_SESSION);
    }
    ...
    public void sendTags(JSONObject jSONObject, @Nullable OneSignal.ChangeTagsUpdateHandler changeTagsUpdateHandler) {
        ...
        JSONObject generateJsonDiff = generateJsonDiff(userStateTags, tags, userStateTags, (Set<String>) null);
    }

    /* access modifiers changed from: package-private */
    public void syncHashedEmail(JSONObject emailFields) {
        JSONObject syncValues = getUserStateForModification().syncValues;
        JSONObject generateJsonDiff = generateJsonDiff(syncValues, emailFields, syncValues, (Set<String>) null);
    }

    /* access modifiers changed from: package-private */
    public void setExternalUserId(String str, OneSignal.OSInternalExternalUserIdUpdateCompletionHandler oSInternalExternalUserIdUpdateCompletionHandler) throws JSONException {
        ...
        JSONObject put = getUserStateForModification().syncValues.put("external_user_id", externalId);
    }
    ...
    /* access modifiers changed from: package-private */
    public void updateLocation(LocationGMS.LocationPoint point) {
