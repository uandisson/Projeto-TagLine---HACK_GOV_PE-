...
class OneSignalStateSynchronizer {
    ...
    static void sendTags(JSONObject jSONObject, @Nullable OneSignal.ChangeTagsUpdateHandler changeTagsUpdateHandler) {
        ...
        try {
            new JSONObject();
            JSONObject jsonField = jSONObject2.put("tags", newTags);
    ...
    static void setExternalUserId(String str, OneSignal.OSExternalUserIdUpdateCompletionHandler completionHandler) throws JSONException {
