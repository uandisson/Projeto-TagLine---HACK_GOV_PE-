...
class OneSignalPrefs {
    ...
    public static class WritePrefHandlerThread extends HandlerThread {
        ...
        public synchronized void startDelayedWrite() {
            ...
            synchronized (this) {
                if (OneSignal.appContext != null) {
                    ...
                    boolean postDelayed = this.mHandler.postDelayed(getNewRunnable(), (this.lastSyncTime - System.currentTimeMillis()) + 200);
                }
            }
        }
        ...
        private void startThread() {
            ...
            StringBuilder sb2;
            if (this.threadStartError != null) {
                throw this.threadStartError;
            } else if (this.threadStartRuntimeException != null) {
                throw this.threadStartRuntimeException;
            } else if (this.threadStartThrowable != null) {
                new StringBuilder();
                new RuntimeException(sb2.append(this.threadStartThrowable.getClass().getName()).append(": ").append(this.threadStartThrowable.getMessage()).toString(), this.threadStartThrowable);
                RuntimeException exception = runtimeException;
                exception.setStackTrace(this.threadStartThrowable.getStackTrace());
                throw exception;
            } else {
                try {
                    start();
                    ...
                    InternalError e2 = e;
                    this.threadStartError = e2;
                    throw e2;
                } catch (OutOfMemoryError e3) {
                    OutOfMemoryError e4 = e3;
                    this.threadStartError = e4;
                    throw e4;
                } catch (Error e5) {
                    Error t = e5;
                    this.threadStartError = t;
                    throw t;
                } catch (IllegalThreadStateException e6) {
                    new StringBuilder();
                    new IllegalThreadStateException(sb.append("Thread has state: ").append(getState()).toString());
                    IllegalThreadStateException exception2 = illegalThreadStateException;
                    exception2.setStackTrace(e6.getStackTrace());
                    this.threadStartRuntimeException = exception2;
                    throw exception2;
                } catch (RuntimeException e7) {
                    RuntimeException e8 = e7;
                    this.threadStartRuntimeException = e8;
                    throw e8;
                } catch (Throwable th) {
                    Throwable t2 = th;
                    this.threadStartThrowable = t2;
                    throw t2;
                }
            }
        }
