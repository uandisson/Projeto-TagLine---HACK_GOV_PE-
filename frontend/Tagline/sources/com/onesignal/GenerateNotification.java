...
class GenerateNotification {
    ...
    private static class OneSignalNotificationBuilder {
        ...
        /* synthetic */ OneSignalNotificationBuilder(C13991 r4) {
            this();
            C13991 r1 = r4;
        }
    }
    ...
    private static void showNotificationAsAlert(JSONObject gcmJson, Activity activity, int notificationId) {
        ...
        new Runnable() {
            public void run() {
                ...
                Intent putExtra3 = buttonIntent.putExtra("onesignal_data", jSONObject.toString());
                    ...
                    public void onClick(DialogInterface dialogInterface, int which) {
                        ...
                        if (list3.size() > 1) {
                            try {
                                ...
                                JSONObject put = newJsonData.put("actionSelected", list3.get(index));
                                Intent putExtra = intent.putExtra("onesignal_data", newJsonData.toString());
    ...
    private static PendingIntent getNewActionPendingIntent(int i, Intent intent) {
        ...
        if (openerIsBroadcast) {
            return PendingIntent.getBroadcast(currentContext, requestCode, intent2, Declaration.PACKAGE_ACCESS);
        }
        return PendingIntent.getActivity(currentContext, requestCode, intent2, Declaration.PACKAGE_ACCESS);
    }
    ...
    public static Intent getNewBaseIntent(int notificationId) {
        ...
        Intent intent2 = intent.putExtra("notificationId", notificationId);
        if (openerIsBroadcast) {
            return intent2;
        }
    ...
    private static Intent getNewBaseDeleteIntent(int notificationId) {
        Intent intent;
        new Intent(currentContext, notificationOpenedClass);
        Intent intent2 = intent.putExtra("notificationId", notificationId).putExtra(OneSignalDbContract.NotificationTable.COLUMN_NAME_DISMISSED, true);
        if (openerIsBroadcast) {
            return intent2;
        }
    ...
    private static OneSignalNotificationBuilder getBaseOneSignalNotificationBuilder(NotificationGenerationJob notificationGenerationJob) {
        ...
        new OneSignalNotificationBuilder((C13991) null);
        ...
        if (!(androidPriority < 0)) {
            ...
            if (!gcmBundle.has("ledc") || gcmBundle.optInt("led", 1) != 1) {
                ...
                try {
                    ...
                    NotificationCompat.Builder lights = notifBuilder.setLights(ledColor.intValue(), MapViewConstants.ANIMATION_DURATION_LONG, 5000);
                } catch (Throwable th) {
                    Throwable th2 = th;
                    notificationDefaults = 0 | 4;
                }
    ...
    private static Notification createGenericPendingIntentsForNotif(NotificationCompat.Builder builder, JSONObject gcmBundle, int i) {
        ...
        NotificationCompat.Builder contentIntent = notifBuilder.setContentIntent(getNewActionPendingIntent(random2.nextInt(), getNewBaseIntent(notificationId).putExtra("onesignal_data", gcmBundle.toString())));
    ...
    private static void createGenericPendingIntentsForGroup(NotificationCompat.Builder builder, JSONObject gcmBundle, String str, int i) {
        ...
        new SecureRandom();
        Random random2 = random;
        NotificationCompat.Builder contentIntent = notifBuilder.setContentIntent(getNewActionPendingIntent(random2.nextInt(), getNewBaseIntent(notificationId).putExtra("onesignal_data", gcmBundle.toString()).putExtra("grp", group)));
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r23v188, resolved type: android.text.SpannableString} */
    ...
    private static void createSummaryNotification(com.onesignal.NotificationGenerationJob r32, com.onesignal.GenerateNotification.OneSignalNotificationBuilder r33) {
        /*
            ...
            r14 = r23
            r23 = r13
            android.database.sqlite.SQLiteDatabase r23 = r23.getReadableDbWithRetries()     // Catch:{ all -> 0x0428 }
            r15 = r23
            r23 = 5
            r0 = r23
            java.lang.String[] r0 = new java.lang.String[r0]     // Catch:{ all -> 0x0428 }
            r23 = r0
            r31 = r23
            r23 = r31
            r24 = r31
            ...
            r23 = r2
            java.lang.Integer r23 = r23.getAndroidId()     // Catch:{ all -> 0x0428 }
            int r23 = r23.intValue()     // Catch:{ all -> 0x0428 }
            r24 = -1
            r0 = r23
            r1 = r24
            if (r0 == r1) goto L_0x0111
            java.lang.StringBuilder r23 = new java.lang.StringBuilder     // Catch:{ all -> 0x0428 }
            r31 = r23
            r23 = r31
            r24 = r31
            r24.<init>()     // Catch:{ all -> 0x0428 }
            r24 = r17
            java.lang.StringBuilder r23 = r23.append(r24)     // Catch:{ all -> 0x0428 }
            java.lang.String r24 = " AND android_notification_id <> "
            java.lang.StringBuilder r23 = r23.append(r24)     // Catch:{ all -> 0x0428 }
            r24 = r2
            java.lang.Integer r24 = r24.getAndroidId()     // Catch:{ all -> 0x0428 }
            java.lang.StringBuilder r23 = r23.append(r24)     // Catch:{ all -> 0x0428 }
            java.lang.String r23 = r23.toString()     // Catch:{ all -> 0x0428 }
            r17 = r23
        L_0x0111:
            r23 = r15
            ...
            android.database.Cursor r23 = r23.query(r24, r25, r26, r27, r28, r29, r30)     // Catch:{ all -> 0x0428 }
            r14 = r23
            r23 = r14
            boolean r23 = r23.moveToFirst()     // Catch:{ all -> 0x0428 }
            if (r23 == 0) goto L_0x0189
            java.util.ArrayList r23 = new java.util.ArrayList     // Catch:{ all -> 0x0428 }
            r31 = r23
            r23 = r31
            r24 = r31
            r24.<init>()     // Catch:{ all -> 0x0428 }
        ...
        L_0x013e:
            ...
            int r24 = r24.getColumnIndex(r25)     // Catch:{ all -> 0x0428 }
            int r23 = r23.getInt(r24)     // Catch:{ all -> 0x0428 }
            r24 = 1
            r0 = r23
            r1 = r24
            ...
            int r24 = r24.getColumnIndex(r25)     // Catch:{ all -> 0x0428 }
            int r23 = r23.getInt(r24)     // Catch:{ all -> 0x0428 }
            java.lang.Integer r23 = java.lang.Integer.valueOf(r23)     // Catch:{ all -> 0x0428 }
            r10 = r23
        L_0x016a:
            r23 = r14
            boolean r23 = r23.moveToNext()     // Catch:{ all -> 0x0428 }
            if (r23 != 0) goto L_0x013e
            r23 = r4
            if (r23 == 0) goto L_0x0189
            r23 = r11
            if (r23 == 0) goto L_0x0189
            org.json.JSONObject r23 = new org.json.JSONObject     // Catch:{ JSONException -> 0x041e }
            r31 = r23
            r23 = r31
            r24 = r31
            r25 = r11
            r24.<init>(r25)     // Catch:{ JSONException -> 0x041e }
            r5 = r23
        L_0x0189:
            r23 = r14
        ...
        L_0x0232:
            ...
            r0 = r23
            android.support.v4.app.NotificationCompat$Builder r0 = r0.compatBuilder
            r23 = r0
            r18 = r23
            r23 = r4
        ...
        L_0x0249:
            r23 = r18
            r24 = r15
            android.support.v4.app.NotificationCompat$Builder r23 = r23.setContentIntent(r24)
            r24 = r8
            android.support.v4.app.NotificationCompat$Builder r23 = r23.setDeleteIntent(r24)
            ...
            android.support.v4.app.NotificationCompat$Builder r23 = r23.setContentTitle(r24)
            r24 = r17
            android.support.v4.app.NotificationCompat$Builder r23 = r23.setContentText(r24)
            r24 = r16
            android.support.v4.app.NotificationCompat$Builder r23 = r23.setNumber(r24)
            int r24 = getDefaultSmallIconId()
            android.support.v4.app.NotificationCompat$Builder r23 = r23.setSmallIcon(r24)
            android.graphics.Bitmap r24 = getDefaultLargeIcon()
            android.support.v4.app.NotificationCompat$Builder r23 = r23.setLargeIcon(r24)
            r24 = r4
            android.support.v4.app.NotificationCompat$Builder r23 = r23.setOnlyAlertOnce(r24)
            r24 = 0
            android.support.v4.app.NotificationCompat$Builder r23 = r23.setAutoCancel(r24)
            r24 = r6
            android.support.v4.app.NotificationCompat$Builder r23 = r23.setGroup(r24)
            r24 = 1
            android.support.v4.app.NotificationCompat$Builder r23 = r23.setGroupSummary(r24)
            r23 = r18
            r24 = 1
            android.support.v4.app.NotificationCompat$Builder r23 = r23.setGroupAlertBehavior(r24)     // Catch:{ Throwable -> 0x04a2 }
        L_0x02a7:
            r23 = r4
            if (r23 != 0) goto L_0x02b3
            r23 = r18
            r24 = r17
            android.support.v4.app.NotificationCompat$Builder r23 = r23.setTicker(r24)
        L_0x02b3:
            android.support.v4.app.NotificationCompat$InboxStyle r23 = new android.support.v4.app.NotificationCompat$InboxStyle
            r31 = r23
            r23 = r31
            r24 = r31
            r24.<init>()
        ...
        L_0x033d:
            r23 = r19
            r24 = r22
            android.support.v4.app.NotificationCompat$InboxStyle r23 = r23.addLine(r24)
        L_0x0345:
            r23 = r12
        ...
        L_0x0368:
            ...
            int r24 = r24.getColumnIndex(r25)     // Catch:{ all -> 0x0428 }
            java.lang.String r23 = r23.getString(r24)     // Catch:{ all -> 0x0428 }
            r20 = r23
            r23 = r20
        ...
        L_0x0382:
            ...
            java.lang.String r23 = r23.getString(r24)     // Catch:{ all -> 0x0428 }
            r21 = r23
            android.text.SpannableString r23 = new android.text.SpannableString     // Catch:{ all -> 0x0428 }
            r31 = r23
            r23 = r31
            r24 = r31
            java.lang.StringBuilder r25 = new java.lang.StringBuilder     // Catch:{ all -> 0x0428 }
            r31 = r25
            r25 = r31
            r26 = r31
            r26.<init>()     // Catch:{ all -> 0x0428 }
            r26 = r20
            java.lang.StringBuilder r25 = r25.append(r26)     // Catch:{ all -> 0x0428 }
            r26 = r21
            java.lang.StringBuilder r25 = r25.append(r26)     // Catch:{ all -> 0x0428 }
            java.lang.String r25 = r25.toString()     // Catch:{ all -> 0x0428 }
            r24.<init>(r25)     // Catch:{ all -> 0x0428 }
            r19 = r23
            r23 = r20
            int r23 = r23.length()     // Catch:{ all -> 0x0428 }
            if (r23 <= 0) goto L_0x03df
            r23 = r19
            android.text.style.StyleSpan r24 = new android.text.style.StyleSpan     // Catch:{ all -> 0x0428 }
            r31 = r24
            r24 = r31
            r25 = r31
            r26 = 1
            r25.<init>(r26)     // Catch:{ all -> 0x0428 }
            r25 = 0
            r26 = r20
            int r26 = r26.length()     // Catch:{ all -> 0x0428 }
            r27 = 0
            r23.setSpan(r24, r25, r26, r27)     // Catch:{ all -> 0x0428 }
        L_0x03df:
            r23 = r12
            r24 = r19
            boolean r23 = r23.add(r24)     // Catch:{ all -> 0x0428 }
            r23 = r11
        ...
        L_0x041e:
            ...
            r20 = r23
            r23 = r20
            r23.printStackTrace()     // Catch:{ all -> 0x0428 }
            goto L_0x0189
        L_0x0428:
            r23 = move-exception
            r22 = r23
        ...
        L_0x046c:
            ...
            android.net.Uri r0 = r0.overriddenSound
            r24 = r0
            android.support.v4.app.NotificationCompat$Builder r23 = r23.setSound(r24)
        L_0x0484:
            r23 = r2
            r0 = r23
            ...
            r24 = r0
            int r24 = r24.intValue()
            android.support.v4.app.NotificationCompat$Builder r23 = r23.setDefaults(r24)
            goto L_0x0249
        L_0x04a2:
            r23 = move-exception
            r19 = r23
        ...
        L_0x04c7:
            r23 = r19
            r24 = r17
            android.support.v4.app.NotificationCompat$InboxStyle r23 = r23.setBigContentTitle(r24)
            r23 = r18
            r24 = r19
            android.support.v4.app.NotificationCompat$Builder r23 = r23.setStyle(r24)
            r23 = r18
            android.app.Notification r23 = r23.build()
            r9 = r23
        L_0x04df:
            android.content.Context r23 = currentContext
            android.support.v4.app.NotificationManagerCompat r23 = android.support.p000v4.app.NotificationManagerCompat.from(r23)
            r24 = r10
            int r24 = r24.intValue()
            r25 = r9
            r23.notify(r24, r25)
        ...
        L_0x04f1:
            ...
            r23 = r16
            r24 = 1
            android.support.v4.app.NotificationCompat$Builder r23 = r23.setGroupAlertBehavior(r24)     // Catch:{ Throwable -> 0x0553 }
        L_0x0543:
            r23 = r16
            android.app.Notification r23 = r23.build()
            r9 = r23
    ...
    private static void createSummaryIdDatabaseEntry(OneSignalDbHelper dbHelper, String str, int i) {
        ...
        try {
            ...
            long insertOrThrow = writableDb.insertOrThrow(OneSignalDbContract.NotificationTable.TABLE_NAME, (String) null, values);
    ...
    private static void addBackgroundImage(JSONObject jSONObject, NotificationCompat.Builder builder) throws Throwable {
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            ...
            if (bg_image != null) {
                new RemoteViews(currentContext.getPackageName(), C1238R.layout.onesignal_bgimage_notif_layout);
                RemoteViews customView = remoteViews;
                customView.setTextViewText(C1238R.C1240id.os_bgimage_notif_title, getTitle(gcmBundle));
                customView.setTextViewText(C1238R.C1240id.os_bgimage_notif_body, gcmBundle.optString("alert"));
                setTextColor(customView, jsonBgImage, C1238R.C1240id.os_bgimage_notif_title, "tc", "onesignal_bgimage_notif_title_color");
                setTextColor(customView, jsonBgImage, C1238R.C1240id.os_bgimage_notif_body, "bc", "onesignal_bgimage_notif_body_color");
                ...
                if ("right".equals(alignSetting)) {
                    customView.setViewPadding(C1238R.C1240id.os_bgimage_notif_bgimage_align_layout, -5000, 0, 0, 0);
                    customView.setImageViewBitmap(C1238R.C1240id.os_bgimage_notif_bgimage_right_aligned, bg_image);
                    customView.setViewVisibility(C1238R.C1240id.os_bgimage_notif_bgimage_right_aligned, 0);
                    customView.setViewVisibility(C1238R.C1240id.os_bgimage_notif_bgimage, 2);
                } else {
                    customView.setImageViewBitmap(C1238R.C1240id.os_bgimage_notif_bgimage, bg_image);
                }
    ...
    private static void setTextColor(RemoteViews remoteViews, JSONObject gcmBundle, int i, String colorPayloadKey, String str) {
        ...
        int colorId = contextResources.getIdentifier(colorDefaultResource, PropertyTypeConstants.PROPERTY_TYPE_COLOR, packageName);
        if (colorId != 0) {
    ...
    private static void addNotificationActionButtons(JSONObject jSONObject, NotificationCompat.Builder builder, int i, String str) {
        ...
        try {
            new JSONObject(gcmBundle.optString(GoogleMapStyleOptions.THEME_CUSTOM));
            ...
            if (customJson.has("a")) {
                ...
                if (additionalDataJSON.has("actionButtons")) {
                    ...
                    for (int i2 = 0; i2 < buttons.length(); i2++) {
                        ...
                        Intent putExtra = buttonIntent.putExtra("action_button", true);
                        JSONObject put = bundle.put("actionSelected", button.optString(CommonProperties.f295ID));
                        Intent putExtra2 = buttonIntent.putExtra("onesignal_data", bundle.toString());
                        ...
                        NotificationCompat.Builder addAction = mBuilder.addAction(buttonIcon, button.optString(PropertyTypeConstants.PROPERTY_TYPE_TEXT), buttonPIntent);
                    }
                }
            }
        } catch (Throwable th) {
        ...
        if (customJson.has("a")) {
            ...
            if (additionalDataJSON.has("actionButtons")) {
                ...
                for (int i = 0; i < buttons.length(); i++) {
                    ...
                    boolean add = buttonsLabels.add(button.optString(PropertyTypeConstants.PROPERTY_TYPE_TEXT));
                    boolean add2 = buttonsIds.add(button.optString(CommonProperties.f295ID));
                }
            }
        }
    }
