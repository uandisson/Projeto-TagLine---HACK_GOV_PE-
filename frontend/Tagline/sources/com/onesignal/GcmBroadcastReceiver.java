...
public class GcmBroadcastReceiver extends WakefulBroadcastReceiver {
    ...
    private static boolean isGcmMessage(Intent intent) {
        ...
        return messageType == null || "gcm".equals(messageType);
    }
    ...
    private static BundleCompat setCompatBundleForServer(Bundle bundle, BundleCompat bundleCompat) {
        ...
        taskExtras.putLong(OneSignalDbContract.OutcomeEventsTable.COLUMN_NAME_TIMESTAMP, Long.valueOf(System.currentTimeMillis() / 1000));
        return taskExtras;
    }
}
