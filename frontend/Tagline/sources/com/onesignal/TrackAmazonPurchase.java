...
class TrackAmazonPurchase {
    ...
    TrackAmazonPurchase(Context context2) {
        ...
        try {
            ...
            new OSPurchasingListener(this, (C14901) null);
    ...
    private class OSPurchasingListener implements PurchasingListener {
        ...
        /* synthetic */ OSPurchasingListener(TrackAmazonPurchase x0, C14901 r7) {
            this(x0);
            C14901 r2 = r7;
        }
        ...
        public void onProductDataResponse(ProductDataResponse productDataResponse) {
            ...
            if (this.lastRequestId != null && this.lastRequestId.toString().equals(response.getRequestId().toString())) {
                try {
                    switch (C14901.f310x4eb80c9f[response.getRequestStatus().ordinal()]) {
                        case 1:
                            new JSONArray();
    ...
    static /* synthetic */ class C14901 {
        ...
        static final /* synthetic */ int[] f310x4eb80c9f = new int[ProductDataResponse.RequestStatus.values().length];

        static {
            try {
                f310x4eb80c9f[ProductDataResponse.RequestStatus.SUCCESSFUL.ordinal()] = 1;
