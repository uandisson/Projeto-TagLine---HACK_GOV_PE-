...
public class OneSignalNotificationManager {
    ...
    static Integer getMostRecentNotifIdFromGroup(SQLiteDatabase sQLiteDatabase, String str, boolean z) {
        ...
        try {
            cursor = db.query(OneSignalDbContract.NotificationTable.TABLE_NAME, (String[]) null, whereStr2, whereArgs, (String) null, (String) null, "created_time DESC", "1");
            ...
            recentId = Integer.valueOf(cursor.getInt(cursor.getColumnIndex(OneSignalDbContract.NotificationTable.COLUMN_NAME_ANDROID_NOTIFICATION_ID)));
            cursor.close();
            if (cursor != null && !cursor.isClosed()) {
                cursor.close();
            }
