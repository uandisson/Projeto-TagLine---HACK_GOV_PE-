...
class OSInAppMessageDisplayStats {
    ...
    OSInAppMessageDisplayStats(int displayQuantity2, long lastDisplayTime2) {
        this.lastDisplayTime = -1;
        this.displayQuantity = 0;
        this.displayLimit = Integer.MAX_VALUE;
        this.displayDelay = 0;
    ...
    OSInAppMessageDisplayStats(JSONObject jSONObject) throws JSONException {
    ...
    public void setDisplayStats(OSInAppMessageDisplayStats oSInAppMessageDisplayStats) {
        OSInAppMessageDisplayStats displayStats = oSInAppMessageDisplayStats;
