...
class InAppMessageView {
    ...
    public void setUpDraggableLayout(Context context, LinearLayout.LayoutParams layoutParams, DraggableRelativeLayout.Params params) {
        ...
        CardView cardView = createCardView(context2);
    ...
    /* access modifiers changed from: private */
    public void animateInAppMessage(WebViewManager.Position displayLocation2, View view, View view2) {
        View messageView = view;
        View backgroundView = view2;
        switch (displayLocation2) {
            case TOP_BANNER:
                animateTop(((ViewGroup) messageView).getChildAt(0), this.webView.getHeight());
                return;
            case BOTTOM_BANNER:
                animateBottom(((ViewGroup) messageView).getChildAt(0), this.webView.getHeight());
                return;
            case CENTER_MODAL:
            case FULL_SCREEN:
    ...
    private void animateTop(View messageView, int height) {
        ...
        OneSignalAnimate.animateViewByTranslation(messageView, (float) ((-height) - MARGIN_PX_SIZE), 0.0f, 1000, interpolator, (Animation.AnimationListener) null).start();
    }
    ...
    private void animateCenter(View messageView, View backgroundView) {
        Interpolator interpolator;
        new OneSignalBounceInterpolator(0.1d, 8.0d);
        Animation messageAnimation = OneSignalAnimate.animateViewSmallToLarge(messageView, 1000, interpolator, (Animation.AnimationListener) null);
        ValueAnimator backgroundAnimation = animateBackgroundColor(backgroundView, 400, ACTIVITY_BACKGROUND_COLOR_EMPTY, ACTIVITY_BACKGROUND_COLOR_FULL, (Animator.AnimatorListener) null);
