...
class WebViewManager extends ActivityLifecycleHandler.ActivityAvailableListener {
    ...
    static /* synthetic */ boolean access$1002(WebViewManager x0, boolean x1) {
        boolean z = x1;
        boolean z2 = z;
        x0.firstShow = z2;
        return z;
    ...
    public static void initInAppMessage(@NonNull Activity activity2, @NonNull OSInAppMessage oSInAppMessage, @NonNull String htmlStr) {
        ...
        OSInAppMessage message2 = oSInAppMessage;
        try {
            String base64Str = Base64.encodeToString(htmlStr.getBytes("UTF-8"), 2);
    ...
    class OSJavaScriptInterface {
        ...
        private void handleRenderComplete(JSONObject jSONObject) {
            ...
            this.this$0.createNewInAppMessageView(displayType, displayType == Position.FULL_SCREEN ? -1 : getPageHeightData(jsonObject));
        }
        ...
        private void handleActionTaken(JSONObject jsonObject) throws JSONException {
            ...
            String id = body.optString(CommonProperties.f295ID, (String) null);
            if (this.this$0.message.isPreview) {
                OSInAppMessageController.getController().onMessageActionOccurredOnPreview(this.this$0.message, body);
            } else if (id != null) {
                OSInAppMessageController.getController().onMessageActionOccurredOnMessage(this.this$0.message, body);
            }
    ...
    /* access modifiers changed from: private */
    public void createNewInAppMessageView(@NonNull Position displayLocation, int pageHeight) {
        ...
        new InAppMessageView.InAppMessageViewListener(this) {
            ...
            public void onMessageWasShown() {
                boolean access$1002 = WebViewManager.access$1002(this.this$0, false);
                OSInAppMessageController.getController().onMessageWasShown(this.this$0.message);
            }

            public void onMessageWasDismissed() {
                StringBuilder sb;
                OSInAppMessageController.getController().messageWasDismissed(this.this$0.message);
                new StringBuilder();
                ActivityLifecycleHandler.removeActivityAvailableListener(sb.append(WebViewManager.TAG).append(this.this$0.message.messageId).toString());
            }
        };
        this.messageView.setMessageController(inAppMessageViewListener);
        new StringBuilder();
        ActivityLifecycleHandler.setActivityAvailableListener(sb.append(TAG).append(this.message.messageId).toString(), this);
    }
